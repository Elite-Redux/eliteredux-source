...
override CFLAGS += -Wall -Wextra -Werror -Wno-array-parameter -Wno-address -Wno-array-bounds -Wno-unused-value -Wno-strict-aliasing -Wno-missing-braces -Wno-pointer-sign -Wno-unused-function -Wno-unused-variable -Wno-unused-but-set-variable -Wno-parentheses -Wno-uninitialized -Wno-maybe-uninitialized -Wno-return-type -Wno-switch -Wno-unused-local-typedefs -mthumb -mthumb-interwork -O2 -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast -Wno-missing-field-initializers -Wno-ignored-qualifiers -Wno-implicit-fallthrough -Wno-unused-parameter -Wno-sign-compare -Wno-old-style-declaration -Wno-type-limits -Wno-empty-body -Wno-sizeof-pointer-div -Wno-empty-body -Wno-unused-label -Wno-override-init -Wno-sequence-point -Wno-logical-not-parentheses -Wno-bool-compare -Wno-shift-negative-value -Wno-int-in-bool-context -g
ROM := $(MODERN_ROM_NAME)
