...
#define ABILITY_LIQUID_VOICE 204 // Sound moves get a 1.2x boost and become Water if Normal.
...
#define ABILITY_POWER_OF_ALCHEMY 223 // Transmutes berries on entry. Transmutes items when lost.
...
#define ABILITY_FRENZIED_PHANTOM 790 // HA + Shadow Tagg
