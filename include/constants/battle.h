...
#define STATUS1_CAN_ACT (STATUS1_POISON_ANY | STATUS1_BURN | STATUS1_PARALYSIS | STATUS1_FROSTBITE | STATUS1_BLEED)
#else
...
#define STATUS1_TOXIC_TURN(num) ((Status1)((num) << 8))
    ...
    STATUS1_CAN_ACT = STATUS1_POISON_ANY | STATUS1_BURN | STATUS1_PARALYSIS | STATUS1_FROSTBITE | STATUS1_BLEED,
} Status1;
#endif
...
#else
typedef enum WeatherFlag {
    WEATHER_NONE = 0,
    WEATHER_RAIN_TEMPORARY = 1 << 0,
    WEATHER_RAIN_DOWNPOUR = 1 << 1,
    WEATHER_RAIN_PERMANENT = 1 << 2,
    WEATHER_RAIN_PRIMAL = 1 << 3,
    WEATHER_RAIN_ANY = WEATHER_RAIN_TEMPORARY | WEATHER_RAIN_DOWNPOUR | WEATHER_RAIN_PERMANENT | WEATHER_RAIN_PRIMAL,
    WEATHER_SANDSTORM_TEMPORARY = 1 << 4,
    WEATHER_SANDSTORM_PERMANENT = 1 << 5,
    WEATHER_SANDSTORM_ANY = WEATHER_SANDSTORM_TEMPORARY | WEATHER_SANDSTORM_PERMANENT,
    WEATHER_SUN_TEMPORARY = 1 << 6,
    WEATHER_SUN_PERMANENT = 1 << 7,
    WEATHER_SUN_PRIMAL = 1 << 8,
    WEATHER_SUN_ANY = WEATHER_SUN_TEMPORARY | WEATHER_SUN_PERMANENT | WEATHER_SUN_PRIMAL,
    WEATHER_HAIL_TEMPORARY = 1 << 9,
    WEATHER_HAIL_PERMANENT = 1 << 10,
    WEATHER_HAIL_ANY = WEATHER_HAIL_TEMPORARY | WEATHER_HAIL_PERMANENT,
    WEATHER_STRONG_WINDS = 1 << 11,
    WEATHER_FOG_PERMANENT = 1 << 12,
    WEATHER_FOG_TEMPORARY = 1 << 13,
    WEATHER_FOG_ANY = WEATHER_FOG_PERMANENT | WEATHER_FOG_TEMPORARY,
    WEATHER_ANY = WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_STRONG_WINDS | WEATHER_FOG_ANY,
    WEATHER_PRIMAL_ANY = WEATHER_RAIN_PRIMAL | WEATHER_SUN_PRIMAL | WEATHER_STRONG_WINDS,
    WEATHER_PERMANENT =
        WEATHER_PRIMAL_ANY | WEATHER_RAIN_PERMANENT | WEATHER_SANDSTORM_PERMANENT | WEATHER_SUN_PERMANENT | WEATHER_HAIL_PERMANENT | WEATHER_FOG_PERMANENT,
} WeatherFlag;
#endif
