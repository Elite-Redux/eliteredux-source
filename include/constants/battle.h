...
#define WEATHER_ANY_VALUE (WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_STRONG_WINDS | WEATHER_FOG_ANY)
#define WEATHER_ANY WEATHER_ANY_VALUE
