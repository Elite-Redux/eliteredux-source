...
#define B_WEATHER_FOG_PERMANENT     (1 << 12) // temporary fog doesn't exist
#define WEATHER_ANY                 (WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_STRONG_WINDS | B_WEATHER_FOG_PERMANENT)
