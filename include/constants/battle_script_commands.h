...
#define MOVEEND_NEXT_TARGET                       MOVEEND_MIRROR_MOVE + 1
...
#define MOVEEND_SET_SWITCH                        MOVEEND_ABILITIES_AFTER_RECOIL + 1
#define MOVEEND_LIFEORB_SHELLBELL                 MOVEEND_SET_SWITCH + 1
