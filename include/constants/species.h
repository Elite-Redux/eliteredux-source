...
#define LAST_VALID_CUSTOM_MEGA              SPECIES_SLOWKING_MEGA_GALARIAN  // To check for a valid species in some menus
...
#define SPECIES_DARMANITAN_REDUX_BLUNDER       REDUX_FORMS_START + 142
