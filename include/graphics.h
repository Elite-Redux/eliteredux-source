...
extern const u32 gItemIcon_Maizemothite[];
extern const u32 gItemIconPalette_Maizemothite[];
extern const u32 gItemIcon_Popmothite[];
extern const u32 gItemIconPalette_Popmothite[];
...
extern const u32 gMonFrontPic_Maizemoth[];
extern const u32 gMonBackPic_Maizemoth[];
extern const u32 gMonPalette_Maizemoth[];
extern const u32 gMonShinyPalette_Maizemoth[];
extern const u8  gMonIcon_Maizemoth[];
extern const u32 gMonFrontPic_MaizemothMega[];
extern const u32 gMonBackPic_MaizemothMega[];
extern const u32 gMonPalette_MaizemothMega[];
extern const u32 gMonShinyPalette_MaizemothMega[];
extern const u8  gMonIcon_MaizemothMega[];
extern const u32 gMonFrontPic_Popmoth[];
extern const u32 gMonBackPic_Popmoth[];
extern const u32 gMonPalette_Popmoth[];
extern const u32 gMonShinyPalette_Popmoth[];
extern const u8  gMonIcon_Popmoth[];
...
extern const u32 gMonFrontPic_PopmothMega[];
extern const u32 gMonBackPic_PopmothMega[];
extern const u32 gMonPalette_PopmothMega[];
extern const u32 gMonShinyPalette_PopmothMega[];
extern const u8  gMonIcon_PopmothMega[];
