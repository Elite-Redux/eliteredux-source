extern const u8 gMonFootprint_Dodrio_Redux[];
extern const u8 gMonFootprint_Doduo_Redux[];
extern const u8 gMonFootprint_Scrafty_Mega[];
extern const u8 gMonFootprint_Froslass_Mega[];
extern const u8 gMonFootprint_Houndoom_Mega_Redux[];
extern const u8 gMonFootprint_Houndoom_Redux[];
extern const u8 gMonFootprint_Houndour_Redux[];
extern const u8 gMonFootprint_Sableye_Mega_Redux[];
extern const u8 gMonFootprint_Sableye_Redux[];
extern const u8 gMonFootprint_Mawile_Mega_Redux[];
extern const u8 gMonFootprint_Mawile_Redux[];
extern const u8 gMonFootprint_Bisharp_Redux[];
extern const u8 gMonFootprint_Pawniard_Redux[];
extern const u8 gMonFootprint_Hydreigon_Redux[];
extern const u8 gMonFootprint_Zweilous_Redux[];
extern const u8 gMonFootprint_Deino_Redux[];
extern const u8 gMonFootprint_Garchomp_Mega_Redux[];
extern const u8 gMonFootprint_Garchomp_Redux[];
extern const u8 gMonFootprint_Gabite_Redux[];
extern const u8 gMonFootprint_Gible_Redux[];
extern const u8 gMonFootprint_Exploud_Redux[];
extern const u8 gMonFootprint_Loudred_Redux[];
extern const u8 gMonFootprint_Whismur_Redux[];
extern const u8 gMonFootprint_Arcanine_Mega_Redux[];
extern const u8 gMonFootprint_Arcanine_Redux[];
extern const u8 gMonFootprint_Growlithe_Redux[];
extern const u8 gMonFootprint_Skarmory_Mega_Redux[];
extern const u8 gMonFootprint_Beedrill_Mega_Redux[];
extern const u8 gMonFootprint_Duosion_Redux[];
...
extern const u8 gMonFootprint_Machop_Redux[];
extern const u8 gMonFootprint_Uxie_Redux[];
extern const u8 gMonFootprint_Mesprit_Redux[];
extern const u8 gMonFootprint_Azelf_Redux[];
extern const u8 gMonFootprint_Floatzel_Redux[];
extern const u8 gMonFootprint_Buizel_Redux[];
extern const u8 gMonFootprint_Magcargo_Redux[];
extern const u8 gMonFootprint_Slugma_Redux[];
extern const u8 gMonFootprint_Simisear_Redux[];
extern const u8 gMonFootprint_Pansear_Redux[];
extern const u8 gMonFootprint_Simisage_Redux[];
extern const u8 gMonFootprint_Pansage_Redux[];
extern const u8 gMonFootprint_Simipour_Redux[];
extern const u8 gMonFootprint_Panpour_Redux[];
extern const u8 gMonFootprint_Bewear_Redux[];
extern const u8 gMonFootprint_Stufful_Redux[];
extern const u8 gMonFootprint_Beedrill_Redux[];
extern const u8 gMonFootprint_Kakuna_Redux[];
extern const u8 gMonFootprint_Weedle_Redux[];
extern const u8 gMonFootprint_Alakazam_Redux_Mega[];
extern const u8 gMonFootprint_Alakazam_Redux[];
extern const u8 gMonFootprint_Kadabra_Redux[];
extern const u8 gMonFootprint_Abra_Redux[];
extern const u8 gMonFootprint_Aegislash_Blade_Redux[];
extern const u8 gMonFootprint_Aegislash_Redux[];
extern const u8 gMonFootprint_Doublade_Redux[];
extern const u8 gMonFootprint_Honedge_Redux[];
...
extern const u8 gMonFootprint_Great_Tusk[];
extern const u8 gMonFootprint_Scream_Tail[];
extern const u8 gMonFootprint_Brute_Bonnet[];
extern const u8 gMonFootprint_Flutter_Mane[];
extern const u8 gMonFootprint_Slither_Wing[];
extern const u8 gMonFootprint_Sandy_Shocks[];
extern const u8 gMonFootprint_Iron_Treads[];
extern const u8 gMonFootprint_Iron_Bundle[];
extern const u8 gMonFootprint_Iron_Hands[];
extern const u8 gMonFootprint_Iron_Jugulis[];
extern const u8 gMonFootprint_Iron_Moth[];
extern const u8 gMonFootprint_Iron_Thorns[];
...
extern const u8 gMonFootprint_Wo_Chien[];
extern const u8 gMonFootprint_Chien_Pao[];
extern const u8 gMonFootprint_Ting_Lu[];
extern const u8 gMonFootprint_Chi_Yu[];
extern const u8 gMonFootprint_Roaring_Moon[];
extern const u8 gMonFootprint_Iron_Valiant[];
extern const u8 gMonFootprint_Koraidon[];
extern const u8 gMonFootprint_Miraidon[];
extern const u8 gMonFootprint_Walking_Wake[];
extern const u8 gMonFootprint_Iron_Leaves[];
...
extern const u8 gMonFootprint_Enamorus_Therian[];
extern const u8 gMonFootprint_Palkia_Origin_Forme[];
extern const u8 gMonFootprint_Dialga_Origin_Forme[];
extern const u8 gMonFootprint_Ogerpon_Hearthflame_Mask[];
extern const u8 gMonFootprint_Ogerpon_Cornerstone_Mask[];
extern const u8 gMonFootprint_Ogerpon_Wellspring_Mask[];
extern const u8 gMonFootprint_Squawkabilly_White_Plumage[];
extern const u8 gMonFootprint_Squawkabilly_Yellow_Plumage[];
extern const u8 gMonFootprint_Squawkabilly_Blue_Plumage[];
extern const u8 gMonFootprint_Squawkabilly_Green_Plumage[];
extern const u8 gMonFootprint_Tatsugiri_Droopy[];
extern const u8 gMonFootprint_Tatsugiri_Stretchy[];
extern const u8 gMonFootprint_Tatsugiri_Curly[];
extern const u8 gMonFootprint_Maushold_Four[];
extern const u8 gMonFootprint_Dudunsparce_Three_Segment[];
extern const u8 gMonFootprint_Palafin_Hero[];
extern const u8 gMonFootprint_Ursaluna_Bloodmoon[];
extern const u8 gMonFootprint_Tauros_Paldean_Combat_Breed[];
extern const u8 gMonFootprint_Tauros_Paldean_Blaze_Breed[];
extern const u8 gMonFootprint_Tauros_Paldean_Aqua_Breed[];
extern const u8 gMonFootprint_Decidueye_Hisuian[];
extern const u8 gMonFootprint_Avalugg_Hisuian[];
extern const u8 gMonFootprint_Goodra_Hisuian[];
extern const u8 gMonFootprint_Sliggoo_Hisuian[];
extern const u8 gMonFootprint_Braviary_Hisuian[];
extern const u8 gMonFootprint_Zorua_Hisuian[];
extern const u8 gMonFootprint_Lilligant_Hisuian[];
extern const u8 gMonFootprint_Samurott_Hisuian[];
extern const u8 gMonFootprint_Sneasel_Hisuian[];
extern const u8 gMonFootprint_Typhlosion_Hisuian[];
extern const u8 gMonFootprint_Electrode_Hisuian[];
extern const u8 gMonFootprint_Voltorb_Hisuian[];
extern const u8 gMonFootprint_Arcanine_Hisuian[];
extern const u8 gMonFootprint_Growlithe_Hisuian[];
extern const u8 gMonFootprint_Qwilfish_Hisuian[];
...
extern const u8 gMonFootprint_Escarginite[];
extern const u8 gMonFootprint_Escarginite_Redux[];
extern const u8 gMonFootprint_Hydrapple[];
extern const u8 gMonFootprint_Basculin_Whitestriped[];
extern const u8 gMonFootprint_Zoroark_Hisuian[];
extern const u8 gMonFootprint_Wooper_Paldean[];
...
extern const u8 gMonIcon_Scizor_Mega_Redux[];
...
extern const u32 gMonShinyPalette_Scizor_Mega_Redux[];
...
extern const u32 gMonPalette_Scizor_Mega_Redux[];
...
extern const u32 gMonBackPic_Scizor_Mega_Redux[];
...
extern const u8 gMonFootprint_Tyranitar_Mega_Redux[];
extern const u8 gMonFootprint_Tyranitar_Redux[];
extern const u8 gMonFootprint_Pupitar_Redux[];
extern const u8 gMonFootprint_Larvitar_Redux[];
...
extern const u32 gMonFrontPic_Scizor_Mega_Redux[];
