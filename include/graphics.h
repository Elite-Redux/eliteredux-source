...
extern const u32 gMonFrontPic_ToxtricityReduxLowKey[];
extern const u32 gMonBackPic_ToxtricityReduxLowKey[];
extern const u32 gMonPalette_ToxtricityReduxLowKey[];
extern const u32 gMonShinyPalette_ToxtricityReduxLowKey[];
extern const u8  gMonIcon_ToxtricityReduxLowKey[];
extern const u32 gMonFrontPic_ToxtricityReduxLowKeyMega[];
extern const u32 gMonBackPic_ToxtricityReduxLowKeyMega[];
extern const u32 gMonPalette_ToxtricityReduxLowKeyMega[];
extern const u32 gMonShinyPalette_ToxtricityReduxLowKeyMega[];
extern const u8  gMonIcon_ToxtricityReduxLowKeyMega[];
