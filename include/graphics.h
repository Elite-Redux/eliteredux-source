extern const u8 gMonFootprint_LycanrocEclipse[];
extern const u8 gMonFootprint_RockruffTwilight[];
extern const u8 gMonFootprint_Golisopod_Redux_Mega[];
extern const u8 gMonFootprint_Spiritomb_Redux[];
extern const u8 gMonFootprint_Golisopod_Redux[];
extern const u8 gMonFootprint_Wimpod_Redux[];
extern const u8 gMonFootprint_Hatterene_Redux_Mega[];
extern const u8 gMonFootprint_Hatterene_Redux[];
extern const u8 gMonFootprint_Hattrem_Redux[];
...
extern const u32 gMonFrontPic_Golisopod_Redux_Mega[];
extern const u32 gMonFrontPic_Spiritomb_Redux[];
extern const u32 gMonFrontPic_Golisopod_Redux[];
extern const u32 gMonFrontPic_Wimpod_Redux[];
extern const u32 gMonFrontPic_Hatterene_Redux_Mega[];
extern const u32 gMonFrontPic_Hatterene_Redux[];
extern const u32 gMonFrontPic_Hattrem_Redux[];
...
extern const u32 gMonBackPic_Golisopod_Redux_Mega[];
extern const u32 gMonBackPic_Spiritomb_Redux[];
extern const u32 gMonBackPic_Golisopod_Redux[];
extern const u32 gMonBackPic_Wimpod_Redux[];
extern const u32 gMonBackPic_Hatterene_Redux_Mega[];
extern const u32 gMonBackPic_Hatterene_Redux[];
extern const u32 gMonBackPic_Hattrem_Redux[];
...
extern const u32 gMonPalette_Golisopod_Redux_Mega[];
extern const u32 gMonPalette_Spiritomb_Redux[];
extern const u32 gMonPalette_Golisopod_Redux[];
extern const u32 gMonPalette_Wimpod_Redux[];
extern const u32 gMonPalette_Hatterene_Redux_Mega[];
extern const u32 gMonPalette_Hatterene_Redux[];
extern const u32 gMonPalette_Hattrem_Redux[];
...
extern const u32 gMonShinyPalette_Golisopod_Redux_Mega[];
extern const u32 gMonShinyPalette_Spiritomb_Redux[];
extern const u32 gMonShinyPalette_Golisopod_Redux[];
extern const u32 gMonShinyPalette_Wimpod_Redux[];
extern const u32 gMonShinyPalette_Hatterene_Redux_Mega[];
extern const u32 gMonShinyPalette_Hatterene_Redux[];
extern const u32 gMonShinyPalette_Hattrem_Redux[];
...
extern const u8 gMonIcon_Golisopod_Redux_Mega[];
extern const u8 gMonIcon_Spiritomb_Redux[];
extern const u8 gMonIcon_Golisopod_Redux[];
extern const u8 gMonIcon_Wimpod_Redux[];
extern const u8 gMonIcon_Hatterene_Redux_Mega[];
extern const u8 gMonIcon_Hatterene_Redux[];
extern const u8 gMonIcon_Hattrem_Redux[];
