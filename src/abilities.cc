...
template <>
constexpr Ability Impl<ABILITY_IGNITION> = {
    .onEntry = +[](ON_ENTRY) -> int { return AddBattlerType(battler, TYPE_FIRE); },
    .addsType = TYPE_FIRE,
};
...
template <>
constexpr Ability Impl<ABILITY_BIRD_TYPE> = {
    .onEntry = +[](ON_ENTRY) -> int { return AddBattlerType(battler, TYPE_FLYING); },
    .addsType = TYPE_FLYING,
};
