...
static u8 *GetSideStatusValue(struct BattleDebugMenu *data, bool32 changeStatus, bool32 statusTrue)
{
    ...
    case LIST_SIDE_STICKY_WEB:
        ...
        return &sideTimer->stickyWebTimer;
    default:
        return NULL;
    }
}
...
static void SetUpModifyArrows(struct BattleDebugMenu *data)
{
    ...
    case LIST_ITEM_PP:
        data->modifyArrows.minValue = 0;
        data->modifyArrows.maxValue = CalculatePPWithBonusPlayer(gBattleMons[data->battlerId].moves[data->currentSecondaryListItemId], gBattleMons[data->battlerId].ppBonuses, data->currentSecondaryListItemId);
...
static const u8 sText_HoldEffectTypePower[] = _("Type Boost");
...
static const u8 *const sHoldEffectNames[] = 
{
    ...
    [HOLD_EFFECT_SMOKE_BALL] = sText_HoldEffectCanAlwaysRun,
