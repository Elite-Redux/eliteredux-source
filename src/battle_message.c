...
static const u8 sText_ExtraSkillEmbargo[] = _("{B_PLAYER_NAME}'s on field pokemon are unable to use items\nfor {B_BUFF1} turns.");
static const u8 sText_ExtraSkillNoProtect[] = _("{B_PLAYER_NAME}'s team had its power points of\nprotect drained.");
static const u8 sText_ExtraSkillEviolite[] = _("{B_TRAINER1_NAME}'s team is protected by\nEviolite.");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_EXTRASKILL_EVIOLITE - 12] = sText_ExtraSkillEviolite,
