...
// || gBattleMons[battlerDef].status2 & STATUS2_TRANSFORMED check for transformed mon before reverting
{
    ...
    static const u16 species[][3] =
    {
        ...
        {SPECIES_MINIOR_CORE_RED,               SPECIES_MINIOR,                 FALSE},
        {SPECIES_MINIOR_CORE_BLUE,              SPECIES_MINIOR_METEOR_BLUE,     FALSE},
        {SPECIES_MINIOR_CORE_GREEN,             SPECIES_MINIOR_METEOR_GREEN,    FALSE},
        {SPECIES_MINIOR_CORE_INDIGO,            SPECIES_MINIOR_METEOR_INDIGO,   FALSE},
        {SPECIES_MINIOR_CORE_ORANGE,            SPECIES_MINIOR_METEOR_ORANGE,   FALSE},
        {SPECIES_MINIOR_CORE_VIOLET,            SPECIES_MINIOR_METEOR_VIOLET,   FALSE},
        {SPECIES_MINIOR_CORE_YELLOW,            SPECIES_MINIOR_METEOR_YELLOW,   FALSE},
