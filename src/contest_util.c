...
static void Task_ShowWinnerMonBanner(u8 taskId)
{
    ...
    case 0:
        ...
        pokePal = GetMonSpritePalStructFromOtIdPersonality(species, personality, isShiny);
...
void ShowContestEntryMonPic(void)
{
    ...
    if (FindTaskIdByFunc(Task_ShowContestEntryMonPic) == TASK_NONE)
    {
        ...
        HandleLoadSpecialPokePic(&gSpecies[species].frontPic, gMonSpritesGfxPtr->sprites.ptr[1], species, personality);
