...
const u32 gBallIcon_Park[] = INCBIN_U32("graphics/summary_screen/ball_icons/park.4bpp.lz");
const u32 gBallIconPalette_Park[] = INCBIN_U32("graphics/summary_screen/ball_icons/park.gbapal.lz");
