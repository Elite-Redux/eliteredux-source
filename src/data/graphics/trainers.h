...
const u32 gTrainerFrontPic_Baneful[] = INCBIN_U32("graphics/trainers/front_pics/baneful.4bpp.lz");
const u32 gTrainerPalette_Baneful[]  = INCBIN_U32("graphics/trainers/palettes/baneful.gbapal.lz");
