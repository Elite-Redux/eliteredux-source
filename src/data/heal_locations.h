static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EVER_GRANDE_CITY - 1] = {MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY), 27, 50},
    ...
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 1, 11},
    ...
    [HEAL_LOCATION_LEGENDARY_DOMAIN - 1] = {MAP_GROUP(LEGENDARY_DOMAIN), MAP_NUM(LEGENDARY_DOMAIN), 9, 2},
};
