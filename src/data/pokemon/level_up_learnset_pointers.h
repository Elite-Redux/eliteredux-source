const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_HITMONCHAN_MEGA]   = sHitmonchanLevelUpLearnset,
    ...
    [SPECIES_WIGGLYTUFF_MEGA] = sWigglytuffLevelUpLearnset,
    [SPECIES_WIGGLYTUFF_MEGA_X] = sWigglytuffLevelUpLearnset,
