const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_UNOWN_G] = sObamasnowLevelUpLearnset,
    [SPECIES_UNOWN_H] = sObamasnowLevelUpLearnset,
    [SPECIES_UNOWN_I] = sRegigichairLevelUpLearnset,
    [SPECIES_UNOWN_J] = strollmaskLevelUpLearnset,
    [SPECIES_UNOWN_K] = sironmugulisLevelUpLearnset,
    [SPECIES_UNOWN_L] = sWariobopassLevelUpLearnset,
    [SPECIES_UNOWN_M] = sSuslettLevelUpLearnset,
    [SPECIES_UNOWN_N] = sdepressiboltLevelUpLearnset,
    [SPECIES_UNOWN_O] = spepsichampLevelUpLearnset,
    [SPECIES_UNOWN_P] = spepsichampLevelUpLearnset,
    [SPECIES_UNOWN_Q] = sescavalegsLevelUpLearnset,
