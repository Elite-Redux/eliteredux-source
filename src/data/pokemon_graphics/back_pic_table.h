const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(TINKATON_MEGA, gMonBackPic_Tinkaton_Mega),
    ...
    SPECIES_SPRITE(WIGGLYTUFF_PRIMAL, gMonBackPic_Wigglytuff_Primal),
    SPECIES_SPRITE(WIGGLYTUFF_APEX,  gMonBackPic_WigglytuffApex),
    ...
    SPECIES_SPRITE(HITMONCHAN_MEGA, gMonBackPic_HitmonchanMega),
    ...
    SPECIES_SPRITE(WIGGLYTUFF_MEGA,   gMonBackPic_WigglytuffMega),
    SPECIES_SPRITE(WIGGLYTUFF_MEGA_X,   gMonBackPic_WigglytuffMegaX),
