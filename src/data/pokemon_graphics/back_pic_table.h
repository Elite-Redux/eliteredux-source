const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(PIKACHU_PARTNER_MEGA, gMonBackPic_PikachuPartnerMega),
    ...
    SPECIES_SPRITE(WIGGLYTUFF1, gMonBackPic_Wigglytuff),
    ...
    SPECIES_SPRITE(MEOWTH_PARTNER, gMonBackPic_MeowthPartner),
    SPECIES_SPRITE(MEOWTH_PARTNER_MEGA, gMonBackPic_MeowthPartnerMega),
    ...
    SPECIES_SPRITE(RAPIDASH1, gMonBackPic_Rapidash),
    ...
    SPECIES_SPRITE(HITMONCHAN1, gMonBackPic_Hitmonchan),
    ...
    SPECIES_SPRITE(KNAIVER, gMonBackPic_Knaiver),
    ...
    SPECIES_SPRITE(EEVEE_PARTNER_MEGA, gMonBackPic_EeveePartnerMega),
    ...
    SPECIES_SPRITE(CRAWDAUNTLES, gMonBackPic_Crawdauntles),
    ...
    SPECIES_SPRITE(BURMY_ETERNA, gMonBackPic_BurmyEterna),
    ...
    SPECIES_SPRITE(LUMINOSITEON, gMonBackPic_Luminositeon),
    ...
    SPECIES_SPRITE(DARUMAKA_REDUX, gMonBackPic_DarumakaRedux),
    SPECIES_SPRITE(DARMANITAN, gMonBackPic_Darmanitan),
    SPECIES_SPRITE(DARMANITAN_REDUX, gMonBackPic_DarmanitanRedux),
    SPECIES_SPRITE(DARMANITAN_REDUX_AURA, gMonBackPic_DarmanitanReduxAura),
    SPECIES_SPRITE(DARMANITAN_REDUX_BOND, gMonBackPic_DarmanitanRedux),
    SPECIES_SPRITE(DARMANITAN_REDUX_BLUNDER, gMonBackPic_DarmanitanReduxBond),
    SPECIES_SPRITE(MARACTUS, gMonBackPic_Maractus),
    SPECIES_SPRITE(SAGARACAS, gMonBackPic_Sagaracas),
    ...
    SPECIES_SPRITE(GARBODOR_MEGA, gMonBackPic_GarbodorMega),
    ...
    SPECIES_SPRITE(MUDSDALE1, gMonBackPic_Mudsdale),
    ...
    SPECIES_SPRITE(BLACEPHALON1, gMonBackPic_Blacephalon),
    ...
    SPECIES_SPRITE(MELMETAL_MEGA, gMonBackPic_MelmetalMega),
    ...
    SPECIES_SPRITE(RILLABOOM_MEGA, gMonBackPic_RillaboomMega),
    ...
    SPECIES_SPRITE(CINDERACE_MEGA, gMonBackPic_CinderaceMega),
    ...
    SPECIES_SPRITE(INTELEON_MEGA, gMonBackPic_InteleonMega),
    ...
    SPECIES_SPRITE(CORVIKNIGHT_MEGA, gMonBackPic_CorviknightMega),
    ...
    SPECIES_SPRITE(ORBEETLE_MEGA, gMonBackPic_OrbeetleMega),
    ...
    SPECIES_SPRITE(DREDNAW_MEGA, gMonBackPic_DrednawMega),
    ...
    SPECIES_SPRITE(CENTISKORCH_MEGA, gMonBackPic_CentiskorchMega),
    ...
    SPECIES_SPRITE(DURALUDON_PARTNER, gMonBackPic_DuraludonPartner),
    SPECIES_SPRITE(DURALUDON_PARTNER_MEGA, gMonBackPic_DuraludonPartnerMega),
    ...
    SPECIES_SPRITE(URSHIFU_MEGA, gMonBackPic_UrshifuMega),
    SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_STYLE_MEGA, gMonBackPic_UrshifuRapidStrikeStyleMega),
    ...
    SPECIES_SPRITE(DODRIO_REDUX, gMonBackPic_Dodrio_Redux),
    SPECIES_SPRITE(DODUO_REDUX, gMonBackPic_Doduo_Redux),
    SPECIES_SPRITE(SCRAFTY_MEGA, gMonBackPic_Scrafty_Mega),
    SPECIES_SPRITE(FROSLASS_MEGA, gMonBackPic_Froslass_Mega),
    SPECIES_SPRITE(HOUNDOOM_MEGA_REDUX, gMonBackPic_Houndoom_Mega_Redux),
    SPECIES_SPRITE(HOUNDOOM_REDUX, gMonBackPic_Houndoom_Redux),
    SPECIES_SPRITE(HOUNDOUR_REDUX, gMonBackPic_Houndour_Redux),
    SPECIES_SPRITE(SABLEYE_MEGA_REDUX, gMonBackPic_Sableye_Mega_Redux),
    SPECIES_SPRITE(SABLEYE_REDUX, gMonBackPic_Sableye_Redux),
    SPECIES_SPRITE(MAWILE_MEGA_REDUX, gMonBackPic_Mawile_Mega_Redux),
    SPECIES_SPRITE(MAWILE_REDUX, gMonBackPic_Mawile_Redux),
    SPECIES_SPRITE(BISHARP_REDUX, gMonBackPic_Bisharp_Redux),
    SPECIES_SPRITE(PAWNIARD_REDUX, gMonBackPic_Pawniard_Redux),
    SPECIES_SPRITE(HYDREIGON_REDUX, gMonBackPic_Hydreigon_Redux),
    SPECIES_SPRITE(ZWEILOUS_REDUX, gMonBackPic_Zweilous_Redux),
    SPECIES_SPRITE(DEINO_REDUX, gMonBackPic_Deino_Redux),
    SPECIES_SPRITE(GARCHOMP_MEGA_REDUX, gMonBackPic_Garchomp_Mega_Redux),
    SPECIES_SPRITE(GARCHOMP_REDUX, gMonBackPic_Garchomp_Redux),
    SPECIES_SPRITE(GABITE_REDUX, gMonBackPic_Gabite_Redux),
    SPECIES_SPRITE(GIBLE_REDUX, gMonBackPic_Gible_Redux),
    SPECIES_SPRITE(EXPLOUD_REDUX, gMonBackPic_Exploud_Redux),
    SPECIES_SPRITE(LOUDRED_REDUX, gMonBackPic_Loudred_Redux),
    SPECIES_SPRITE(WHISMUR_REDUX, gMonBackPic_Whismur_Redux),
    SPECIES_SPRITE(ARCANINE_MEGA_REDUX, gMonBackPic_Arcanine_Mega_Redux),
    SPECIES_SPRITE(ARCANINE_REDUX, gMonBackPic_Arcanine_Redux),
    SPECIES_SPRITE(GROWLITHE_REDUX, gMonBackPic_Growlithe_Redux),
    SPECIES_SPRITE(SKARMORY_MEGA_REDUX, gMonBackPic_Skarmory_Mega_Redux),
    SPECIES_SPRITE(BEEDRILL_MEGA_REDUX, gMonBackPic_Beedrill_Mega_Redux),
    SPECIES_SPRITE(SOLOSIS_REDUX, gMonBackPic_Solosis_Redux),
    SPECIES_SPRITE(DUOSION_REDUX, gMonBackPic_Duosion_Redux),
    SPECIES_SPRITE(REUNICLUS_REDUX, gMonBackPic_Reuniclus_Redux),
    SPECIES_SPRITE(SKARMORY_REDUX, gMonBackPic_Skarmory_Redux),
    SPECIES_SPRITE(MACHAMP_MEGA_REDUX, gMonBackPic_Machamp_Mega_Redux),
    SPECIES_SPRITE(MACHAMP_REDUX, gMonBackPic_Machamp_Redux),
    SPECIES_SPRITE(MACHOKE_REDUX, gMonBackPic_Machoke_Redux),
    SPECIES_SPRITE(MACHOP_REDUX, gMonBackPic_Machop_Redux),
    SPECIES_SPRITE(UXIE_REDUX, gMonBackPic_Uxie_Redux),
    SPECIES_SPRITE(MESPRIT_REDUX, gMonBackPic_Mesprit_Redux),
    SPECIES_SPRITE(AZELF_REDUX, gMonBackPic_Azelf_Redux),
    SPECIES_SPRITE(FLOATZEL_REDUX, gMonBackPic_Floatzel_Redux),
    SPECIES_SPRITE(VELOZEL, gMonBackPic_Velozel),
    SPECIES_SPRITE(BUIZEL_REDUX, gMonBackPic_Buizel_Redux),
    SPECIES_SPRITE(MAGCARGO_REDUX, gMonBackPic_Magcargo_Redux),
    SPECIES_SPRITE(SLUGMA_REDUX, gMonBackPic_Slugma_Redux),
    SPECIES_SPRITE(SIMISEAR_REDUX, gMonBackPic_Simisear_Redux),
    SPECIES_SPRITE(PANSEAR_REDUX, gMonBackPic_Pansear_Redux),
    SPECIES_SPRITE(SIMISAGE_REDUX, gMonBackPic_Simisage_Redux),
    SPECIES_SPRITE(PANSAGE_REDUX, gMonBackPic_Pansage_Redux),
    SPECIES_SPRITE(SIMIPOUR_REDUX, gMonBackPic_Simipour_Redux),
    SPECIES_SPRITE(PANPOUR_REDUX, gMonBackPic_Panpour_Redux),
    SPECIES_SPRITE(BEWEAR_REDUX, gMonBackPic_Bewear_Redux),
    SPECIES_SPRITE(BEWARDEN, gMonBackPic_Bewarden),
    SPECIES_SPRITE(STUFFUL_REDUX, gMonBackPic_Stufful_Redux),
    SPECIES_SPRITE(BEEDRILL_REDUX, gMonBackPic_Beedrill_Redux),
    SPECIES_SPRITE(KAKUNA_REDUX, gMonBackPic_Kakuna_Redux),
    SPECIES_SPRITE(WEEDLE_REDUX, gMonBackPic_Weedle_Redux),
    SPECIES_SPRITE(ALAKAZAM_MEGA_REDUX, gMonBackPic_Alakazam_Redux_Mega),
    SPECIES_SPRITE(ALAKAZAM_REDUX, gMonBackPic_Alakazam_Redux),
    SPECIES_SPRITE(KADABRA_REDUX, gMonBackPic_Kadabra_Redux),
    SPECIES_SPRITE(ABRA_REDUX, gMonBackPic_Abra_Redux),
    SPECIES_SPRITE(AEGISLASH_BLADE_REDUX, gMonBackPic_Aegislash_Blade_Redux),
    SPECIES_SPRITE(AEGISLASH_REDUX, gMonBackPic_Aegislash_Redux),
    SPECIES_SPRITE(DOUBLADE_REDUX, gMonBackPic_Doublade_Redux),
    SPECIES_SPRITE(HONEDGE_REDUX, gMonBackPic_Honedge_Redux),
    SPECIES_SPRITE(RIBOMBEE_MEGA, gMonBackPic_Ribombee_Mega),
    ...
    SPECIES_SPRITE(FIDOUGH_PARTNER, gMonBackPic_Fidough),
    SPECIES_SPRITE(FIDOUGH_PARTNER_MEGA, gMonBackPic_FidoughPartnerMega),
    ...
    SPECIES_SPRITE(TINKATON1, gMonBackPic_Tinkaton),
    ...
    SPECIES_SPRITE(GREAT_TUSK, gMonBackPic_Great_Tusk),
    SPECIES_SPRITE(SCREAM_TAIL, gMonBackPic_Scream_Tail),
    SPECIES_SPRITE(BRUTE_BONNET, gMonBackPic_Brute_Bonnet),
    SPECIES_SPRITE(FLUTTER_MANE, gMonBackPic_Flutter_Mane),
    SPECIES_SPRITE(SLITHER_WING, gMonBackPic_Slither_Wing),
    SPECIES_SPRITE(SANDY_SHOCKS, gMonBackPic_Sandy_Shocks),
    SPECIES_SPRITE(IRON_TREADS, gMonBackPic_Iron_Treads),
    SPECIES_SPRITE(IRON_BUNDLE, gMonBackPic_Iron_Bundle),
    SPECIES_SPRITE(IRON_HANDS, gMonBackPic_Iron_Hands),
    SPECIES_SPRITE(IRON_JUGULIS, gMonBackPic_Iron_Jugulis),
    SPECIES_SPRITE(IRON_MOTH, gMonBackPic_Iron_Moth),
    SPECIES_SPRITE(IRON_THORNS, gMonBackPic_Iron_Thorns),
    ...
    SPECIES_SPRITE(WO_CHIEN, gMonBackPic_Wo_Chien),
    SPECIES_SPRITE(CHIEN_PAO, gMonBackPic_Chien_Pao),
    SPECIES_SPRITE(TING_LU, gMonBackPic_Ting_Lu),
    SPECIES_SPRITE(CHI_YU, gMonBackPic_Chi_Yu),
    SPECIES_SPRITE(ROARING_MOON, gMonBackPic_Roaring_Moon),
    SPECIES_SPRITE(IRON_VALIANT, gMonBackPic_Iron_Valiant),
    SPECIES_SPRITE(KORAIDON, gMonBackPic_Koraidon),
    SPECIES_SPRITE(MIRAIDON, gMonBackPic_Miraidon),
    SPECIES_SPRITE(WALKING_WAKE, gMonBackPic_Walking_Wake),
    SPECIES_SPRITE(IRON_LEAVES, gMonBackPic_Iron_Leaves),
    ...
    SPECIES_SPRITE(PHANTOWL, gMonBackPic_Phantowl),
    SPECIES_SPRITE(DUELUMBER, gMonBackPic_Duelumber),
    SPECIES_SPRITE(ESCARGINITE, gMonBackPic_Escarginite),
    SPECIES_SPRITE(ARACHTRES, gMonBackPic_Arachtres),
    SPECIES_SPRITE(FLAIRGRANCE, gMonBackPic_Flairgrance),
    SPECIES_SPRITE(POLARTIC, gMonBackPic_Polartic),
    SPECIES_SPRITE(POLARTIC_BLUEMOON, gMonBackPic_Polartic_Bluemoon),
    SPECIES_SPRITE(ARASHINNE, gMonBackPic_Arashinne),
    SPECIES_SPRITE(DREADNAUT, gMonBackPic_Dreadnaut),
    SPECIES_SPRITE(BOARLOCK, gMonBackPic_Boarlock),
    SPECIES_SPRITE(HELIOSUNNY, gMonBackPic_Heliosunny),
    SPECIES_SPRITE(SOPRANICE, gMonBackPic_Sopranice),
    SPECIES_SPRITE(BEEFENDER, gMonBackPic_Beefender),
    SPECIES_SPRITE(SALAZARUS, gMonBackPic_Salazarus),
    SPECIES_SPRITE(GOOSCHASE, gMonBackPic_Gooschase),
    SPECIES_SPRITE(LEPASTRY, gMonBackPic_Lepastry),
    SPECIES_SPRITE(GYARADEATH, gMonBackPic_Gyaradeath),
    SPECIES_SPRITE(GYARADEATH_MEGA_X, gMonBackPic_GyaradeathMegaX),
    SPECIES_SPRITE(GYARADEATH_MEGA_Y, gMonBackPic_GyaradeathMegaY),
    SPECIES_SPRITE(TORTEMPLE, gMonBackPic_Tortemple),
    SPECIES_SPRITE(BRONTONANA, gMonBackPic_Brontonana),
    SPECIES_SPRITE(DREDWOOD, gMonBackPic_Dredwood),
    SPECIES_SPRITE(KAIOSEA, gMonBackPic_Kaiosea),
    SPECIES_SPRITE(PHANFERNAL, gMonBackPic_Phanfernal),
    SPECIES_SPRITE(SKULBERUS, gMonBackPic_Skulberus),
    SPECIES_SPRITE(CORM, gMonBackPic_Corm),
    SPECIES_SPRITE(CORMOTH, gMonBackPic_Cormoth),
    SPECIES_SPRITE(CORMOTH_MEGA, gMonBackPic_CormothMega),
    SPECIES_SPRITE(POPCORM, gMonBackPic_Popcorm),
    SPECIES_SPRITE(POPCORM_MEGA, gMonBackPic_PopcormMega),
    SPECIES_SPRITE(BLIZZARD_MAW, gMonBackPic_BlizzardMaw),
    SPECIES_SPRITE(LUMBERING_SLOTH, gMonBackPic_LumberingSloth),
    SPECIES_SPRITE(LUMBERING_SLOTH_ENGULFED, gMonBackPic_LumberingSlothEngulfed),
    SPECIES_SPRITE(IRON_CARAPACE, gMonBackPic_IronCarapace),
    SPECIES_SPRITE(TURTWIG_REDUX, gMonBackPic_TurtwigRedux),
    SPECIES_SPRITE(GROTLE_REDUX, gMonBackPic_GrotleRedux),
    SPECIES_SPRITE(TORTERRA_REDUX, gMonBackPic_TorterraRedux),
    SPECIES_SPRITE(TORTERRA_REDUX_MEGA, gMonBackPic_TorterraReduxMega),
    SPECIES_SPRITE(CHIMCHAR_REDUX, gMonBackPic_ChimcharRedux),
    SPECIES_SPRITE(MONFERNO_REDUX, gMonBackPic_MonfernoRedux),
    SPECIES_SPRITE(INFERNAPE_REDUX, gMonBackPic_InfernapeRedux),
    SPECIES_SPRITE(INFERNAPE_REDUX_MEGA, gMonBackPic_InfernapeReduxMega),
    SPECIES_SPRITE(PIPLUP_REDUX, gMonBackPic_PiplupRedux),
    SPECIES_SPRITE(PRINPLUP_REDUX, gMonBackPic_PrinplupRedux),
    SPECIES_SPRITE(EMPOLEON_REDUX, gMonBackPic_EmpoleonRedux),
    SPECIES_SPRITE(EMPOLEON_REDUX_MEGA, gMonBackPic_EmpoleonReduxMega),
    SPECIES_SPRITE(BOUNSWEET_REDUX, gMonBackPic_BounsweetRedux),
    SPECIES_SPRITE(STEENEE_REDUX, gMonBackPic_SteeneeRedux),
    SPECIES_SPRITE(TSAREENA_REDUX, gMonBackPic_TsareenaRedux),
    SPECIES_SPRITE(TSAREENA_REDUX_MEGA, gMonBackPic_TsareenaReduxMega),
    SPECIES_SPRITE(TOXEL_REDUX, gMonBackPic_ToxelRedux),
    SPECIES_SPRITE(TOXTRICITY_REDUX, gMonBackPic_ToxtricityRedux),
    SPECIES_SPRITE(TOXTRICITY_REDUX_MEGA, gMonBackPic_ToxtricityReduxMega),
    SPECIES_SPRITE(TOXTRICITY_REDUX_FUZZ, gMonBackPic_ToxtricityReduxFuzz),
    SPECIES_SPRITE(TOXTRICITY_REDUX_FUZZ_MEGA, gMonBackPic_ToxtricityReduxFuzzMega),
    SPECIES_SPRITE(TRAPINCH_REDUX, gMonBackPic_TrapinchRedux),
    SPECIES_SPRITE(VIBRAVA_REDUX, gMonBackPic_VibravaRedux),
    SPECIES_SPRITE(FLYGON_REDUX, gMonBackPic_FlygonRedux),
    SPECIES_SPRITE(FLYGON_REDUX_MEGA, gMonBackPic_FlygonReduxMega),
    SPECIES_SPRITE(CRABRAWLER_REDUX, gMonBackPic_CrabrawlerRedux),
    SPECIES_SPRITE(CRABOMINABLE_REDUX, gMonBackPic_CrabominableRedux),
    SPECIES_SPRITE(CRABONINATION, gMonBackPic_Crabonination),
    SPECIES_SPRITE(CLEFFA_REDUX, gMonBackPic_CleffaRedux),
    SPECIES_SPRITE(CLEFAIRY_REDUX, gMonBackPic_ClefairyRedux),
    SPECIES_SPRITE(CLEFABLE_REDUX, gMonBackPic_ClefableRedux),
    SPECIES_SPRITE(CLEFABLE_REDUX_MEGA, gMonBackPic_ClefableReduxMega),
    SPECIES_SPRITE(GLIGAR_REDUX, gMonBackPic_GligarRedux),
    SPECIES_SPRITE(GLISCOR_REDUX, gMonBackPic_GliscorRedux),
    SPECIES_SPRITE(MAGMENOUS, gMonBackPic_Magmenous),
    SPECIES_SPRITE(PSYDUCK_REDUX, gMonBackPic_PsyduckRedux),
    SPECIES_SPRITE(SLYDUCK, gMonBackPic_Slyduck),
    SPECIES_SPRITE(SHYDUCK, gMonBackPic_Shyduck),
    SPECIES_SPRITE(SEEL_REDUX, gMonBackPic_SeelRedux),
    SPECIES_SPRITE(DEWGONG_REDUX, gMonBackPic_DewgongRedux),
    SPECIES_SPRITE(BARIONG, gMonBackPic_Bariong),
    SPECIES_SPRITE(SNORUNT_REDUX, gMonBackPic_SnoruntRedux),
    SPECIES_SPRITE(GLALIE_REDUX, gMonBackPic_GlalieRedux),
    SPECIES_SPRITE(GLALIE_REDUX_MEGA, gMonBackPic_GlalieReduxMega),
    SPECIES_SPRITE(FROSLASS_REDUX, gMonBackPic_FroslassRedux),
    SPECIES_SPRITE(FROSLASS_REDUX_MEGA, gMonBackPic_FroslassReduxMega),
    SPECIES_SPRITE(MARBEEP, gMonBackPic_Marbeep),
    SPECIES_SPRITE(FLUFFBEE, gMonBackPic_Fluffbee),
    SPECIES_SPRITE(AMPHYBUZZ, gMonBackPic_Amphybuzz),
    SPECIES_SPRITE(AMPHYBUZZ_MEGA, gMonBackPic_AmphybuzzMega),
    SPECIES_SPRITE(ARBOK_MEGA, gMonBackPic_ArbokMega),
    SPECIES_SPRITE(RAPIDASH_MEGA1, gMonBackPic_RapidashMega),
    SPECIES_SPRITE(RAPIDASH_MEGA_GALARIAN, gMonBackPic_RapidashMegaGalarian),
    SPECIES_SPRITE(ORICORIO_MEGA, gMonBackPic_OricorioMega),
    SPECIES_SPRITE(TINKATON_MEGA1, gMonBackPic_Tinkaton_Mega),
    SPECIES_SPRITE(AEGISLASH_REDUX_MEGA, gMonBackPic_AegislashReduxMega),
    SPECIES_SPRITE(HYDREIGON_REDUX_MEGA, gMonBackPic_HydreigonReduxMega),
    SPECIES_SPRITE(AEGISLASH_BLADE_REDUX_MEGA, gMonBackPic_AegislashBladeReduxMega),
    SPECIES_SPRITE(REUNICLUS_REDUX_MEGA, gMonBackPic_ReuniclusReduxMega),
    SPECIES_SPRITE(BUBBLEO, gMonBackPic_Bubbleo),
    SPECIES_SPRITE(HYDROAR, gMonBackPic_Hydroar),
    SPECIES_SPRITE(HYDROAR_F, gMonBackPic_HydroarF),
    SPECIES_SPRITE(KARTANA_FALLEN, gMonBackPic_Kartana_Fallen),
    SPECIES_SPRITE(KINGAMBIT_REDUX_MEGA, gMonBackPic_Kingambit_Redux_Mega),
    SPECIES_SPRITE(YVELTAL_MEGA, gMonBackPic_Yveltal_Mega),
    SPECIES_SPRITE(CALYREX_CLOUD_RIDER, gMonBackPic_Calyrex_Cloud_Rider),
    SPECIES_SPRITE(SPECTRIER_CLOUD, gMonBackPic_Spectrier_Cloud),
    SPECIES_SPRITE(SOLROCK_SYSTEM, gMonBackPic_Solrock_System),
    SPECIES_SPRITE(DARKRAI_NIGHTMARE, gMonBackPic_Darkrai_Nightmare),
    SPECIES_SPRITE(ESPEON_GALAXY, gMonBackPic_Espeon_Galaxy),
    SPECIES_SPRITE(MIMIKYU_APEX, gMonBackPic_Mimikyu),
    SPECIES_SPRITE(MIMIKYU_APEX_BUSTED, gMonBackPic_MimikyuBusted),
    SPECIES_SPRITE(MIMIKYU_RAYQUAZA, gMonBackPic_Mimikyu_Rayquaza),
    SPECIES_SPRITE(MIMIKYU_RAYQUAZA_BUSTED, gMonBackPic_Mimikyu_RayquazaBusted),
    SPECIES_SPRITE(BEWEAR_ANGRY, gMonBackPic_Bewear_Angry),
    SPECIES_SPRITE(ABOMASNOW_SANTA, gMonBackPic_Abomasnow_Santa),
    SPECIES_SPRITE(WEAVILE_REDUX_MEGA, gMonBackPic_Weavile_Redux_Mega),
    SPECIES_SPRITE(WEAVILE_REDUX, gMonBackPic_Weavile_Redux),
    SPECIES_SPRITE(RIBOMBEE_REDUX_MEGA, gMonBackPic_Ribombee_Redux_Mega),
    SPECIES_SPRITE(RIBOMBEE_REDUX, gMonBackPic_Ribombee_Redux),
    SPECIES_SPRITE(MAWILE_REDUX_B_MEGA, gMonBackPic_Mawile_Redux_B_Mega),
    SPECIES_SPRITE(MAWILE_REDUX_B, gMonBackPic_Mawile_Redux_B),
    SPECIES_SPRITE(FLYGON_REDUX_B_MEGA, gMonBackPic_Flygon_Redux_B_Mega),
    SPECIES_SPRITE(FLYGON_REDUX_B, gMonBackPic_Flygon_Redux_B),
    SPECIES_SPRITE(WIGGLYTUFF_PRIMAL1, gMonBackPic_Wigglytuff_Primal),
    SPECIES_SPRITE(WIGGLYTUFF_APEX1,  gMonBackPic_WigglytuffApex),
    SPECIES_SPRITE(VICTINI_PRIMAL, gMonBackPic_Victini_Primal),
    SPECIES_SPRITE(SNORLAX_PRIMAL, gMonBackPic_Snorlax_Primal),
    SPECIES_SPRITE(LEDIAN_PARADOX, gMonBackPic_Ledian_Paradox),
    SPECIES_SPRITE(DRACOVISH_MEGA, gMonBackPic_Dracovish_Mega),
    SPECIES_SPRITE(CHIEN_PAO_MEGA, gMonBackPic_Chien_Pao_Mega),
    SPECIES_SPRITE(DRAGONITE_DELIVERY, gMonBackPic_Dragonite_Delivery),
    SPECIES_SPRITE(ARCHALUDON, gMonBackPic_Archaludon),
    SPECIES_SPRITE(GOUGING_FIRE, gMonBackPic_Gouging_Fire),
    SPECIES_SPRITE(IRON_BOULDER, gMonBackPic_Iron_Boulder),
    SPECIES_SPRITE(IRON_CROWN, gMonBackPic_Iron_Crown),
    SPECIES_SPRITE(PECHARUNT, gMonBackPic_Pecharunt),
    SPECIES_SPRITE(TERAPAGOS, gMonBackPic_Terapagos),
    SPECIES_SPRITE(TERAPAGOS_STELLAR, gMonBackPic_Terapagos_Stellar),
    SPECIES_SPRITE(RAGING_BOLT, gMonBackPic_Raging_Bolt),
    SPECIES_SPRITE(ESCARGINITE_REDUX, gMonBackPic_Escarginite_Redux),
    SPECIES_SPRITE(HYDRAPPLE, gMonBackPic_Hydrapple),
    SPECIES_SPRITE(BASCULIN_WHITESTRIPED, gMonBackPic_Basculin_Whitestriped),
    SPECIES_SPRITE(ZOROARK_HISUIAN, gMonBackPic_Zoroark_Hisuian),
    SPECIES_SPRITE(WOOPER_PALDEAN, gMonBackPic_Wooper_Paldean),
    SPECIES_SPRITE(SCIZOR_REDUX, gMonBackPic_Scizor_Redux),
    SPECIES_SPRITE(IRON_EXO, gMonBackPic_Iron_Exo),
    SPECIES_SPRITE(URSALUNA_MEGA, gMonBackPic_Ursaluna_Mega),
    SPECIES_SPRITE(TYRANITAR_MEGA_REDUX, gMonBackPic_Tyranitar_Mega_Redux),
    SPECIES_SPRITE(TYRANITAR_REDUX, gMonBackPic_Tyranitar_Redux),
    SPECIES_SPRITE(PUPITAR_REDUX, gMonBackPic_Pupitar_Redux),
    SPECIES_SPRITE(LARVITAR_REDUX, gMonBackPic_Larvitar_Redux),
    SPECIES_SPRITE(CASTFORM_SANDY, gMonBackPic_Castform_Sandy),
    SPECIES_SPRITE(KINGAMBIT_REDUX, gMonBackPic_Kingambit_Redux),
    SPECIES_SPRITE(ENAMORUS_THERIAN, gMonBackPic_Enamorus_Therian),
    SPECIES_SPRITE(DIALGA_ORIGIN, gMonBackPic_Dialga_Origin_Forme),
    SPECIES_SPRITE(PALKIA_ORIGIN, gMonBackPic_Palkia_Origin_Forme),
    SPECIES_SPRITE(OGERPON_HEARTHFLAME_MASK, gMonBackPic_Ogerpon_Hearthflame_Mask),
    SPECIES_SPRITE(OGERPON_CORNERSTONE_MASK, gMonBackPic_Ogerpon_Cornerstone_Mask),
    SPECIES_SPRITE(OGERPON_WELLSPRING_MASK, gMonBackPic_Ogerpon_Wellspring_Mask),
    SPECIES_SPRITE(SQUAWKABILLY_WHITE_PLUMAGE, gMonBackPic_Squawkabilly_White_Plumage),
    SPECIES_SPRITE(SQUAWKABILLY_YELLOW_PLUMAGE, gMonBackPic_Squawkabilly_Yellow_Plumage),
    SPECIES_SPRITE(SQUAWKABILLY_BLUE_PLUMAGE, gMonBackPic_Squawkabilly_Blue_Plumage),
    SPECIES_SPRITE(SQUAWKABILLY_GREEN_PLUMAGE, gMonBackPic_Squawkabilly_Green_Plumage),
    SPECIES_SPRITE(TATSUGIRI_DROOPY, gMonBackPic_Tatsugiri_Droopy),
    SPECIES_SPRITE(TATSUGIRI_STRETCHY, gMonBackPic_Tatsugiri_Stretchy),
    SPECIES_SPRITE(TATSUGIRI_CURLY, gMonBackPic_Tatsugiri_Curly),
    SPECIES_SPRITE(MAUSHOLD_FOUR, gMonBackPic_Maushold_Four),
    SPECIES_SPRITE(DUDUNSPARCE_THREE_SEGMENT, gMonBackPic_Dudunsparce_Three_Segment),
    SPECIES_SPRITE(PALAFIN_HERO, gMonBackPic_Palafin_Hero),
    SPECIES_SPRITE(URSALUNA_BLOODMOON, gMonBackPic_Ursaluna_Bloodmoon),
    SPECIES_SPRITE(TAUROS_PALDEAN_COMBAT_BREED, gMonBackPic_Tauros_Paldean_Combat_Breed),
    SPECIES_SPRITE(TAUROS_PALDEAN_BLAZE_BREED, gMonBackPic_Tauros_Paldean_Blaze_Breed),
    SPECIES_SPRITE(TAUROS_PALDEAN_AQUA_BREED, gMonBackPic_Tauros_Paldean_Aqua_Breed),
    SPECIES_SPRITE(DECIDUEYE_HISUIAN, gMonBackPic_Decidueye_Hisuian),
    SPECIES_SPRITE(AVALUGG_HISUIAN, gMonBackPic_Avalugg_Hisuian),
    SPECIES_SPRITE(GOODRA_HISUIAN, gMonBackPic_Goodra_Hisuian),
    SPECIES_SPRITE(SLIGGOO_HISUIAN, gMonBackPic_Sliggoo_Hisuian),
    SPECIES_SPRITE(BRAVIARY_HISUIAN, gMonBackPic_Braviary_Hisuian),
    SPECIES_SPRITE(ZORUA_HISUIAN, gMonBackPic_Zorua_Hisuian),
    SPECIES_SPRITE(LILLIGANT_HISUIAN, gMonBackPic_Lilligant_Hisuian),
    SPECIES_SPRITE(SAMUROTT_HISUIAN, gMonBackPic_Samurott_Hisuian),
    SPECIES_SPRITE(SNEASEL_HISUIAN, gMonBackPic_Sneasel_Hisuian),
    SPECIES_SPRITE(TYPHLOSION_HISUIAN, gMonBackPic_Typhlosion_Hisuian),
    SPECIES_SPRITE(ELECTRODE_HISUIAN, gMonBackPic_Electrode_Hisuian),
    SPECIES_SPRITE(VOLTORB_HISUIAN, gMonBackPic_Voltorb_Hisuian),
    SPECIES_SPRITE(ARCANINE_HISUIAN, gMonBackPic_Arcanine_Hisuian),
    SPECIES_SPRITE(GROWLITHE_HISUIAN, gMonBackPic_Growlithe_Hisuian),
    SPECIES_SPRITE(QWILFISH_HISUIAN, gMonBackPic_Qwilfish_Hisuian),
    SPECIES_SPRITE(BASCULEGION, gMonBackPic_Basculegion),
    SPECIES_SPRITE(BASCULEGION_F, gMonBackPic_BasculegionF),

    SPECIES_SPRITE(VENUSAUR_MEGA, gMonBackPic_VenusaurMega),
    SPECIES_SPRITE(VENUSAUR_MEGA_X, gMonBackPic_VenusaurMegaX),
    SPECIES_SPRITE(CHARIZARD_MEGA_X, gMonBackPic_CharizardMegaX),
    SPECIES_SPRITE(CHARIZARD_MEGA_Y, gMonBackPic_CharizardMegaY),
    SPECIES_SPRITE(CHARIZARD_MEGA_Z, gMonBackPic_CharizardMegaZ),
    SPECIES_SPRITE(BLASTOISE_MEGA, gMonBackPic_BlastoiseMega),
    SPECIES_SPRITE(BLASTOISE_MEGA_X, gMonBackPic_BlastoiseMegaX),
    ...
    SPECIES_SPRITE(GENGAR_MEGA_X, gMonBackPic_GengarMegaX),
    ...
    SPECIES_SPRITE(DEWGONG_MEGA, gMonBackPic_DewgongMega),
    SPECIES_SPRITE(HITMONCHAN_MEGA1, gMonBackPic_HitmonchanMega),
    SPECIES_SPRITE(HITMONLEE_MEGA, gMonBackPic_HitmonleeMega),
    SPECIES_SPRITE(HITMONTOP_MEGA, gMonBackPic_HitmontopMega),
    SPECIES_SPRITE(CROBAT_MEGA, gMonBackPic_CrobatMega),
    SPECIES_SPRITE(SKARMORY_MEGA, gMonBackPic_SkarmoryMega),
    SPECIES_SPRITE(BRUXISH_MEGA, gMonBackPic_BruxishMega),
    SPECIES_SPRITE(TORTERRA_MEGA, gMonBackPic_TorterraMega),
    SPECIES_SPRITE(INFERNAPE_MEGA, gMonBackPic_InfernapeMega),
    SPECIES_SPRITE(EMPOLEON_MEGA, gMonBackPic_EmpoleonMega),
    SPECIES_SPRITE(SHUCKLE_MEGA,      gMonBackPic_ShuckleMega),
    SPECIES_SPRITE(RELICANTH_MEGA,    gMonBackPic_RelicanthMega),
    SPECIES_SPRITE(QUAGSIRE_MEGA,     gMonBackPic_QuagsireMega),
    SPECIES_SPRITE(JELLICENT_MEGA,    gMonBackPic_JellicentMega),
    SPECIES_SPRITE(TOUCANNON_MEGA,    gMonBackPic_ToucannonMega),
    SPECIES_SPRITE(DRAGONITE_MEGA,    gMonBackPic_DragoniteMega),
    SPECIES_SPRITE(BRELOOM_MEGA,      gMonBackPic_BreloomMega),
    SPECIES_SPRITE(SLAKING_MEGA,      gMonBackPic_SlakingMega),
    SPECIES_SPRITE(SLAKING_MEGA_APE_SHIFT,      gMonBackPic_SlakingMegaApeShift),
    SPECIES_SPRITE(FERALIGATR_MEGA_X, gMonBackPic_FeraligatrMegaX),
    SPECIES_SPRITE(FERALIGATR_MEGA_Y, gMonBackPic_FeraligatrMegaY),
    SPECIES_SPRITE(GRANBULL_MEGA,     gMonBackPic_GranbullMega),
    SPECIES_SPRITE(GYARADOS_MEGA_Y,   gMonBackPic_GyaradosMegaY),
    SPECIES_SPRITE(HAXORUS_MEGA,      gMonBackPic_HaxorusMega),
    SPECIES_SPRITE(KINGDRA_MEGA_Y,    gMonBackPic_KingdraMegaY),
    SPECIES_SPRITE(LUXRAY_MEGA,       gMonBackPic_LuxrayMega),
    SPECIES_SPRITE(NIDOKING_MEGA,     gMonBackPic_NidokingMega),
    SPECIES_SPRITE(NIDOQUEEN_MEGA,    gMonBackPic_NidoqueenMega),
    SPECIES_SPRITE(SANDSLASH_MEGA,    gMonBackPic_SandslashMega),
    SPECIES_SPRITE(TYPHLOSION_MEGA,   gMonBackPic_TyphlosionMega),
    SPECIES_SPRITE(MEGANIUM_MEGA1,     gMonBackPic_MeganiumMega),
    SPECIES_SPRITE(SLOWKING_MEGA,     gMonBackPic_SlowkingMega),
    SPECIES_SPRITE(KROOKODILE_MEGA,   gMonBackPic_KrookodileMega),
    SPECIES_SPRITE(MAGNEZONE_MEGA,    gMonBackPic_MagnezoneMega),
    ...
    SPECIES_SPRITE(WIGGLYTUFF_MEGA1,   gMonBackPic_WigglytuffMega),
    SPECIES_SPRITE(WIGGLYTUFF_MEGA_X1,   gMonBackPic_WigglytuffMegaX),
    SPECIES_SPRITE(LUCARIO_MEGA_Y,   gMonBackPic_LucarioMegaY),
    SPECIES_SPRITE(CLAWITZER_REDUX, gMonBackPic_ClawitzerRedux),
    SPECIES_SPRITE(KECLEONG,           gMonBackPic_Kecleong),
    ...
    SPECIES_SPRITE(UNOWN_B1, gMonBackPic_UnownB),
    SPECIES_SPRITE(UNOWN_C1, gMonBackPic_UnownC),
    SPECIES_SPRITE(STEVE_REALER, gMonBackPic_UnownD),
    SPECIES_SPRITE(UNOWN_E1, gMonBackPic_UnownE),
    SPECIES_SPRITE(UNOWN_F1, gMonBackPic_UnownF),
    SPECIES_SPRITE(UNOWN_G1, gMonBackPic_UnownG),
    SPECIES_SPRITE(OBAMASNOW_MEGA, gMonBackPic_UnownH),
    SPECIES_SPRITE(UNOWN_I1, gMonBackPic_UnownI),
    SPECIES_SPRITE(UNOWN_J1, gMonBackPic_UnownJ),
    SPECIES_SPRITE(UNOWN_K1, gMonBackPic_UnownK),
    SPECIES_SPRITE(UNOWN_L1, gMonBackPic_UnownL),
    SPECIES_SPRITE(UNOWN_M1, gMonBackPic_UnownM),
    SPECIES_SPRITE(UNOWN_N1, gMonBackPic_UnownN),
    SPECIES_SPRITE(UNOWN_O1, gMonBackPic_UnownO),
    SPECIES_SPRITE(PEPSICHAMP_MEGA, gMonBackPic_UnownP),
    SPECIES_SPRITE(UNOWN_Q1, gMonBackPic_UnownQ),
    SPECIES_SPRITE(UNOWN_R1, gMonBackPic_UnownR),
    SPECIES_SPRITE(UNOWN_S1, gMonBackPic_UnownS),
    SPECIES_SPRITE(UNOWN_T1, gMonBackPic_UnownT),
    SPECIES_SPRITE(BOWSERSTOISE_MEGA, gMonBackPic_UnownU),
    SPECIES_SPRITE(UNOWN_V1, gMonBackPic_UnownV),
    ...
    SPECIES_SPRITE(CASTFORM_FOGGY, gMonBackPic_CastformFoggy),
    ...
    SPECIES_SPRITE(WEAVILE_MEGA, gMonBackPic_WeavileMega),
    ...
    SPECIES_SPRITE(DEWPIDER_REDUX, gMonBackPic_DewpiderRedux),
    SPECIES_SPRITE(ARAQUANID_REDUX, gMonBackPic_AraquanidRedux),
    SPECIES_SPRITE(FROSTULA, gMonBackPic_Frostula),
    ...
    SPECIES_SPRITE(MORPEKYLL_HANGRY, gMonBackPic_MorpekyllHangry),
    ...
    SPECIES_SPRITE(SAMUROTT_HISUIAN_MEGA, gMonBackPic_SamurottHisuianMega),
    ...
    SPECIES_SPRITE(DUDUDUNSPARCE, gMonBackPic_Dududunsparce),
    SPECIES_SPRITE(DUDUDUNSPARCE_MEGA, gMonBackPic_DududunsparceMega),
};
