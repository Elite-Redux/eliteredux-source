const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(LUMBERING_SLOTH_OVERGROWN, gMonBackPic_LumberingSloth_Overgrown),
    ...
    SPECIES_SPRITE(RATICATE_REDUX, gMonBackPic_Raticate_Redux),
    SPECIES_SPRITE(RATTATA_REDUX, gMonBackPic_Rattata_Redux),
    ...
    SPECIES_SPRITE(MINCCINO_REDUX, gMonBackPic_MinccinoRedux),
    SPECIES_SPRITE(CINCCINO_REDUX, gMonBackPic_CinccinoRedux),
