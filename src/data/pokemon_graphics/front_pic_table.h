const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(WIGGLYTUFF_PRIMAL, gMonFrontPic_Wigglytuff_Primal),
    SPECIES_SPRITE(WIGGLYTUFF_APEX, gMonFrontPic_WigglytuffApex),
    ...
    SPECIES_SPRITE(WIGGLYTUFF_MEGA,   gMonFrontPic_WigglytuffMega),
    SPECIES_SPRITE(WIGGLYTUFF_MEGA_X,   gMonFrontPic_WigglytuffMegaX),
