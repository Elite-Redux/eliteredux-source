const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(PIKACHU_PARTNER_MEGA, gMonFrontPic_PikachuPartnerMega),
    ...
    SPECIES_SPRITE(WIGGLYTUFF1, gMonFrontPic_Wigglytuff),
    ...
    SPECIES_SPRITE(MEOWTH_PARTNER, gMonFrontPic_MeowthPartner),
    SPECIES_SPRITE(MEOWTH_PARTNER_MEGA, gMonFrontPic_MeowthPartnerMega),
    ...
    SPECIES_SPRITE(RAPIDASH1, gMonFrontPic_Rapidash),
    ...
    SPECIES_SPRITE(HITMONCHAN1, gMonFrontPic_Hitmonchan),
    ...
    SPECIES_SPRITE(EEVEE_PARTNER_MEGA, gMonFrontPic_EeveePartnerMega),
    ...
    SPECIES_SPRITE(CRAWDAUNTLES, gMonFrontPic_Crawdauntles),
    ...
    SPECIES_SPRITE(LUMINOSITEON, gMonFrontPic_Luminositeon),
    ...
    SPECIES_SPRITE(SAGARACAS, gMonFrontPic_Sagaracas),
    ...
    SPECIES_SPRITE(MUDSDALE1, gMonFrontPic_Mudsdale),
    ...
    SPECIES_SPRITE(BLACEPHALON1, gMonFrontPic_Blacephalon),
    ...
    SPECIES_SPRITE(FUJIFLAP, gMonFrontPic_Fujiflap),
    SPECIES_SPRITE(APPLETUN, gMonFrontPic_Appletun),
    SPECIES_SPRITE(GRANITUN, gMonFrontPic_Granitun),
    ...
    SPECIES_SPRITE(DURALUDON_PARTNER, gMonFrontPic_Duraludon),
    SPECIES_SPRITE(DURALUDON_PARTNER_MEGA, gMonFrontPic_DuraludonPartnerMega),
    ...
    SPECIES_SPRITE(BEWARDEN, gMonFrontPic_Bewarden),
    ...
    SPECIES_SPRITE(TINKATON1, gMonFrontPic_Tinkaton),
    ...
    SPECIES_SPRITE(ARACHTRES, gMonFrontPic_Arachtres),
    SPECIES_SPRITE(FLAIRGRANCE, gMonFrontPic_Flairgrance),
    SPECIES_SPRITE(POLARTIC, gMonFrontPic_Polartic),
    SPECIES_SPRITE(POLARTIC_BLUEMOON, gMonFrontPic_Polartic_Bluemoon),
    SPECIES_SPRITE(ARASHINNE, gMonFrontPic_Arashinne),
    SPECIES_SPRITE(DREADNAUT, gMonFrontPic_Dreadnaut),
    SPECIES_SPRITE(BOARLOCK, gMonFrontPic_Boarlock),
    SPECIES_SPRITE(HELIOSUNNY, gMonFrontPic_Heliosunny),
    SPECIES_SPRITE(SOPRANICE, gMonFrontPic_Sopranice),
    SPECIES_SPRITE(BEEFENDER, gMonFrontPic_Beefender),
    SPECIES_SPRITE(SALAZARUS, gMonFrontPic_Salazarus),
    SPECIES_SPRITE(GOOSCHASE, gMonFrontPic_Gooschase),
    SPECIES_SPRITE(LEPASTRY, gMonFrontPic_Lepastry),
    SPECIES_SPRITE(GYARADEATH, gMonFrontPic_Gyaradeath),
    SPECIES_SPRITE(GYARADEATH_MEGA_X, gMonFrontPic_GyaradeathMegaX),
    SPECIES_SPRITE(GYARADEATH_MEGA_Y, gMonFrontPic_GyaradeathMegaY),
    SPECIES_SPRITE(TORTEMPLE, gMonFrontPic_Tortemple),
    SPECIES_SPRITE(BRONTONANA, gMonFrontPic_Brontonana),
    SPECIES_SPRITE(DREDWOOD, gMonFrontPic_Dredwood),
    SPECIES_SPRITE(KAIOSEA, gMonFrontPic_Kaiosea),
    SPECIES_SPRITE(PHANFERNAL, gMonFrontPic_Phanfernal),
    SPECIES_SPRITE(SKULBERUS, gMonFrontPic_Skulberus),
    SPECIES_SPRITE(MARBEEP, gMonFrontPic_Marbeep),
    SPECIES_SPRITE(FLUFFBEE, gMonFrontPic_Fluffbee),
    SPECIES_SPRITE(AMPHYBUZZ, gMonFrontPic_Amphybuzz),
    SPECIES_SPRITE(AMPHYBUZZ_MEGA, gMonFrontPic_AmphybuzzMega),
    SPECIES_SPRITE(CORM, gMonFrontPic_Corm),
    SPECIES_SPRITE(CORMOTH, gMonFrontPic_Cormoth),
    SPECIES_SPRITE(CORMOTH_MEGA, gMonFrontPic_CormothMega),
    SPECIES_SPRITE(POPCORM, gMonFrontPic_Popcorm),
    SPECIES_SPRITE(LUMBERING_SLOTH, gMonFrontPic_LumberingSloth),
    SPECIES_SPRITE(LUMBERING_SLOTH_ENGULFED, gMonFrontPic_LumberingSlothEngulfed),
    SPECIES_SPRITE(BLIZZARD_MAW, gMonFrontPic_BlizzardMaw),
    SPECIES_SPRITE(IRON_CARAPACE, gMonFrontPic_IronCarapace),
    SPECIES_SPRITE(TURTWIG_REDUX, gMonFrontPic_TurtwigRedux),
    SPECIES_SPRITE(GROTLE_REDUX, gMonFrontPic_GrotleRedux),
    SPECIES_SPRITE(TORTERRA_REDUX, gMonFrontPic_TorterraRedux),
    ...
    SPECIES_SPRITE(PIPLUP_REDUX, gMonFrontPic_PiplupRedux),
    SPECIES_SPRITE(PRINPLUP_REDUX, gMonFrontPic_PrinplupRedux),
    SPECIES_SPRITE(EMPOLEON_REDUX, gMonFrontPic_EmpoleonRedux),
    SPECIES_SPRITE(EMPOLEON_REDUX_MEGA, gMonFrontPic_EmpoleonReduxMega),
    SPECIES_SPRITE(BOUNSWEET_REDUX, gMonFrontPic_BounsweetRedux),
    SPECIES_SPRITE(STEENEE_REDUX, gMonFrontPic_SteeneeRedux),
    SPECIES_SPRITE(TSAREENA_REDUX, gMonFrontPic_TsareenaRedux),
    SPECIES_SPRITE(TSAREENA_REDUX_MEGA, gMonFrontPic_TsareenaReduxMega),
    SPECIES_SPRITE(TOXEL_REDUX, gMonFrontPic_ToxelRedux),
    SPECIES_SPRITE(TOXTRICITY_REDUX, gMonFrontPic_ToxtricityRedux),
    SPECIES_SPRITE(TOXTRICITY_REDUX_MEGA, gMonFrontPic_ToxtricityReduxMega),
    SPECIES_SPRITE(TOXTRICITY_REDUX_FUZZ, gMonFrontPic_ToxtricityReduxFuzz),
    SPECIES_SPRITE(TOXTRICITY_REDUX_FUZZ_MEGA, gMonFrontPic_ToxtricityReduxFuzzMega),
    SPECIES_SPRITE(TRAPINCH_REDUX, gMonFrontPic_TrapinchRedux),
    SPECIES_SPRITE(VIBRAVA_REDUX, gMonFrontPic_VibravaRedux),
    SPECIES_SPRITE(FLYGON_REDUX, gMonFrontPic_FlygonRedux),
    SPECIES_SPRITE(FLYGON_REDUX_MEGA, gMonFrontPic_FlygonReduxMega),
    SPECIES_SPRITE(CRABRAWLER_REDUX, gMonFrontPic_CrabrawlerRedux),
    SPECIES_SPRITE(CRABOMINABLE_REDUX, gMonFrontPic_CrabominableRedux),
    SPECIES_SPRITE(CRABONINATION, gMonFrontPic_Crabonination),
    SPECIES_SPRITE(CLEFFA_REDUX, gMonFrontPic_CleffaRedux),
    SPECIES_SPRITE(CLEFAIRY_REDUX, gMonFrontPic_ClefairyRedux),
    SPECIES_SPRITE(CLEFABLE_REDUX, gMonFrontPic_ClefableRedux),
    SPECIES_SPRITE(CLEFABLE_REDUX_MEGA, gMonFrontPic_ClefableReduxMega),
    SPECIES_SPRITE(GLIGAR_REDUX, gMonFrontPic_GligarRedux),
    SPECIES_SPRITE(GLISCOR_REDUX, gMonFrontPic_GliscorRedux),
    SPECIES_SPRITE(MAGMENOUS, gMonFrontPic_Magmenous),
    SPECIES_SPRITE(PSYDUCK_REDUX, gMonFrontPic_PsyduckRedux),
    ...
    SPECIES_SPRITE(BARIONG, gMonFrontPic_Bariong),
    SPECIES_SPRITE(SNORUNT_REDUX, gMonFrontPic_SnoruntRedux),
    SPECIES_SPRITE(GLALIE_REDUX, gMonFrontPic_GlalieRedux),
    SPECIES_SPRITE(GLALIE_REDUX_MEGA, gMonFrontPic_GlalieReduxMega),
    SPECIES_SPRITE(FROSLASS_REDUX, gMonFrontPic_FroslassRedux),
    SPECIES_SPRITE(FROSLASS_REDUX_MEGA, gMonFrontPic_FroslassReduxMega),
    SPECIES_SPRITE(POPCORM_MEGA, gMonFrontPic_PopcormMega),
    SPECIES_SPRITE(ARBOK_MEGA, gMonFrontPic_ArbokMega),
    SPECIES_SPRITE(GOLISOPOD_MEGA, gMonFrontPic_GolisopodMega),
    SPECIES_SPRITE(RAPIDASH_MEGA1, gMonFrontPic_RapidashMega),
    SPECIES_SPRITE(RAPIDASH_MEGA_GALARIAN, gMonFrontPic_RapidashMegaGalarian),
    SPECIES_SPRITE(ORICORIO_MEGA, gMonFrontPic_OricorioMega),
    SPECIES_SPRITE(HYDREIGON_REDUX_MEGA, gMonFrontPic_HydreigonReduxMega),
    SPECIES_SPRITE(AEGISLASH_REDUX_MEGA, gMonFrontPic_AegislashReduxMega),
    SPECIES_SPRITE(AEGISLASH_BLADE_REDUX_MEGA, gMonFrontPic_AegislashBladeReduxMega),
    SPECIES_SPRITE(REUNICLUS_REDUX_MEGA, gMonFrontPic_ReuniclusReduxMega),
    SPECIES_SPRITE(TINKATON_MEGA1, gMonFrontPic_Tinkaton_Mega),
    SPECIES_SPRITE(BUBBLEO, gMonFrontPic_Bubbleo),
    SPECIES_SPRITE(HYDROAR, gMonFrontPic_Hydroar),
    SPECIES_SPRITE(HYDROAR_F, gMonFrontPic_HydroarF),
    SPECIES_SPRITE(KARTANA_FALLEN, gMonFrontPic_Kartana_Fallen),
    SPECIES_SPRITE(KINGAMBIT_REDUX_MEGA, gMonFrontPic_Kingambit_Redux_Mega),
    SPECIES_SPRITE(YVELTAL_MEGA, gMonFrontPic_Yveltal_Mega),
    SPECIES_SPRITE(CALYREX_CLOUD_RIDER, gMonFrontPic_Calyrex_Cloud_Rider),
    SPECIES_SPRITE(SPECTRIER_CLOUD, gMonFrontPic_Spectrier_Cloud),
    ...
    SPECIES_SPRITE(WEAVILE_REDUX_MEGA, gMonFrontPic_Weavile_Redux_Mega),
    SPECIES_SPRITE(WEAVILE_REDUX, gMonFrontPic_Weavile_Redux),
    SPECIES_SPRITE(RIBOMBEE_REDUX_MEGA, gMonFrontPic_Ribombee_Redux_Mega),
    SPECIES_SPRITE(RIBOMBEE_REDUX, gMonFrontPic_Ribombee_Redux),
    SPECIES_SPRITE(MAWILE_REDUX_B_MEGA, gMonFrontPic_Mawile_Redux_B_Mega),
    SPECIES_SPRITE(MAWILE_REDUX_B, gMonFrontPic_Mawile_Redux_B),
    SPECIES_SPRITE(FLYGON_REDUX_B_MEGA, gMonFrontPic_Flygon_Redux_B_Mega),
    SPECIES_SPRITE(FLYGON_REDUX_B, gMonFrontPic_Flygon_Redux_B),
    SPECIES_SPRITE(WIGGLYTUFF_PRIMAL1, gMonFrontPic_Wigglytuff_Primal),
    SPECIES_SPRITE(WIGGLYTUFF_APEX1, gMonFrontPic_WigglytuffApex),
    SPECIES_SPRITE(VICTINI_PRIMAL, gMonFrontPic_Victini_Primal),
    SPECIES_SPRITE(SNORLAX_PRIMAL, gMonFrontPic_Snorlax_Primal),
    SPECIES_SPRITE(LEDIAN_PARADOX, gMonFrontPic_Ledian_Paradox),
    SPECIES_SPRITE(DRACOVISH_MEGA, gMonFrontPic_Dracovish_Mega),
    SPECIES_SPRITE(CHIEN_PAO_MEGA, gMonFrontPic_Chien_Pao_Mega),
    SPECIES_SPRITE(DRAGONITE_DELIVERY, gMonFrontPic_Dragonite_Delivery),
    SPECIES_SPRITE(ARCHALUDON, gMonFrontPic_Archaludon),
    SPECIES_SPRITE(GOUGING_FIRE, gMonFrontPic_Gouging_Fire),
    SPECIES_SPRITE(IRON_BOULDER, gMonFrontPic_Iron_Boulder),
    SPECIES_SPRITE(IRON_CROWN, gMonFrontPic_Iron_Crown),
    SPECIES_SPRITE(PECHARUNT, gMonFrontPic_Pecharunt),
    SPECIES_SPRITE(TERAPAGOS, gMonFrontPic_Terapagos),
    SPECIES_SPRITE(TERAPAGOS_STELLAR, gMonFrontPic_Terapagos_Stellar),
    SPECIES_SPRITE(RAGING_BOLT, gMonFrontPic_Raging_Bolt),
    ...
    SPECIES_SPRITE(IRON_EXO, gMonFrontPic_Iron_Exo),
    ...
    SPECIES_SPRITE(BASCULEGION_F, gMonFrontPic_BasculegionF),

    SPECIES_SPRITE(VENUSAUR_MEGA, gMonFrontPic_VenusaurMega),
    SPECIES_SPRITE(VENUSAUR_MEGA_X, gMonFrontPic_VenusaurMegaX),
    SPECIES_SPRITE(CHARIZARD_MEGA_X, gMonFrontPic_CharizardMegaX),
    SPECIES_SPRITE(CHARIZARD_MEGA_Y, gMonFrontPic_CharizardMegaY),
    SPECIES_SPRITE(CHARIZARD_MEGA_Z, gMonFrontPic_CharizardMegaZ),
    SPECIES_SPRITE(BLASTOISE_MEGA, gMonFrontPic_BlastoiseMega),
    SPECIES_SPRITE(BLASTOISE_MEGA_X, gMonFrontPic_BlastoiseMegaX),
    ...
    SPECIES_SPRITE(GENGAR_MEGA_X, gMonFrontPic_GengarMegaX),
    SPECIES_SPRITE(KNAIVER, gMonFrontPic_Knaiver),
    SPECIES_SPRITE(BURMY_ETERNA, gMonFrontPic_BurmyEterna),
    ...
    SPECIES_SPRITE(LUCARIO_MEGA_Y, gMonFrontPic_LucarioMegaY),
    ...
    SPECIES_SPRITE(HITMONCHAN_MEGA1,   gMonFrontPic_HitmonchanMega),
    ...
    SPECIES_SPRITE(SLAKING_MEGA_APE_SHIFT,      gMonFrontPic_SlakingMegaApeShift),
    ...
    SPECIES_SPRITE(MEGANIUM_MEGA1,     gMonFrontPic_MeganiumMega),
    ...
    SPECIES_SPRITE(WIGGLYTUFF_MEGA1,   gMonFrontPic_WigglytuffMega),
    SPECIES_SPRITE(WIGGLYTUFF_MEGA_X1,   gMonFrontPic_WigglytuffMegaX),
    SPECIES_SPRITE(CLAWITZER_REDUX, gMonFrontPic_ClawitzerRedux),
    SPECIES_SPRITE(KECLEONG,           gMonFrontPic_Kecleong),
    ...
    SPECIES_SPRITE(UNOWN_B1, gMonFrontPic_UnownB),
    SPECIES_SPRITE(UNOWN_C1, gMonFrontPic_UnownC),
    SPECIES_SPRITE(STEVE_REALER, gMonFrontPic_UnownD),
    SPECIES_SPRITE(UNOWN_E1, gMonFrontPic_UnownE),
    SPECIES_SPRITE(UNOWN_F1, gMonFrontPic_UnownF),
    SPECIES_SPRITE(UNOWN_G1, gMonFrontPic_UnownG),
    SPECIES_SPRITE(OBAMASNOW_MEGA, gMonFrontPic_UnownH),
    SPECIES_SPRITE(UNOWN_I1, gMonFrontPic_UnownI),
    SPECIES_SPRITE(UNOWN_J1, gMonFrontPic_UnownJ),
    SPECIES_SPRITE(UNOWN_K1, gMonFrontPic_UnownK),
    SPECIES_SPRITE(UNOWN_L1, gMonFrontPic_UnownL),
    SPECIES_SPRITE(UNOWN_M1, gMonFrontPic_UnownM),
    SPECIES_SPRITE(UNOWN_N1, gMonFrontPic_UnownN),
    SPECIES_SPRITE(UNOWN_O1, gMonFrontPic_UnownO),
    SPECIES_SPRITE(PEPSICHAMP_MEGA, gMonFrontPic_UnownP),
    SPECIES_SPRITE(UNOWN_Q1, gMonFrontPic_UnownQ),
    SPECIES_SPRITE(UNOWN_R1, gMonFrontPic_UnownR),
    SPECIES_SPRITE(UNOWN_S1, gMonFrontPic_UnownS),
    SPECIES_SPRITE(UNOWN_T1, gMonFrontPic_UnownT),
    SPECIES_SPRITE(BOWSERSTOISE_MEGA, gMonFrontPic_UnownU),
    SPECIES_SPRITE(UNOWN_V1, gMonFrontPic_UnownV),
    ...
    // PARTNER POKEMON
    SPECIES_SPRITE(AMAURA_PARTNER, gMonFrontPic_Amaura),
    SPECIES_SPRITE(AMAURA_PARTNER_B, gMonFrontPic_Amaura),
    SPECIES_SPRITE(AMAURA_PARTNER_C, gMonFrontPic_Amaura),
    SPECIES_SPRITE(AURORUS_PARTNER, gMonFrontPic_Aurorus),
    SPECIES_SPRITE(AURORUS_PARTNER_B, gMonFrontPic_Aurorus),
    SPECIES_SPRITE(AURORUS_PARTNER_C, gMonFrontPic_Aurorus),

    SPECIES_SPRITE(HITMONCHAN_PARTNER, gMonFrontPic_Hitmonchan),
    SPECIES_SPRITE(HITMONCHAN_PARTNER_B, gMonFrontPic_Hitmonchan),
    SPECIES_SPRITE(HITMONCHAN_PARTNER_C, gMonFrontPic_Hitmonchan),
    SPECIES_SPRITE(HITMONCHAN_PARTNER_MEGA, gMonFrontPic_HitmonchanMega),
    SPECIES_SPRITE(HITMONCHAN_PARTNER_MEGA_B, gMonFrontPic_HitmonchanMega),
    SPECIES_SPRITE(HITMONCHAN_PARTNER_MEGA_C, gMonFrontPic_HitmonchanMega),

    SPECIES_SPRITE(AMPHAROS_PARTNER, gMonFrontPic_Ampharos),
    ...
    SPECIES_SPRITE(VOLCARONA_PARTNER_C, gMonFrontPic_Volcarona),

    SPECIES_SPRITE(KANGASKHAN_PARTNER, gMonFrontPic_Kangaskhan),
    ...
    SPECIES_SPRITE(REUNICLUS_PARTNER_B, gMonFrontPic_Reuniclus),
    SPECIES_SPRITE(REUNICLUS_PARTNER_C, gMonFrontPic_Reuniclus),
    ...
    SPECIES_SPRITE(DEWPIDER_REDUX, gMonFrontPic_DewpiderRedux),
    SPECIES_SPRITE(ARAQUANID_REDUX, gMonFrontPic_AraquanidRedux),
    SPECIES_SPRITE(FROSTULA, gMonFrontPic_Frostula),
    SPECIES_SPRITE(CHESNAUGHT_BATTLE_BOND, gMonFrontPic_Chesnaught),
    SPECIES_SPRITE(CHESNAUGHT_CLEMONT, gMonFrontPic_ChesnaughtClemont),
    SPECIES_SPRITE(DELPHOX_BATTLE_BOND, gMonFrontPic_Delphox),
    SPECIES_SPRITE(DELPHOX_SERENA, gMonFrontPic_DelphoxSerena),
    ...
    SPECIES_SPRITE(DUDUDUNSPARCE, gMonFrontPic_Dududunsparce),
    SPECIES_SPRITE(DUDUDUNSPARCE_MEGA, gMonFrontPic_DududunsparceMega),
