const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(WIGGLYTUFF_PRIMAL, gMonPalette_Wigglytuff_Primal),
    SPECIES_PAL(WIGGLYTUFF_APEX, gMonPalette_WigglytuffApex),
    ...
    SPECIES_PAL(WIGGLYTUFF_MEGA, gMonPalette_WigglytuffMega),
    SPECIES_PAL(WIGGLYTUFF_MEGA_X, gMonPalette_WigglytuffMegaX),
