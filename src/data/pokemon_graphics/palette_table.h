const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(PIKACHU_PARTNER_MEGA, gMonPalette_PikachuPartnerMega),
    ...
    SPECIES_PAL(WIGGLYTUFF1, gMonPalette_Wigglytuff),
    ...
    SPECIES_PAL(MEOWTH_PARTNER, gMonPalette_MeowthPartner),
    SPECIES_PAL(MEOWTH_PARTNER_MEGA, gMonPalette_MeowthPartnerMega),
    ...
    SPECIES_PAL(RAPIDASH1, gMonPalette_Rapidash),
    ...
    SPECIES_PAL(HITMONCHAN1, gMonPalette_Hitmonchan),
    ...
    SPECIES_PAL(EEVEE_PARTNER_MEGA, gMonPalette_EeveePartnerMega),
    ...
    SPECIES_PAL(CRAWDAUNTLES, gMonPalette_Crawdauntles),
    ...
    SPECIES_PAL(LUMINOSITEON, gMonPalette_Luminositeon),
    ...
    SPECIES_PAL(SAGARACAS, gMonPalette_Sagaracas),
    ...
    SPECIES_PAL(MUDSDALE1, gMonPalette_Mudsdale),
    ...
    SPECIES_PAL(BLACEPHALON1, gMonPalette_Blacephalon),
    ...
    SPECIES_PAL(FUJIFLAP, gMonPalette_Fujiflap),
    SPECIES_PAL(APPLETUN, gMonPalette_Appletun),
    SPECIES_PAL(GRANITUN, gMonPalette_Granitun),
    ...
    SPECIES_PAL(DURALUDON_PARTNER, gMonPalette_DuraludonPartner),
    SPECIES_PAL(DURALUDON_PARTNER_MEGA, gMonPalette_DuraludonPartnerMega),
    ...
    SPECIES_PAL(BEWARDEN, gMonPalette_Bewarden),
    ...
    SPECIES_PAL(TINKATON1, gMonPalette_Tinkaton),
    ...
    SPECIES_PAL(ARACHTRES, gMonPalette_Arachtres),
    SPECIES_PAL(FLAIRGRANCE, gMonPalette_Flairgrance),
    SPECIES_PAL(POLARTIC, gMonPalette_Polartic),
    SPECIES_PAL(POLARTIC_BLUEMOON, gMonPalette_Polartic_Bluemoon),
    SPECIES_PAL(ARASHINNE, gMonPalette_Arashinne),
    SPECIES_PAL(DREADNAUT, gMonPalette_Dreadnaut),
    SPECIES_PAL(BOARLOCK, gMonPalette_Boarlock),
    SPECIES_PAL(HELIOSUNNY, gMonPalette_Heliosunny),
    SPECIES_PAL(SOPRANICE, gMonPalette_Sopranice),
    SPECIES_PAL(BEEFENDER, gMonPalette_Beefender),
    SPECIES_PAL(SALAZARUS, gMonPalette_Salazarus),
    SPECIES_PAL(GOOSCHASE, gMonPalette_Gooschase),
    SPECIES_PAL(LEPASTRY, gMonPalette_Lepastry),
    SPECIES_PAL(GYARADEATH, gMonPalette_Gyaradeath),
    SPECIES_PAL(GYARADEATH_MEGA_X, gMonPalette_GyaradeathMegaX),
    SPECIES_PAL(GYARADEATH_MEGA_Y, gMonPalette_GyaradeathMegaY),
    SPECIES_PAL(TORTEMPLE, gMonPalette_Tortemple),
    SPECIES_PAL(BRONTONANA, gMonPalette_Brontonana),
    SPECIES_PAL(DREDWOOD, gMonPalette_Dredwood),
    SPECIES_PAL(KAIOSEA, gMonPalette_Kaiosea),
    SPECIES_PAL(PHANFERNAL, gMonPalette_Phanfernal),
    SPECIES_PAL(SKULBERUS, gMonPalette_Skulberus),
    SPECIES_PAL(MARBEEP, gMonPalette_Marbeep),
    SPECIES_PAL(FLUFFBEE, gMonPalette_Fluffbee),
    SPECIES_PAL(AMPHYBUZZ, gMonPalette_Amphybuzz),
    SPECIES_PAL(AMPHYBUZZ_MEGA, gMonPalette_AmphybuzzMega),
    SPECIES_PAL(CORM, gMonPalette_Corm),
    SPECIES_PAL(CORMOTH, gMonPalette_Cormoth),
    SPECIES_PAL(CORMOTH_MEGA, gMonPalette_CormothMega),
    SPECIES_PAL(POPCORM, gMonPalette_Popcorm),
    SPECIES_PAL(BLIZZARD_MAW, gMonPalette_BlizzardMaw),
    SPECIES_PAL(LUMBERING_SLOTH, gMonPalette_LumberingSloth),
    SPECIES_PAL(LUMBERING_SLOTH_ENGULFED, gMonPalette_LumberingSlothEngulfed),
    SPECIES_PAL(IRON_CARAPACE, gMonPalette_IronCarapace),
    SPECIES_PAL(TURTWIG_REDUX, gMonPalette_TurtwigRedux),
    SPECIES_PAL(GROTLE_REDUX, gMonPalette_GrotleRedux),
    SPECIES_PAL(TORTERRA_REDUX, gMonPalette_TorterraRedux),
    SPECIES_PAL(TORTERRA_REDUX_MEGA, gMonPalette_TorterraReduxMega),
    SPECIES_PAL(CHIMCHAR_REDUX, gMonPalette_ChimcharRedux),
    SPECIES_PAL(MONFERNO_REDUX, gMonPalette_MonfernoRedux),
    SPECIES_PAL(INFERNAPE_REDUX, gMonPalette_InfernapeRedux),
    SPECIES_PAL(INFERNAPE_REDUX_MEGA, gMonPalette_InfernapeReduxMega),
    SPECIES_PAL(PIPLUP_REDUX, gMonPalette_PiplupRedux),
    SPECIES_PAL(PRINPLUP_REDUX, gMonPalette_PrinplupRedux),
    SPECIES_PAL(EMPOLEON_REDUX, gMonPalette_EmpoleonRedux),
    SPECIES_PAL(EMPOLEON_REDUX_MEGA, gMonPalette_EmpoleonReduxMega),
    SPECIES_PAL(BOUNSWEET_REDUX, gMonPalette_BounsweetRedux),
    SPECIES_PAL(STEENEE_REDUX, gMonPalette_SteeneeRedux),
    SPECIES_PAL(TSAREENA_REDUX, gMonPalette_TsareenaRedux),
    SPECIES_PAL(TSAREENA_REDUX_MEGA, gMonPalette_TsareenaReduxMega),
    SPECIES_PAL(TOXEL_REDUX, gMonPalette_ToxelRedux),
    SPECIES_PAL(TOXTRICITY_REDUX, gMonPalette_ToxtricityRedux),
    SPECIES_PAL(TOXTRICITY_REDUX_MEGA, gMonPalette_ToxtricityReduxMega),
    SPECIES_PAL(TOXTRICITY_REDUX_FUZZ, gMonPalette_ToxtricityReduxFuzz),
    SPECIES_PAL(TOXTRICITY_REDUX_FUZZ_MEGA, gMonPalette_ToxtricityReduxFuzzMega),
    SPECIES_PAL(TRAPINCH_REDUX, gMonPalette_TrapinchRedux),
    SPECIES_PAL(VIBRAVA_REDUX, gMonPalette_VibravaRedux),
    SPECIES_PAL(FLYGON_REDUX, gMonPalette_FlygonRedux),
    SPECIES_PAL(FLYGON_REDUX_MEGA, gMonPalette_FlygonReduxMega),
    SPECIES_PAL(CRABRAWLER_REDUX, gMonPalette_CrabrawlerRedux),
    SPECIES_PAL(CRABOMINABLE_REDUX, gMonPalette_CrabominableRedux),
    SPECIES_PAL(CRABONINATION, gMonPalette_Crabonination),
    SPECIES_PAL(CLEFFA_REDUX, gMonPalette_CleffaRedux),
    SPECIES_PAL(CLEFAIRY_REDUX, gMonPalette_ClefairyRedux),
    SPECIES_PAL(CLEFABLE_REDUX, gMonPalette_ClefableRedux),
    SPECIES_PAL(CLEFABLE_REDUX_MEGA, gMonPalette_ClefableReduxMega),
    SPECIES_PAL(GLIGAR_REDUX, gMonPalette_GligarRedux),
    SPECIES_PAL(GLISCOR_REDUX, gMonPalette_GliscorRedux),
    SPECIES_PAL(MAGMENOUS, gMonPalette_Magmenous),
    SPECIES_PAL(PSYDUCK_REDUX, gMonPalette_PsyduckRedux),
    SPECIES_PAL(SLYDUCK, gMonPalette_Slyduck),
    SPECIES_PAL(SHYDUCK, gMonPalette_Shyduck),
    SPECIES_PAL(SEEL_REDUX, gMonPalette_SeelRedux),
    SPECIES_PAL(DEWGONG_REDUX, gMonPalette_DewgongRedux),
    SPECIES_PAL(BARIONG, gMonPalette_Bariong),
    SPECIES_PAL(BUBBLEO, gMonPalette_Bubbleo),
    SPECIES_PAL(HYDROAR, gMonPalette_Hydroar),
    SPECIES_PAL(HYDROAR_F, gMonPalette_HydroarF),
    SPECIES_PAL(SNORUNT_REDUX, gMonPalette_SnoruntRedux),
    SPECIES_PAL(GLALIE_REDUX, gMonPalette_GlalieRedux),
    SPECIES_PAL(GLALIE_REDUX_MEGA, gMonPalette_GlalieReduxMega),
    SPECIES_PAL(FROSLASS_REDUX, gMonPalette_FroslassRedux),
    SPECIES_PAL(FROSLASS_REDUX_MEGA, gMonPalette_FroslassReduxMega),
    SPECIES_PAL(POPCORM_MEGA, gMonPalette_PopcormMega),
    SPECIES_PAL(ARBOK_MEGA, gMonPalette_ArbokMega),
    SPECIES_PAL(GOLISOPOD_MEGA, gMonPalette_GolisopodMega),
    SPECIES_PAL(RAPIDASH_MEGA1, gMonPalette_RapidashMega),
    SPECIES_PAL(RAPIDASH_MEGA_GALARIAN, gMonPalette_RapidashMegaGalarian),
    SPECIES_PAL(ORICORIO_MEGA, gMonPalette_OricorioMega),
    SPECIES_PAL(HYDREIGON_REDUX_MEGA, gMonPalette_HydreigonReduxMega),
    SPECIES_PAL(AEGISLASH_REDUX_MEGA, gMonPalette_AegislashReduxMega),
    SPECIES_PAL(AEGISLASH_BLADE_REDUX_MEGA, gMonPalette_AegislashBladeReduxMega),
    SPECIES_PAL(REUNICLUS_REDUX_MEGA, gMonPalette_ReuniclusReduxMega),
    SPECIES_PAL(TINKATON_MEGA1, gMonPalette_Tinkaton_Mega),
    SPECIES_PAL(KARTANA_FALLEN, gMonPalette_Kartana_Fallen),
    SPECIES_PAL(KINGAMBIT_REDUX_MEGA, gMonPalette_Kingambit_Redux_Mega),
    SPECIES_PAL(YVELTAL_MEGA, gMonPalette_Yveltal_Mega),
    SPECIES_PAL(CALYREX_CLOUD_RIDER, gMonPalette_Calyrex_Cloud_Rider),
    SPECIES_PAL(SPECTRIER_CLOUD, gMonPalette_Spectrier_Cloud),
    SPECIES_PAL(SOLROCK_SYSTEM, gMonPalette_Solrock_System),
    SPECIES_PAL(DARKRAI_NIGHTMARE, gMonPalette_Darkrai_Nightmare),
    SPECIES_PAL(ESPEON_GALAXY, gMonPalette_Espeon_Galaxy),
    SPECIES_PAL(MIMIKYU_APEX, gMonPalette_MimikyuApex),
    SPECIES_PAL(MIMIKYU_APEX_BUSTED, gMonPalette_MimikyuApex),
    SPECIES_PAL(MIMIKYU_RAYQUAZA, gMonPalette_Mimikyu_Rayquaza),
    SPECIES_PAL(MIMIKYU_RAYQUAZA_BUSTED, gMonPalette_Mimikyu_RayquazaBusted),
    SPECIES_PAL(BEWEAR_ANGRY, gMonPalette_Bewear_Angry),
    SPECIES_PAL(ABOMASNOW_SANTA, gMonPalette_Abomasnow_Santa),
    SPECIES_PAL(WEAVILE_REDUX_MEGA, gMonPalette_Weavile_Redux_Mega),
    SPECIES_PAL(WEAVILE_REDUX, gMonPalette_Weavile_Redux),
    SPECIES_PAL(RIBOMBEE_REDUX_MEGA, gMonPalette_Ribombee_Redux_Mega),
    SPECIES_PAL(RIBOMBEE_REDUX, gMonPalette_Ribombee_Redux),
    SPECIES_PAL(MAWILE_REDUX_B_MEGA, gMonPalette_Mawile_Redux_B_Mega),
    SPECIES_PAL(MAWILE_REDUX_B, gMonPalette_Mawile_Redux_B),
    SPECIES_PAL(FLYGON_REDUX_B_MEGA, gMonPalette_Flygon_Redux_B_Mega),
    SPECIES_PAL(FLYGON_REDUX_B, gMonPalette_Flygon_Redux_B),
    SPECIES_PAL(WIGGLYTUFF_PRIMAL1, gMonPalette_Wigglytuff_Primal),
    SPECIES_PAL(WIGGLYTUFF_APEX1, gMonPalette_WigglytuffApex),
    SPECIES_PAL(VICTINI_PRIMAL, gMonPalette_Victini_Primal),
    SPECIES_PAL(SNORLAX_PRIMAL, gMonPalette_Snorlax_Primal),
    SPECIES_PAL(LEDIAN_PARADOX, gMonPalette_Ledian_Paradox),
    SPECIES_PAL(DRACOVISH_MEGA, gMonPalette_Dracovish_Mega),
    SPECIES_PAL(CHIEN_PAO_MEGA, gMonPalette_Chien_Pao_Mega),
    SPECIES_PAL(DRAGONITE_DELIVERY, gMonPalette_Dragonite_Delivery),
    SPECIES_PAL(ARCHALUDON, gMonPalette_Archaludon),
    SPECIES_PAL(GOUGING_FIRE, gMonPalette_Gouging_Fire),
    SPECIES_PAL(IRON_BOULDER, gMonPalette_Iron_Boulder),
    SPECIES_PAL(IRON_CROWN, gMonPalette_Iron_Crown),
    SPECIES_PAL(PECHARUNT, gMonPalette_Pecharunt),
    SPECIES_PAL(TERAPAGOS, gMonPalette_Terapagos),
    SPECIES_PAL(TERAPAGOS_STELLAR, gMonPalette_Terapagos_Stellar),
    SPECIES_PAL(RAGING_BOLT, gMonPalette_Raging_Bolt),
    ...
    SPECIES_PAL(VENUSAUR_MEGA_X, gMonPalette_VenusaurMegaX),
    SPECIES_PAL(CHARIZARD_MEGA_X, gMonPalette_CharizardMegaX),
    SPECIES_PAL(CHARIZARD_MEGA_Y, gMonPalette_CharizardMegaY),
    SPECIES_PAL(CHARIZARD_MEGA_Z, gMonPalette_CharizardMegaZ),
    SPECIES_PAL(BLASTOISE_MEGA, gMonPalette_BlastoiseMega),
    SPECIES_PAL(BLASTOISE_MEGA_X, gMonPalette_BlastoiseMegaX),
    ...
    SPECIES_PAL(GENGAR_MEGA_X, gMonPalette_GengarMegaX),
    SPECIES_PAL(KNAIVER, gMonPalette_Knaiver),
    SPECIES_PAL(BURMY_ETERNA, gMonPalette_BurmyEterna),
    ...
    SPECIES_PAL(HITMONCHAN_MEGA1,   gMonPalette_HitmonchanMega),
    ...
    SPECIES_PAL(SLAKING_MEGA_APE_SHIFT,      gMonPalette_SlakingMegaApeShift),
    ...
    SPECIES_PAL(MEGANIUM_MEGA1,     gMonPalette_MeganiumMega),
    ...
    SPECIES_PAL(WIGGLYTUFF_MEGA1, gMonPalette_WigglytuffMega),
    SPECIES_PAL(WIGGLYTUFF_MEGA_X1, gMonPalette_WigglytuffMegaX),
    SPECIES_PAL(LUCARIO_MEGA_Y, gMonPalette_LucarioMegaY),
    SPECIES_PAL(KECLEONG,           gMonPalette_Kecleong),
    ...
    SPECIES_PAL(UNOWN_B1, gMonPalette_UnownB),
    SPECIES_PAL(UNOWN_C1, gMonPalette_UnownC),
    SPECIES_PAL(STEVE_REALER, gMonPalette_UnownD),
    SPECIES_PAL(UNOWN_E1, gMonPalette_UnownE),
    SPECIES_PAL(UNOWN_F1, gMonPalette_UnownF),
    SPECIES_PAL(UNOWN_G1, gMonPalette_UnownG),
    SPECIES_PAL(OBAMASNOW_MEGA, gMonPalette_UnownH),
    SPECIES_PAL(UNOWN_I1, gMonPalette_UnownI),
    SPECIES_PAL(UNOWN_J1, gMonPalette_UnownJ),
    SPECIES_PAL(UNOWN_K1, gMonPalette_UnownK),
    SPECIES_PAL(UNOWN_L1, gMonPalette_UnownL),
    SPECIES_PAL(UNOWN_M1, gMonPalette_UnownM),
    SPECIES_PAL(UNOWN_N1, gMonPalette_UnownN),
    SPECIES_PAL(UNOWN_O1, gMonPalette_UnownO),
    SPECIES_PAL(PEPSICHAMP_MEGA, gMonPalette_UnownP),
    SPECIES_PAL(UNOWN_Q1, gMonPalette_UnownQ),
    SPECIES_PAL(UNOWN_R1, gMonPalette_UnownR),
    SPECIES_PAL(UNOWN_S1, gMonPalette_UnownS),
    SPECIES_PAL(UNOWN_T1, gMonPalette_UnownT),
    SPECIES_PAL(BOWSERSTOISE_MEGA, gMonPalette_UnownU),
    SPECIES_PAL(UNOWN_V1, gMonPalette_UnownV),
    ...
    SPECIES_PAL(WEAVILE_MEGA,     gMonPalette_WeavileMega),
    SPECIES_PAL(HAPPINY_REDUX,     gMonPalette_HappinyRedux),
    SPECIES_PAL(CHANSEY_REDUX,     gMonPalette_ChanseyRedux),
    SPECIES_PAL(BLISSEY_REDUX,     gMonPalette_BlisseyRedux),
    SPECIES_PAL(DEWPIDER_REDUX,     gMonPalette_DewpiderRedux),
    SPECIES_PAL(ARAQUANID_REDUX,     gMonPalette_AraquanidRedux),
    SPECIES_PAL(FROSTULA,     gMonPalette_Frostula),
    SPECIES_PAL(DELPHOX_BATTLE_BOND,     gMonPalette_Delphox),
    SPECIES_PAL(DELPHOX_SERENA,     gMonPalette_DelphoxSerena),
    SPECIES_PAL(CHESNAUGHT_BATTLE_BOND,     gMonPalette_Chesnaught),
    SPECIES_PAL(CHESNAUGHT_CLEMONT,     gMonPalette_ChesnaughtClemont),
    ...
    SPECIES_PAL(DUDUDUNSPARCE, gMonPalette_Dududunsparce),
    SPECIES_PAL(DUDUDUNSPARCE_MEGA, gMonPalette_DududunsparceMega),
};
