const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(WIGGLYTUFF_MEGA, gMonShinyPalette_WigglytuffMega),
    SPECIES_SHINY_PAL(WIGGLYTUFF_MEGA_X, gMonShinyPalette_WigglytuffMegaX),
    ...
    SPECIES_SHINY_PAL(TINKATON_MEGA, gMonShinyPalette_Tinkaton_Mega),
    ...
    SPECIES_SHINY_PAL(WIGGLYTUFF_APEX, gMonShinyPalette_WigglytuffApex),
    ...
    SPECIES_SHINY_PAL(HITMONCHAN_MEGA,   gMonShinyPalette_HitmonchanMega),
