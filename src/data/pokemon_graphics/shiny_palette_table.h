const struct CompressedSpritePalette gMonRareShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BULBASAUR, gMonRareShinyPalette_Bulbasaur),
    SPECIES_SHINY_PAL(IVYSAUR, gMonRareShinyPalette_Ivysaur),
    SPECIES_SHINY_PAL(VENUSAUR, gMonRareShinyPalette_Venusaur),
    SPECIES_SHINY_PAL(VENUSAUR_MEGA, gMonRareShinyPalette_VenusaurMega),
};
