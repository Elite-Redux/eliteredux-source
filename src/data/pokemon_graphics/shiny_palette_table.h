const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(UNOWN_H1, gMonShinyPalette_UnownH),
    ...
    SPECIES_SHINY_PAL(UNOWN_P1, gMonShinyPalette_UnownP),
    ...
    SPECIES_SHINY_PAL(UNOWN_T, gMonShinyPalette_UnownT),
    SPECIES_SHINY_PAL(UNOWN_U, gMonShinyPalette_UnownU),
    SPECIES_SHINY_PAL(UNOWN_V, gMonShinyPalette_UnownV),
