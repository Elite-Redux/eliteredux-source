...
static const u8 sAbilityHugePowerDescription[] = _("increases offenses by 5\nbillion quintillion real.");
...
static const u8 sAbilityTruantDescription[] = _("Can only attack every other turn.\nCan use status moves every turn.");
static const u8 sAbilityHustleDescription[] = _("0.9x accuracy.\nRaises Atk & SpAtk by 1.4x.");
static const u8 sAbilityCuteCharmDescription[] = _("50% chance to attract on contact.\nAlso works on offense.");
...
static const u8 sAbilityGluttonyDescription[] = _("Eats berries early. Berries also\nrestore 1/3 of max HP.");
...
static const u8 sAbilitySlowStartDescription[] = _("Reduces all stats\nthe first 20 turns out. 90%");
...
static const u8 sAbilityFlowerGiftDescription[] = _("Increases the party's SpAtk\nand SpDef by 1.5x in Sun.");
...
static const u8 sAbilityHealerDescription[] = _("30% chance to heal user or ally's\nstatus at the end of each turn.");
...
static const u8 sAbilityMummyDescription[] = _("If hit, makes the attacker's ability\nMummy.");
static const u8 sAbilityMoxieDescription[] = _("Dealing a KO raises Attack by\none stage.");
static const u8 sAbilityJustifiedDescription[] = _("Boosts Attack instead of being\nhit by Dark-type moves.");
...
static const u8 sAbilitySapSipperDescription[] = _("Boosts highest Atk instead of\nbeing hit by Grass-type moves.");
...
static const u8 sAbilityCheekPouchDescription[] = _("This ability has no effect.");
...
static const u8 sAbilityLiquidVoiceDescription[] = _("Sound moves get a 1.2x boost\nand become Water if Normal.");
...
static const u8 sAbilityDisguiseDescription[] = _("Protects once against an attack.\nRestores protection in fog.");
...
static const u8 sAbilityPowerOfAlchemyDescription[] = _("Transmutes berries on entry.\nTransmutes items when lost.");
...
static const u8 sAbilityCottonDownDescription[] = _("Lowers the Speed of all foes\nby one stage when hit.");
...
static const u8 sAbilityAsOneIceRiderDescription[] = _("Unnerve + Chilling Neigh.");
static const u8 sAbilityAsOneShadowRiderDescription[] = _("Unnerve + Grim Neigh.");
static const u8 sAbilityChloroplastDescription[] = _("Weather Ball, Solar Beam/Blade,\nGrowth act as if used in sun.");
static const u8 sAbilityWhiteoutDescription[] = _("Ups highest attacking stat\nby 1.5x in hail.");
...
static const u8 sAbilitySandSongDescription[] = _("Sound moves get a 1.2x boost\nand become Ground if Normal.");
...
static const u8 sAbilityAerodynamicsDescription[] = _("Boosts Speed instead of being\nhit by Flying-type moves.");
...
static const u8 sAbilityLoudBangDescription[] = _("Sound-based moves have 50%\nchance to confuse the foe.");
...
static const u8 sAbilityEarthboundDescription[] = _("Boosts Ground-type moves by\n1.2x, or 1.5x when under 1/3 HP.");
...
static const u8 sAbilityDragonflyDescription[] = _("Adds Dragon type to itself.\nAvoids Ground attacks.");
static const u8 sAbilityDragonslayerDescription[] = _("Deals 1.5x damage to Dragons.\nTakes 0.5x damage from Dragons.");
...
static const u8 sAbilityOverchargeDescription[] = _("Electric is super effective vs\nElectric. Can paralyze Electric.");
...
static const u8 sAbilityFieldExplorerDescription[] = _("Boosts field moves by 50%.\nCut, Surf, Strength etc.");
...
static const u8 sAbilityBigLeavesDescription[] = _("Chloroplast + Chlorophyll + Leaf\nGuard + Harvest + Solar Power.");
...
static const u8 sAbilityIceDewDescription[] = _("Boosts highest Atk instead of\nbeing hit by Ice-type moves.");
...
static const u8 sAbilitySelfRepairDescription[] = _("Self Sufficient + Natural Cure.");
...
static const u8 sAbilityJawsOfCarnageDescription[] = _("Heals 1/2 HP when KO'ing with\na biting move. 1/4 HP otherwise.");
...
static const u8 sAbilityWellBakedBodyDescription[] = _("Boosts Defense sharply instead\nof being hit by Fire-type moves.");
...
static const u8 sAbilityLingeringAromaDescription[] = _("If hit, makes the attacker's ability\nLingering Aroma.");
...
static const u8 sAbilityCryomancyDescription[] = _("Moves inflict frostbite\n5x as often.");
...
static const u8 sAbilityPixiePowerDescription[] = _("1.2x accuracy. Boosts Fairy\nmoves by 1.33x for all.");
...
static const u8 sAbilitySuperHotGooDescription[] = _("Inflicts burn and lowers\nSpeed on contact.");
...
static const u8 sAbilityInverseRoomDescription[] = _("Sets up Inverse Room on\nentry, lasts 3 turns.");
...
static const u8 sAbilityGeneratorDescription[] = _("Charges up once on entry or\nwhen electric terrain is active.");
...
static const u8 sAbilityWindRiderDescription[] = _("Increases attack in tailwind or\nwhen hit by wind move.");
...
static const u8 sAbilityTippingPointDescription[] = _("Getting hit raises SpAtk.\nCritical hits maximize SpAtk.");
...
static const u8 sAbilityPhantomThiefDescription[] = _("Attacks with 40BP Spectral Thief\non switch-in.");
...
static const u8 sAbilityCrownedShieldDescription[] = _("Dauntless Shield + Stamina.");
static const u8 sAbilityBerserkDnaDescription[] = _("Sharply ups highest attacking stat\nbut confuses on entry.");
static const u8 sAbilityCrownedKingDescription[] = _("Unnerve + Grim Neigh +\nChilling Neigh.");
...
static const u8 sAbilityHubrisDescription[] = _("KOs raise SpAtk by one stage.");
...
static const u8 sAbilityBansheeDescription[] = _("Sound moves get a 1.2x boost\nand become Ghost if Normal.");
...
static const u8 sAbilitySubdueDescription[] = _("Doubles stat drop effects\nused by this pokemon.");
...
static const u8 sAbilityRadioJamDescription[] = _("Sound-based moves have a 20%\nchance to inflict disable.");
static const u8 sAbilityOleDescription[] = _("50% chance to evade single-\ntarget moves.");
...
static const u8 sAbilityBrawlingWyvernDescription[] = _("No guard + Dragon type\nmoves become punching moves.");
...
static const u8 sAbilitySnowSongDescription[] = _("Sound moves get a 1.2x boost\nand become Ice if Normal.");
static const u8 sAbilityGreaterSpiritDescription[] = _("Ups highest stat by +1\non entry in fog.");
static const u8 sAbilityResonanceDescription[] = _("Sound moves have a 30%\nbleed chance.");
...
static const u8 sAbilityRecurringNightmareDescription[] = _("Revives at 25% HP once after\nfainting in fog.");
...
static const u8 sAbilityBloodlustDescription[] = _("Blood Bath + Soul Eater.");
static const u8 sAbilityPiercingSoloDescription[] = _("Sound moves cause bleeding.");
...
static const u8 sAbilityIceColdHunterDescription[] = _("Ice-type moves hit twice in hail.");
...
static const u8 sAbilityEternalBlessingDescription[] = _("Celestial Blessing + Regenerator.");
static const u8 sAbilitySugarRushDescription[] = _("Gluttony + eats foe's berry when\nhitting with contact move.");
static const u8 sAbilityPeacefulRestDescription[] = _("Heals 1/8 of max HP every turn\nin fog.");
static const u8 sAbilityWhiteNoiseDescription[] = _("Static + Rest in Peace.");
...
static const u8 sAbilityPowerMetalDescription[] = _("Sound moves get a 1.2x boost\nand become Steel if Normal.");
...
static const u8 sAbilitySnowyWrathDescription[] = _("Snow Warning + Cryomancy.");
...
static const u8 sAbilityButterUpDescription[] = _("Hospitality + Soothing Aroma");
...
static const u8 sAbilitySwordOfDamnationDescription[] = _("Unaware + Sword of Ruin.");
static const u8 sAbilityRestrainingOrderDescription[] = _("Forces the attacker out when\nhit     once each switch-in.");
...
static const u8 sAbilityPatchworkDescription[] = _("Disguise + curses the opponent\nwhen its Disguise breaks.");
static const u8 sAbilityBlindRageDescription[] = _("Scrappy + Mold Breaker.");
static const u8 sAbilitySlipstreamDescription[] = _("Moves use 20% of its Speed\nstat additionally.");
static const u8 sAbilityApexPredatorDescription[] = _("Tough Claws + Predator.");
...
static const u8 sAbilityEnergizedDescription[] = _("Generator + charges up on KO\nwith an Electric-type move.");
...
static const u8 sAbilityFromTheShadowsDescription[] = _("Attacks trap and have a 99%\nflinch chance when moving first.");
...
static const u8 sAbilityWhiplashDescription[] = _("Physical attacks lower Defense.");
...
static const u8 sAbilityOverwatchDescription[] = _("On the Prowl + Stakeout.");
...
static const u8 sAbilityFaradayCageDescription[] = _("Shell Armor + 50BP\nThunder Cage when hit by contact.");
...
static const u8 sAbilityConjourerOfDeceitDescription[] = _("Magic Guard + Magic Bounce.");
static const u8 sAbilityDeepFreezeDescription[] = _("Boosts water and ice by\n25% and halves fire damage taken");
static const u8 sAbilitySoulDevourerDescription[] = _("Phantom Pain + Soul Eater.");
static const u8 sAbilityChampionsEntranceDescription[] = _("Intimidate + Violent Rush.");
static const u8 sAbilityPrestoDescription[] = _("At full HP, gives +1 priority to\nthis Pokémon's Sound-based moves.");
static const u8 sAbilitySambaDescription[] = _("Striker + Dancer.");
static const u8 sAbilityJunshiSandaDescription[] = _("Every move gets a 30% boost\nfrom Combat Specialist.");
static const u8 sAbilityGladiatorDescription[] = _("Boosts Fighting-type moves by 1.3x,\nor 1.8x when below 1/3 HP.");
static const u8 sAbilityForsakenHeartDescription[] = _("KOs dealt anywhere on the field\nraise Attack by one stage.");
static const u8 sAbilityRelentlessDescription[] = _("Exploit Weakness + Merciless.");
static const u8 sAbilitySoothsayerDescription[] = _("All hits will be not very effective\nfor 5 turns against this Pokemon.");
...
static const u8 sAbilityUnownPowerDescription[] = _("Mystic Power + Hidden and Secret\nPower hit Super-effectively.");
...
static const u8 sAbilityPoseidonsDominionDescription[] = _("Uses Whirlpool on entry.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_HUGE_POWER] = _("average power"),
    ...
    [ABILITY_SLOW_START] = _("Slowest Start"),
    ...
    [ABILITY_INVERSE_ROOM] = _("Inversion"),
    ...
    [ABILITY_MASTER_HAND] = _("Koopa King"),
    ...
    [ABILITY_HUGE_WINGS] = _("Imposing Wings"),
    ...
    [ABILITY_FARADAY_CAGE] = _("Faraday Cage"),
    [ABILITY_ACIDIC_SLIME] = _("Acidic Slime"),
    [ABILITY_ROSE_GARDEN] = _("Rose Garden"),
    [ABILITY_QIGONG] = _("Qigong"),
    [ABILITY_CONJOURER_OF_DECEIT] = _("Deceit Conjourer"),
    [ABILITY_DEEP_FREEZE] = _("Deep Freeze"),
    [ABILITY_SOUL_DEVOURER] = _("Soul Devourer"),
    [ABILITY_CHAMPIONS_ENTRANCE] = _("Champion's Entrance"),
    [ABILITY_PRESTO] = _("Presto"),
    [ABILITY_SAMBA] = _("Samba"),
    [ABILITY_JUNSHI_SANDA] = _("Junshi Sanda"),
    [ABILITY_GLADIATOR] = _("Gladiator"),
    [ABILITY_FORSAKEN_HEART] = _("Forsaken Heart"),
    [ABILITY_RELENTLESS] = _("Relentless"),
    [ABILITY_SOOTHSAYER] = _("Soothsayer"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_POWER_OF_ALCHEMY] = sAbilityPowerOfAlchemyDescription,
    ...
    [ABILITY_LINGERING_AROMA] = sAbilityLingeringAromaDescription,
    ...
    [ABILITY_LOW_VISIBILITY] = sAbilityLowVisibilityDescription,
    [ABILITY_OLD_MARINER] = sAbilityOldMarinerDescription,
    [ABILITY_ECTOPLASM] = sAbilityEctoplasmDescription,
    [ABILITY_BEAUTIFUL_MUSIC] = sAbilityBeautifulMusicDescription,
    [ABILITY_SURPRISE] = sAbilitySurpriseDescription,
    [ABILITY_SNOW_SONG] = sAbilitySnowSongDescription,
    [ABILITY_GREATER_SPIRIT] = sAbilityGreaterSpiritDescription,
    [ABILITY_RESONANCE] = sAbilityResonanceDescription,
    [ABILITY_ETHEREAL_RUSH] = sAbilityEtherealRushDescription,
    [ABILITY_CUTE_ANTECEDENCE] = sAbilityCuteAntecedenceDescription,
    [ABILITY_RECURRING_NIGHTMARE] = sAbilityRecurringNightmareDescription,
    ...
    [ABILITY_FARADAY_CAGE] = sAbilityFaradayCageDescription,
    ...
    [ABILITY_CONJOURER_OF_DECEIT] = sAbilityConjourerOfDeceitDescription,
    ...
    [ABILITY_RELENTLESS] = sAbilityRelentlessDescription,
    [ABILITY_SOOTHSAYER] = sAbilitySoothsayerDescription,
