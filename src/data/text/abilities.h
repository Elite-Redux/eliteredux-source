...
static const u8 sAbilityHealerDescription[] = _("30% chance to heal ally or user's\nstatus at the end of each turn.");
...
static const u8 sAbilitySandForceDescription[] = _("Rock, Ground, and Steel type\nmoves are boosted by 30% in sand.");
...
static const u8 sAbilityDeadeyeDescription[] = _("Never misses + arrow moves\ntarget enemy's lower defense stat.");
