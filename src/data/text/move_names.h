const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_LIGHTNING_STRIKE] = _("Light Strike"),
    ...
    [MOVE_GIGATON_HAMMER] = _("Ban Hammer"),
    ...
    [MOVE_SMOLDER_BASH] = _("BlazingHorns"),
    ...
    [MOVE_SPECTRAL_FLAME] = _("SpectrlFlame"),
...
const u8 gMoveNamesLong[MOVES_COUNT][LONG_MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_SMOLDER_BASH] = _("Blazing Horns"),
    [MOVE_BEATDOWN] = _("Beatdown"),
    [MOVE_EERIE_FOG] = _("Eerie Fog"),
    [MOVE_MYSTIC_DANCE] = _("Mystic Dance"),
