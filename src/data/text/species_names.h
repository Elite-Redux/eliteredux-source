const u8 gSpeciesNames[][POKEMON_SPECIES_NAME_LENGTH + 1] = {
    ...
    [SPECIES_WIGGLYTUFF1] = _("Autuffism"),
    ...
    [SPECIES_RAPIDASH1] = _("hungrydash"),
    ...
    [SPECIES_HITMONCHAN1] = _("Pregmonchan"),
    ...
    [SPECIES_LUMINOSITEON] = _("Lucineon"),
    ...
    [SPECIES_DARMANITAN_REDUX_BOND] = _("Darmanitan"),
    ...
    [SPECIES_BLACEPHALON1] = _("Wahcephalon"),
    ...
    [SPECIES_FUJIFLAP] = _("Fujiflap"),
    [SPECIES_APPLETUN] = _("Appletun"),
    [SPECIES_GRANITUN] = _("Granitun"),
    ...
    [SPECIES_FLAIRGRANCE] = _("Flairgrance"),
...
[SPECIES_MIMIKYU_APEX] = _("Mimikyu"),
[SPECIES_MIMIKYU_APEX_BUSTED] = _("Mimikyu"),
[SPECIES_MIMIKYU_RAYQUAZA] = _("Mimikyu"),
[SPECIES_MIMIKYU_RAYQUAZA_BUSTED] = _("Mimikyu"),
...
[SPECIES_RIBOMBEE_REDUX] = _("Ribombee"),
    ...
    [SPECIES_FLYGON_REDUX_B] = _("Flygon"),
    [SPECIES_FLYGON_REDUX_B_MEGA] = _("Flygon"),
    [SPECIES_WIGGLYTUFF_PRIMAL1] = _("Autuffism"),
    [SPECIES_WIGGLYTUFF_APEX1]      = _("Autuffism"),
    [SPECIES_VICTINI_PRIMAL] = _("Victini"),
    [SPECIES_SNORLAX_PRIMAL] = _("Snorlax"),
    [SPECIES_LEDIAN_PARADOX] = _("Iron Heart"),
    ...
    [SPECIES_CORM]          = _("Corm"),
    [SPECIES_CORMOTH]             = _("Cormoth"),
    [SPECIES_CORMOTH_MEGA]      = _("Cormoth"),
    [SPECIES_POPCORM]             = _("Popcorm"),
    [SPECIES_POPCORM_MEGA]             = _("Popcorm"),
    ...
    [SPECIES_BOUNSWEET_REDUX]      = _("Bounsweet"),
    ...
    [SPECIES_TOXTRICITY_REDUX_FUZZ]      = _("Toxtricity"),
    [SPECIES_TOXTRICITY_REDUX_FUZZ_MEGA]      = _("Toxtricity"),

    [SPECIES_TRAPINCH_REDUX]      = _("Trapinch"),
    [SPECIES_VIBRAVA_REDUX]      = _("Vibrava"),
    ...
    [SPECIES_CRABONINATION]      = _("Crabruiser"),
    ...
    [SPECIES_VENUSAUR_MEGA_X] = _("Venusaur"),
    [SPECIES_CHARIZARD_MEGA_X] = _("Charizard"),
    [SPECIES_CHARIZARD_MEGA_Y] = _("Charizard"),
    [SPECIES_CHARIZARD_MEGA_Z] = _("Charizard"),
    [SPECIES_BLASTOISE_MEGA] = _("Blastoise"),
    [SPECIES_BLASTOISE_MEGA_X] = _("Blastoise"),
    ...
    [SPECIES_HITMONCHAN_MEGA1]    = _("Pregmonchan"),
    ...
    [SPECIES_MEGANIUM_MEGA1]      = _("Meganium"),
    ...
    [SPECIES_WIGGLYTUFF_MEGA1]      = _("Autuffism"),
    [SPECIES_WIGGLYTUFF_MEGA_X1]      = _("Autuffism"),
    ...
    // Unown
    [SPECIES_UNOWN_B1] = _("P. Bidoof"),
    [SPECIES_UNOWN_C1] = _("steve"),
    [SPECIES_STEVE_REALER] = _("real steve"),
    [SPECIES_UNOWN_E1] = _("skibiper"),
    [SPECIES_UNOWN_F1] = _("sans"),
    [SPECIES_UNOWN_G1] = _("obamasnow"),
    [SPECIES_OBAMASNOW_MEGA] = _("obamasnow"),
    [SPECIES_UNOWN_I1] = _("regigichair"),
    [SPECIES_UNOWN_J1] = _("trollmask"),
    [SPECIES_UNOWN_K1] = _("iron mugulis"),
    [SPECIES_UNOWN_L1] = _("wariobopass"),
    [SPECIES_UNOWN_M1] = _("suslett"),
    [SPECIES_UNOWN_N1] = _("depressibolt"),
    [SPECIES_UNOWN_O1] = _("pepsichamp"),
    [SPECIES_PEPSICHAMP_MEGA] = _("pepsichamp"),
    [SPECIES_UNOWN_Q1] = _("escavalegs"),
    [SPECIES_UNOWN_R1] = _("Oshawott?"),
    [SPECIES_UNOWN_S1] = _("sustrio"),
    [SPECIES_UNOWN_T1] = _("Bowserstoise"),
    [SPECIES_BOWSERSTOISE_MEGA] = _("Bowserstoise"),
    [SPECIES_UNOWN_V1] = _("Mysterbeast"),
    ...
    // Vivillon
    [SPECIES_VIVILLON_POLAR] = _("VivillonPolr"),
    [SPECIES_VIVILLON_TUNDRA] = _("VivillonTund"),
    [SPECIES_VIVILLON_CONTINENTAL] = _("VivillonCont"),
    [SPECIES_VIVILLON_GARDEN] = _("VivillonGard"),
    [SPECIES_VIVILLON_ELEGANT] = _("VivillonEle."),
    [SPECIES_VIVILLON_MEADOW] = _("VivillonMead"),
    [SPECIES_VIVILLON_MODERN] = _("VivillonMod."),
    [SPECIES_VIVILLON_MARINE] = _("VivillonMari"),
    [SPECIES_VIVILLON_ARCHIPELAGO] = _("VivillonArch"),
    [SPECIES_VIVILLON_HIGH_PLAINS] = _("VivillonHP."),
    [SPECIES_VIVILLON_SANDSTORM] = _("VivillonSand"),
    [SPECIES_VIVILLON_RIVER] = _("VivillonRiv."),
    [SPECIES_VIVILLON_MONSOON] = _("VivillonMon."),
    [SPECIES_VIVILLON_SAVANNA] = _("VivillonSav."),
    [SPECIES_VIVILLON_SUN] = _("VivillonSun"),
    [SPECIES_VIVILLON_OCEAN] = _("VivillonAqua"),
    [SPECIES_VIVILLON_JUNGLE] = _("VivillonJun."),
    [SPECIES_VIVILLON_FANCY] = _("VivillonFan."),
    [SPECIES_VIVILLON_POKE_BALL] = _("VivillonPoke"),
    // Flabébé
    ...
    [SPECIES_ALCREMIE_LEMON_CREAM] = _("AlcremieLem."),
    [SPECIES_ALCREMIE_SALTED_CREAM] = _("AlcremieSalt"),
    [SPECIES_ALCREMIE_RUBY_SWIRL] = _("AlcremieRS."),
    [SPECIES_ALCREMIE_CARAMEL_SWIRL] = _("AlcremieCara"),
    [SPECIES_ALCREMIE_RAINBOW_SWIRL] = _("AlcremieRbow"),
    // Eiscue
    ...
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE_MEGA] = _("UrshifuRapid"),
    [SPECIES_URSHIFU_MEGA] = _("Urshifu"),
    // Zarude
    ...
    [SPECIES_DEWPIDER_REDUX] = _("Dewpider"),
    [SPECIES_ARAQUANID_REDUX] = _("Araquanid"),
    [SPECIES_FROSTULA] = _("Frostula"),
    ...
    [SPECIES_MEOWTH_PARTNER] = _("Meowth"),
    [SPECIES_PIKACHU_PARTNER_MEGA] = _("Pikachu"),
    [SPECIES_EEVEE_PARTNER_MEGA] = _("Eevee"),
    [SPECIES_MEOWTH_PARTNER_MEGA] = _("Meowth"),
