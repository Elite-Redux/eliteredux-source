...
[SPECIES_RIBOMBEE_REDUX] = _("Ribombee"),
    ...
    [SPECIES_UNOWN_G] = _("obamasnow"),
    [SPECIES_UNOWN_H] = _("obamasnow"),
    [SPECIES_UNOWN_I] = _("regigichair"),
    [SPECIES_UNOWN_J] = _("trollmask"),
    [SPECIES_UNOWN_K] = _("iron mugulis"),
    [SPECIES_UNOWN_L] = _("wariobopass"),
    [SPECIES_UNOWN_M] = _("suslett"),
    [SPECIES_UNOWN_N] = _("depressibolt"),
    [SPECIES_UNOWN_O] = _("pepsichamp"),
    [SPECIES_UNOWN_P] = _("pepsichamp"),
    [SPECIES_UNOWN_Q] = _("escavalegs"),
