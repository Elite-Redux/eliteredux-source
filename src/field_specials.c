...
static void Task_ShowScrollableMultichoice(u8 taskId)
{
    ...
    spriteTemplate = CreateWindowTemplate(0, task->tLeft, task->tTop, task->tWidth, task->tHeight, 0xF, 0x64);
...
static void ScrollableMultichoice_UpdateScrollArrows(u8 taskId)
{
    ...
    if (task->tMaxItemsOnScreen != task->data[1])
    {
        ...
        spriteTemplate.secondY = task->tHeight * 8 + 10;
        spriteTemplate.fullyUpThreshold = 0;
        spriteTemplate.fullyDownThreshold = task->data[1] - task->tMaxItemsOnScreen;
        task->tScrollArrowId = AddScrollIndicatorArrowPair(&spriteTemplate, &sScrollableMultichoice_ScrollOffset);
    }
}
...
u16 GetMysteryGiftSpecies (void)
{
    static const u16 mysteryGiftData[][4] =
    {
        ...
        {SPECIES_DELPHOX_BATTLE_BOND, ITEM_COMET_SHARD, FLAG_RECEIVED_SERENA_DELPHOX, FLAG_BADGE04_GET},
        {SPECIES_PIKACHU_PARTNER, ITEM_PIKANITE, FLAG_RECEIVED_PIKACHU_PARTNER, FLAG_BADGE04_GET},
        {SPECIES_EEVEE_PARTNER, ITEM_EEVITE, FLAG_RECEIVED_EEVEE_PARTNER, FLAG_BADGE04_GET},
        {SPECIES_MEOWTH_PARTNER, ITEM_MEOWTHITE, FLAG_RECEIVED_MEOWTH_PARTNER, FLAG_BADGE04_GET},
        {SPECIES_FIDOUGH_PARTNER, ITEM_FIDOUGHITE, FLAG_RECEIVED_FIDOUGH_PARTNER, FLAG_BADGE04_GET},
        {SPECIES_DURALUDON_PARTNER, ITEM_DURALUDITE, FLAG_RECEIVED_DURALUDON_PARTNER, FLAG_BADGE05_GET},
        {SPECIES_MELOETTA, ITEM_FOCUS_SASH, FLAG_RECEIVED_MELOETTA, FLAG_BADGE05_GET},
        {SPECIES_SILVALLY, ITEM_NORMAL_GEM, FLAG_RECEIVED_SILVALLY, FLAG_BADGE06_GET},
        {SPECIES_CALYREX, ITEM_GRASS_GEM, FLAG_RECEIVED_CALYREX, FLAG_BADGE06_GET},
        {SPECIES_KELDEO, ITEM_BLACK_BELT, FLAG_RECEIVED_KELDEO, FLAG_BADGE08_GET},
        {SPECIES_ZYGARDE_10, ITEM_CHOICE_BAND, FLAG_RECEIVED_ZYGARDE_10, FLAG_BADGE08_GET},
        {SPECIES_OGERPON, FLAG_RECEIVED_OGERPON, FLAG_BADGE08_GET},
        {SPECIES_TERAPAGOS, ITEM_CLEAR_AMULET, FLAG_RECEIVED_TERAPAGOS, FLAG_BADGE08_GET},
        {SPECIES_REGIDRAGO, ITEM_CHOICE_SCARF, FLAG_RECEIVED_REGIDRAGO, FLAG_BADGE07_GET},
        {SPECIES_REGIELEKI, ITEM_ELECTRIC_GEM, FLAG_RECEIVED_REGIELEKI, FLAG_BADGE07_GET},
        {SPECIES_VOLCANION, ITEM_ASSAULT_VEST, FLAG_RECEIVED_VOLCANION, FLAG_BADGE08_GET},
        {SPECIES_FLOETTE_ETERNAL_FLOWER, ITEM_FAIRY_GEM, FLAG_RECEIVED_FLOETTE_ETERNAL, FLAG_BADGE06_GET},
        {SPECIES_ENAMORUS, ITEM_FOCUS_SASH, FLAG_RECEIVED_ENAMORUS, FLAG_SYS_GAME_CLEAR},
        {SPECIES_ETERNATUS, ITEM_LIFE_ORB, FLAG_RECEIVED_ETERNATUS, FLAG_SYS_GAME_CLEAR},
        {SPECIES_CHI_YU, ITEM_CHOICE_SPECS, FLAG_RECEIVED_CHI_YU, FLAG_SYS_GAME_CLEAR},
        {SPECIES_WO_CHIEN, ITEM_TACTICAL_VEST, FLAG_RECEIVED_WO_CHIEN, FLAG_SYS_GAME_CLEAR},
        {SPECIES_CHIEN_PAO, ITEM_CHOICE_BAND, FLAG_RECEIVED_CHIEN_PAO, FLAG_SYS_GAME_CLEAR},
        {SPECIES_TING_LU, ITEM_ASSAULT_VEST, FLAG_RECEIVED_TING_LU, FLAG_SYS_GAME_CLEAR},
        {SPECIES_ZACIAN, ITEM_RUSTED_SWORD, FLAG_RECEIVED_ZACIAN, FLAG_SYS_GAME_CLEAR},
        {SPECIES_ZAMAZENTA, ITEM_RUSTED_SHIELD, FLAG_RECEIVED_ZAMAZENTA, FLAG_SYS_GAME_CLEAR},
        {SPECIES_ZYGARDE_10_POWER_CONSTRUCT, ITEM_CHOICE_BAND, FLAG_RECEIVED_ZYGARDE_10_POWER_CONSTRUCT, FLAG_SYS_GAME_CLEAR},
    };
