...
u16 GetMysteryGiftSpecies (void)
{
    static const u16 mysteryGiftData[][4] =
    {
        ...
        {SPECIES_MELOETTA, ITEM_FOCUS_SASH, FLAG_RECEIVED_MELOETTA, FLAG_SYS_GAME_CLEAR},
        {SPECIES_SILVALLY, ITEM_NORMAL_GEM, FLAG_RECEIVED_SILVALLY, FLAG_SYS_GAME_CLEAR},
        ...
        {SPECIES_VOLCANION, ITEM_ASSAULT_VEST, FLAG_RECEIVED_VOLCANION, FLAG_SYS_GAME_CLEAR},
