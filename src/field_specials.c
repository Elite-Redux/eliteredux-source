...
u16 GetMysteryGiftSpecies (void)
{
    static const u16 mysteryGiftData[][4] =
    {
        ...
        {SPECIES_CALYREX, ITEM_GRASS_GEM, FLAG_RECEIVED_CALYREX, FLAG_SYS_GAME_CLEAR},
        {SPECIES_KELDEO, ITEM_BLACK_BELT, FLAG_RECEIVED_KELDEO, FLAG_SYS_GAME_CLEART},
        ...
        {SPECIES_TERAPAGOS, ITEM_CLEAR_AMULET, FLAG_RECEIVED_TERAPAGOS, FLAG_SYS_GAME_CLEAR},
