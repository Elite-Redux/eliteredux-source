...
{
    u8 numModes = 0;
    static const u8 gText_WelcomeToHOF[] 		  = _("Elite Redux v2.0-b2d - {STR_VAR_1} Mode{COLOR WHITE}{SHADOW DARK_GRAY}, {STR_VAR_2} Caps\n{COLOR WHITE}{SHADOW DARK_GRAY}{STR_VAR_3}");
