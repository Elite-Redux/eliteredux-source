...
enum
{
    MENUITEM_CUSTOM_BATTLE_UI_THEME,
...
{
    [MENUITEM_MAIN_BATTLE_SPEED]    = {DrawChoices_BattleSpeed,    ProcessInput_Options_Four},
...
static const u8 sText_Overworld_Speed[]  = _("Overworld Speed");
...
{
    [MENUITEM_MAIN_BATTLE_SPEED]    = sText_Battle_Speed,
    [MENUITEM_MAIN_OVERWORLD_SPEED] = sText_Overworld_Speed,
...
{
    [MENUITEM_CUSTOM_BATTLE_UI_THEME]     = sText_BattleUITheme,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_MAIN:
        switch (selection)
        {
        case MENUITEM_MAIN_BATTLE_SPEED:    return TRUE;
    ...
    case MENU_CUSTOM:
        ...
        case MENUITEM_CUSTOM_START_MENU_COLOR:    return TRUE;
...
{
    [MENUITEM_MAIN_BATTLE_SPEED]    = {sText_Desc_BattleSpeed,          sText_Empty,                sText_Empty},
...
{
    [MENUITEM_MAIN_BATTLE_SPEED]      = sText_Empty,
...
static const u8 *const OptionTextDescription(void)
{
    ...
    case MENU_MAIN:
        ...
        if (menuItem == MENUITEM_MAIN_TEXTSPEED || menuItem == MENUITEM_MAIN_FRAMETYPE || menuItem == MENUITEM_MAIN_HPBARSPEED || menuItem == MENUITEM_MAIN_BATTLE_SPEED || menuItem == MENUITEM_MAIN_OVERWORLD_SPEED)
            selection = 0;
...
void CB2_InitOptionPlusMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel[MENUITEM_MAIN_BATTLE_SPEED]    = VarGet(VAR_BATTLE_SPEED);
        ...
        sOptions->sel_custom[MENUITEM_CUSTOM_BATTLE_UI_THEME]     = gSaveBlock2Ptr->battleInterfaceTheme;
...
static void Task_OptionMenuSave(u8 taskId)
{
    VarSet(VAR_BATTLE_SPEED, sOptions->sel[MENUITEM_MAIN_BATTLE_SPEED]);
    ...
    gSaveBlock2Ptr->battleInterfaceTheme         = sOptions->sel_custom[MENUITEM_CUSTOM_BATTLE_UI_THEME];
...
const u8 gText_Options_Battle_Speed_0[] = _("Normal Speed");
const u8 gText_Options_Battle_Speed_1[] = _("Battle Speed x2");
const u8 gText_Options_Battle_Speed_2[] = _("Battle Speed x3");
const u8 gText_Options_Battle_Speed_3[] = _("Battle Speed x4");
const u8 gText_Options_Battle_Speed_4[] = _("Disabled Animations");
...
static void DrawChoices_BattleSpeed(int selection, int y)
{
    ...
    switch(selection){
        ...
        case OPTIONS_BATTLE_SCENE_1X:
            DrawOptionMenuChoice(gText_Options_Battle_Speed_0, 104, y, 1, active);
        break;
        case OPTIONS_BATTLE_SCENE_2X:
            DrawOptionMenuChoice(gText_Options_Battle_Speed_1, 104, y, 1, active);
        break;
        case OPTIONS_BATTLE_SCENE_3X:
            DrawOptionMenuChoice(gText_Options_Battle_Speed_2, 104, y, 1, active);
        break;
        case OPTIONS_BATTLE_SCENE_4X:
            DrawOptionMenuChoice(gText_Options_Battle_Speed_3, 104, y, 1, active);
        break;
        case OPTIONS_BATTLE_SCENE_DISABLED:
            DrawOptionMenuChoice(gText_Options_Battle_Speed_4, 104, y, 1, active);
        break;
    }
}

const u8 gText_Options_Overworld_Speed_0[] = _("Normal Speed");
const u8 gText_Options_Overworld_Speed_1[] = _("Overworld Speed x2");
const u8 gText_Options_Overworld_Speed_2[] = _("Overworld Speed x4");
const u8 gText_Options_Overworld_Speed_3[] = _("Overworld Speed x8");
const u8 gText_Options_Overworld_Speed_4[] = _("Overworld Speed x16");
...
static void DrawChoices_OverworldSpeed(int selection, int y)
{
    ...
    switch(selection){
        ...
        case OPTIONS_OVERWORLD_SPEED_1X:
            DrawOptionMenuChoice(gText_Options_Overworld_Speed_0, 104, y, 1, active);
        break;
        case OPTIONS_OVERWORLD_SPEED_2X:
            DrawOptionMenuChoice(gText_Options_Overworld_Speed_1, 104, y, 1, active);
        break;
        case OPTIONS_OVERWORLD_SPEED_4X:
            DrawOptionMenuChoice(gText_Options_Overworld_Speed_2, 104, y, 1, active);
        break;
        case OPTIONS_OVERWORLD_SPEED_8X:
            DrawOptionMenuChoice(gText_Options_Overworld_Speed_3, 104, y, 1, active);
        break;
    }
}
...
const u8 gText_Start_Menu_Color_01[]   = _("Blue");
const u8 gText_Start_Menu_Color_02[]   = _("Red");
const u8 gText_Start_Menu_Color_03[]   = _("Yellow");
...
static void DrawChoices_StartMenuColor(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_START_MENU_COLOR);
    
    DrawOptionMenuChoice(sStartMenuColors[selection], 104, y, 0, active);
}

static void DrawChoices_BattleInterfaceShortcut(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_SHORTCUT_BUTTON);
    u8 styles[2] = {0};
    styles[selection] = 1;
