...
const u16 gSpeciesToHoennPokedexNum[NUM_SPECIES] =  // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
    {
        SPECIES_TO_HOENN(TREECKO),   SPECIES_TO_HOENN(GROVYLE),   SPECIES_TO_HOENN(SCEPTILE),   SPECIES_TO_HOENN(TORCHIC),    SPECIES_TO_HOENN(COMBUSKEN),
        SPECIES_TO_HOENN(BLAZIKEN),  SPECIES_TO_HOENN(MUDKIP),    SPECIES_TO_HOENN(MARSHTOMP),  SPECIES_TO_HOENN(SWAMPERT),   SPECIES_TO_HOENN(POOCHYENA),
        SPECIES_TO_HOENN(MIGHTYENA), SPECIES_TO_HOENN(ZIGZAGOON), SPECIES_TO_HOENN(LINOONE),    SPECIES_TO_HOENN(WURMPLE),    SPECIES_TO_HOENN(SILCOON),
        SPECIES_TO_HOENN(BEAUTIFLY), SPECIES_TO_HOENN(CASCOON),   SPECIES_TO_HOENN(DUSTOX),     SPECIES_TO_HOENN(LOTAD),      SPECIES_TO_HOENN(LOMBRE),
        SPECIES_TO_HOENN(LUDICOLO),  SPECIES_TO_HOENN(SEEDOT),    SPECIES_TO_HOENN(NUZLEAF),    SPECIES_TO_HOENN(SHIFTRY),    SPECIES_TO_HOENN(TAILLOW),
        SPECIES_TO_HOENN(SWELLOW),   SPECIES_TO_HOENN(WINGULL),   SPECIES_TO_HOENN(PELIPPER),   SPECIES_TO_HOENN(RALTS),      SPECIES_TO_HOENN(KIRLIA),
        SPECIES_TO_HOENN(GARDEVOIR), SPECIES_TO_HOENN(GALLADE),   SPECIES_TO_HOENN(SURSKIT),    SPECIES_TO_HOENN(MASQUERAIN), SPECIES_TO_HOENN(SHROOMISH),
        SPECIES_TO_HOENN(BRELOOM),   SPECIES_TO_HOENN(SLAKOTH),   SPECIES_TO_HOENN(VIGOROTH),   SPECIES_TO_HOENN(SLAKING),    SPECIES_TO_HOENN(ABRA),
        SPECIES_TO_HOENN(KADABRA),   SPECIES_TO_HOENN(ALAKAZAM),  SPECIES_TO_HOENN(NINCADA),    SPECIES_TO_HOENN(NINJASK),    SPECIES_TO_HOENN(SHEDINJA),
        SPECIES_TO_HOENN(WHISMUR),   SPECIES_TO_HOENN(LOUDRED),   SPECIES_TO_HOENN(EXPLOUD),    SPECIES_TO_HOENN(MAKUHITA),   SPECIES_TO_HOENN(HARIYAMA),
        SPECIES_TO_HOENN(GOLDEEN),   SPECIES_TO_HOENN(SEAKING),   SPECIES_TO_HOENN(MAGIKARP),   SPECIES_TO_HOENN(GYARADOS),   SPECIES_TO_HOENN(AZURILL),
        SPECIES_TO_HOENN(MARILL),    SPECIES_TO_HOENN(AZUMARILL), SPECIES_TO_HOENN(GEODUDE),    SPECIES_TO_HOENN(GRAVELER),   SPECIES_TO_HOENN(GOLEM),
        SPECIES_TO_HOENN(NOSEPASS),  SPECIES_TO_HOENN(PROBOPASS), SPECIES_TO_HOENN(SKITTY),     SPECIES_TO_HOENN(DELCATTY),   SPECIES_TO_HOENN(ZUBAT),
        SPECIES_TO_HOENN(GOLBAT),    SPECIES_TO_HOENN(CROBAT),    SPECIES_TO_HOENN(TENTACOOL),  SPECIES_TO_HOENN(TENTACRUEL), SPECIES_TO_HOENN(SABLEYE),
        SPECIES_TO_HOENN(MAWILE),    SPECIES_TO_HOENN(ARON),      SPECIES_TO_HOENN(LAIRON),     SPECIES_TO_HOENN(AGGRON),     SPECIES_TO_HOENN(MACHOP),
        SPECIES_TO_HOENN(MACHOKE),   SPECIES_TO_HOENN(MACHAMP),   SPECIES_TO_HOENN(MEDITITE),   SPECIES_TO_HOENN(MEDICHAM),   SPECIES_TO_HOENN(ELECTRIKE),
        SPECIES_TO_HOENN(MANECTRIC), SPECIES_TO_HOENN(PLUSLE),    SPECIES_TO_HOENN(MINUN),      SPECIES_TO_HOENN(MAGNEMITE),  SPECIES_TO_HOENN(MAGNETON),
        SPECIES_TO_HOENN(MAGNEZONE), SPECIES_TO_HOENN(VOLTORB),   SPECIES_TO_HOENN(ELECTRODE),  SPECIES_TO_HOENN(VOLBEAT),    SPECIES_TO_HOENN(ILLUMISE),
        SPECIES_TO_HOENN(ODDISH),    SPECIES_TO_HOENN(GLOOM),     SPECIES_TO_HOENN(VILEPLUME),  SPECIES_TO_HOENN(BELLOSSOM),  SPECIES_TO_HOENN(DODUO),
        SPECIES_TO_HOENN(DODRIO),    SPECIES_TO_HOENN(BUDEW),     SPECIES_TO_HOENN(ROSELIA),    SPECIES_TO_HOENN(ROSERADE),   SPECIES_TO_HOENN(GULPIN),
        SPECIES_TO_HOENN(SWALOT),    SPECIES_TO_HOENN(CARVANHA),  SPECIES_TO_HOENN(SHARPEDO),   SPECIES_TO_HOENN(WAILMER),    SPECIES_TO_HOENN(WAILORD),
        SPECIES_TO_HOENN(NUMEL),     SPECIES_TO_HOENN(CAMERUPT),  SPECIES_TO_HOENN(SLUGMA),     SPECIES_TO_HOENN(MAGCARGO),   SPECIES_TO_HOENN(TORKOAL),
        SPECIES_TO_HOENN(GRIMER),    SPECIES_TO_HOENN(MUK),       SPECIES_TO_HOENN(KOFFING),    SPECIES_TO_HOENN(WEEZING),    SPECIES_TO_HOENN(SPOINK),
        SPECIES_TO_HOENN(GRUMPIG),   SPECIES_TO_HOENN(SANDSHREW), SPECIES_TO_HOENN(SANDSLASH),  SPECIES_TO_HOENN(SPINDA),     SPECIES_TO_HOENN(SKARMORY),
        SPECIES_TO_HOENN(TRAPINCH),  SPECIES_TO_HOENN(VIBRAVA),   SPECIES_TO_HOENN(FLYGON),     SPECIES_TO_HOENN(CACNEA),     SPECIES_TO_HOENN(CACTURNE),
        SPECIES_TO_HOENN(SWABLU),    SPECIES_TO_HOENN(ALTARIA),   SPECIES_TO_HOENN(ZANGOOSE),   SPECIES_TO_HOENN(SEVIPER),    SPECIES_TO_HOENN(LUNATONE),
        SPECIES_TO_HOENN(SOLROCK),   SPECIES_TO_HOENN(BARBOACH),  SPECIES_TO_HOENN(WHISCASH),   SPECIES_TO_HOENN(CORPHISH),   SPECIES_TO_HOENN(CRAWDAUNT),
        SPECIES_TO_HOENN(BALTOY),    SPECIES_TO_HOENN(CLAYDOL),   SPECIES_TO_HOENN(LILEEP),     SPECIES_TO_HOENN(CRADILY),    SPECIES_TO_HOENN(ANORITH),
        SPECIES_TO_HOENN(ARMALDO),   SPECIES_TO_HOENN(IGGLYBUFF), SPECIES_TO_HOENN(JIGGLYPUFF), SPECIES_TO_HOENN(WIGGLYTUFF1), SPECIES_TO_HOENN(FEEBAS),
        SPECIES_TO_HOENN(MILOTIC),   SPECIES_TO_HOENN(CASTFORM),  SPECIES_TO_HOENN(STARYU),     SPECIES_TO_HOENN(STARMIE),    SPECIES_TO_HOENN(KECLEON),
        SPECIES_TO_HOENN(SHUPPET),   SPECIES_TO_HOENN(BANETTE),   SPECIES_TO_HOENN(DUSKULL),    SPECIES_TO_HOENN(DUSCLOPS),   SPECIES_TO_HOENN(DUSKNOIR),
        SPECIES_TO_HOENN(TROPIUS),   SPECIES_TO_HOENN(CHINGLING), SPECIES_TO_HOENN(CHIMECHO),   SPECIES_TO_HOENN(ABSOL),      SPECIES_TO_HOENN(VULPIX),
        SPECIES_TO_HOENN(NINETALES), SPECIES_TO_HOENN(PICHU),     SPECIES_TO_HOENN(PIKACHU),    SPECIES_TO_HOENN(RAICHU),     SPECIES_TO_HOENN(PSYDUCK),
        SPECIES_TO_HOENN(GOLDUCK),   SPECIES_TO_HOENN(WYNAUT),    SPECIES_TO_HOENN(WOBBUFFET),  SPECIES_TO_HOENN(NATU),       SPECIES_TO_HOENN(XATU),
        SPECIES_TO_HOENN(GIRAFARIG), SPECIES_TO_HOENN(PHANPY),    SPECIES_TO_HOENN(DONPHAN),    SPECIES_TO_HOENN(PINSIR),     SPECIES_TO_HOENN(HERACROSS),
        SPECIES_TO_HOENN(RHYHORN),   SPECIES_TO_HOENN(RHYDON),    SPECIES_TO_HOENN(RHYPERIOR),  SPECIES_TO_HOENN(SNORUNT),    SPECIES_TO_HOENN(GLALIE),
        SPECIES_TO_HOENN(FROSLASS),  SPECIES_TO_HOENN(SPHEAL),    SPECIES_TO_HOENN(SEALEO),     SPECIES_TO_HOENN(WALREIN),    SPECIES_TO_HOENN(CLAMPERL),
        SPECIES_TO_HOENN(HUNTAIL),   SPECIES_TO_HOENN(GOREBYSS),  SPECIES_TO_HOENN(RELICANTH),  SPECIES_TO_HOENN(CORSOLA),    SPECIES_TO_HOENN(CHINCHOU),
        SPECIES_TO_HOENN(LANTURN),   SPECIES_TO_HOENN(LUVDISC),   SPECIES_TO_HOENN(HORSEA),     SPECIES_TO_HOENN(SEADRA),     SPECIES_TO_HOENN(KINGDRA),
        SPECIES_TO_HOENN(BAGON),     SPECIES_TO_HOENN(SHELGON),   SPECIES_TO_HOENN(SALAMENCE),  SPECIES_TO_HOENN(BELDUM),     SPECIES_TO_HOENN(METANG),
        SPECIES_TO_HOENN(METAGROSS), SPECIES_TO_HOENN(REGIROCK),  SPECIES_TO_HOENN(REGICE),     SPECIES_TO_HOENN(REGISTEEL),  SPECIES_TO_HOENN(LATIAS),
        SPECIES_TO_HOENN(LATIOS),    SPECIES_TO_HOENN(KYOGRE),    SPECIES_TO_HOENN(GROUDON),    SPECIES_TO_HOENN(RAYQUAZA),   SPECIES_TO_HOENN(JIRACHI),
...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] =  // Assigns all species to the National Dex Index (Summary No. for National Dex)
    {
        ...
        SPECIES_TO_NATIONAL(WIGGLYTUFF1),
        ...
        SPECIES_TO_NATIONAL(BLACEPHALON1),
        ...
        [SPECIES_HITMONCHAN_MEGA1 - 1] = NATIONAL_DEX_HITMONCHAN,
        ...
        [SPECIES_SLAKING_MEGA_APE_SHIFT - 1] = NATIONAL_DEX_SLAKING,
        ...
        [SPECIES_MEGANIUM_MEGA1 - 1] = NATIONAL_DEX_MEGANIUM,
        ...
        // Unown
        [SPECIES_UNOWN_B1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_C1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_STEVE_REALER - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_E1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_F1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_G1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_OBAMASNOW_MEGA - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_I1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_J1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_K1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_L1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_M1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_N1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_O1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_PEPSICHAMP_MEGA - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_Q1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_R1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_S1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_T1 - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_BOWSERSTOISE_MEGA - 1] = NATIONAL_DEX_UNOWN,
        [SPECIES_UNOWN_V1 - 1] = NATIONAL_DEX_UNOWN,
        ...
        [SPECIES_CASTFORM_FOGGY - 1] = NATIONAL_DEX_CASTFORM,
        // Deoxys
        ...
        [SPECIES_HONEDGE_REDUX - 1] = NATIONAL_DEX_HONEDGE,
        [SPECIES_DOUBLADE_REDUX - 1] = NATIONAL_DEX_DOUBLADE,
        [SPECIES_AEGISLASH_REDUX - 1] = NATIONAL_DEX_AEGISLASH,
        [SPECIES_AEGISLASH_BLADE_REDUX - 1] = NATIONAL_DEX_AEGISLASH,
        [SPECIES_ABRA_REDUX - 1] = NATIONAL_DEX_ABRA,
        [SPECIES_KADABRA_REDUX - 1] = NATIONAL_DEX_KADABRA,
        [SPECIES_ALAKAZAM_REDUX - 1] = NATIONAL_DEX_ALAKAZAM,
        [SPECIES_ALAKAZAM_MEGA_REDUX - 1] = NATIONAL_DEX_ALAKAZAM,
        [SPECIES_WEEDLE_REDUX - 1] = NATIONAL_DEX_WEEDLE,
        [SPECIES_KAKUNA_REDUX - 1] = NATIONAL_DEX_KAKUNA,
        [SPECIES_BEEDRILL_REDUX - 1] = NATIONAL_DEX_BEEDRILL,
        [SPECIES_BEEDRILL_MEGA_REDUX - 1] = NATIONAL_DEX_BEEDRILL,
        [SPECIES_STUFFUL_REDUX - 1] = NATIONAL_DEX_STUFFUL,
        [SPECIES_BEWEAR_REDUX - 1] = NATIONAL_DEX_BEWEAR,
        [SPECIES_PANPOUR_REDUX - 1] = NATIONAL_DEX_PANPOUR,
        [SPECIES_SIMIPOUR_REDUX - 1] = NATIONAL_DEX_SIMIPOUR,
        [SPECIES_PANSAGE_REDUX - 1] = NATIONAL_DEX_PANSAGE,
        [SPECIES_SIMISAGE_REDUX - 1] = NATIONAL_DEX_SIMISAGE,
        [SPECIES_PANSEAR_REDUX - 1] = NATIONAL_DEX_PANSEAR,
        [SPECIES_SIMISEAR_REDUX - 1] = NATIONAL_DEX_SIMISEAR,
        [SPECIES_SLUGMA_REDUX - 1] = NATIONAL_DEX_SLUGMA,
        [SPECIES_MAGCARGO_REDUX - 1] = NATIONAL_DEX_MAGCARGO,
        [SPECIES_BUIZEL_REDUX - 1] = NATIONAL_DEX_BUIZEL,
        [SPECIES_FLOATZEL_REDUX - 1] = NATIONAL_DEX_FLOATZEL,
        [SPECIES_AZELF_REDUX - 1] = NATIONAL_DEX_AZELF,
        [SPECIES_MESPRIT_REDUX - 1] = NATIONAL_DEX_MESPRIT,
        [SPECIES_UXIE_REDUX - 1] = NATIONAL_DEX_UXIE,
        [SPECIES_MACHOP_REDUX - 1] = NATIONAL_DEX_MACHOP,
        [SPECIES_MACHOKE_REDUX - 1] = NATIONAL_DEX_MACHOKE,
        [SPECIES_MACHAMP_REDUX - 1] = NATIONAL_DEX_MACHAMP,
        [SPECIES_MACHAMP_MEGA_REDUX - 1] = NATIONAL_DEX_MACHAMP,
        [SPECIES_SOLOSIS_REDUX - 1] = NATIONAL_DEX_SOLOSIS,
        [SPECIES_DUOSION_REDUX - 1] = NATIONAL_DEX_DUOSION,
        [SPECIES_REUNICLUS_REDUX - 1] = NATIONAL_DEX_REUNICLUS,
        [SPECIES_SKARMORY_REDUX - 1] = NATIONAL_DEX_SKARMORY,
        [SPECIES_GROWLITHE_REDUX - 1] = NATIONAL_DEX_GROWLITHE,
        [SPECIES_ARCANINE_REDUX - 1] = NATIONAL_DEX_ARCANINE,
        [SPECIES_WHISMUR_REDUX - 1] = NATIONAL_DEX_WHISMUR,
        [SPECIES_LOUDRED_REDUX - 1] = NATIONAL_DEX_LOUDRED,
        [SPECIES_EXPLOUD_REDUX - 1] = NATIONAL_DEX_EXPLOUD,
        [SPECIES_GIBLE_REDUX - 1] = NATIONAL_DEX_GIBLE,
        [SPECIES_GABITE_REDUX - 1] = NATIONAL_DEX_GABITE,
        [SPECIES_GARCHOMP_REDUX - 1] = NATIONAL_DEX_GARCHOMP,
        [SPECIES_DEINO_REDUX - 1] = NATIONAL_DEX_DEINO,
        [SPECIES_ZWEILOUS_REDUX - 1] = NATIONAL_DEX_ZWEILOUS,
        [SPECIES_HYDREIGON_REDUX - 1] = NATIONAL_DEX_HYDREIGON,
        [SPECIES_PAWNIARD_REDUX - 1] = NATIONAL_DEX_PAWNIARD,
        [SPECIES_BISHARP_REDUX - 1] = NATIONAL_DEX_BISHARP,
        [SPECIES_MAWILE_REDUX - 1] = NATIONAL_DEX_MAWILE,
        [SPECIES_SABLEYE_REDUX - 1] = NATIONAL_DEX_SABLEYE,
        [SPECIES_HOUNDOUR_REDUX - 1] = NATIONAL_DEX_HOUNDOUR,
        [SPECIES_HOUNDOOM_REDUX - 1] = NATIONAL_DEX_HOUNDOOM,
        [SPECIES_DODUO_REDUX - 1] = NATIONAL_DEX_DODUO,
        [SPECIES_DODRIO_REDUX - 1] = NATIONAL_DEX_DODRIO,
        [SPECIES_KINGAMBIT_REDUX - 1] = NATIONAL_DEX_KINGAMBIT,
        [SPECIES_LARVITAR_REDUX - 1] = NATIONAL_DEX_LARVITAR,
        [SPECIES_PUPITAR_REDUX - 1] = NATIONAL_DEX_PUPITAR,
        ...
        [SPECIES_ESCARGINITE_REDUX - 1] = NATIONAL_DEX_ESCARGINITE,
};

const u16 gHoennToNationalOrder[HOENN_DEX_COUNT] =  // Assigns Hoenn Dex Pokémon (Using National Dex Index)
    {
        HOENN_TO_NATIONAL(TREECKO),   HOENN_TO_NATIONAL(GROVYLE),   HOENN_TO_NATIONAL(SCEPTILE),   HOENN_TO_NATIONAL(TORCHIC),    HOENN_TO_NATIONAL(COMBUSKEN),
        HOENN_TO_NATIONAL(BLAZIKEN),  HOENN_TO_NATIONAL(MUDKIP),    HOENN_TO_NATIONAL(MARSHTOMP),  HOENN_TO_NATIONAL(SWAMPERT),   HOENN_TO_NATIONAL(POOCHYENA),
        HOENN_TO_NATIONAL(MIGHTYENA), HOENN_TO_NATIONAL(ZIGZAGOON), HOENN_TO_NATIONAL(LINOONE),    HOENN_TO_NATIONAL(WURMPLE),    HOENN_TO_NATIONAL(SILCOON),
        HOENN_TO_NATIONAL(BEAUTIFLY), HOENN_TO_NATIONAL(CASCOON),   HOENN_TO_NATIONAL(DUSTOX),     HOENN_TO_NATIONAL(LOTAD),      HOENN_TO_NATIONAL(LOMBRE),
        HOENN_TO_NATIONAL(LUDICOLO),  HOENN_TO_NATIONAL(SEEDOT),    HOENN_TO_NATIONAL(NUZLEAF),    HOENN_TO_NATIONAL(SHIFTRY),    HOENN_TO_NATIONAL(TAILLOW),
        HOENN_TO_NATIONAL(SWELLOW),   HOENN_TO_NATIONAL(WINGULL),   HOENN_TO_NATIONAL(PELIPPER),   HOENN_TO_NATIONAL(RALTS),      HOENN_TO_NATIONAL(KIRLIA),
        HOENN_TO_NATIONAL(GARDEVOIR), HOENN_TO_NATIONAL(GALLADE),   HOENN_TO_NATIONAL(SURSKIT),    HOENN_TO_NATIONAL(MASQUERAIN), HOENN_TO_NATIONAL(SHROOMISH),
        HOENN_TO_NATIONAL(BRELOOM),   HOENN_TO_NATIONAL(SLAKOTH),   HOENN_TO_NATIONAL(VIGOROTH),   HOENN_TO_NATIONAL(SLAKING),    HOENN_TO_NATIONAL(ABRA),
        HOENN_TO_NATIONAL(KADABRA),   HOENN_TO_NATIONAL(ALAKAZAM),  HOENN_TO_NATIONAL(NINCADA),    HOENN_TO_NATIONAL(NINJASK),    HOENN_TO_NATIONAL(SHEDINJA),
        HOENN_TO_NATIONAL(WHISMUR),   HOENN_TO_NATIONAL(LOUDRED),   HOENN_TO_NATIONAL(EXPLOUD),    HOENN_TO_NATIONAL(MAKUHITA),   HOENN_TO_NATIONAL(HARIYAMA),
        HOENN_TO_NATIONAL(GOLDEEN),   HOENN_TO_NATIONAL(SEAKING),   HOENN_TO_NATIONAL(MAGIKARP),   HOENN_TO_NATIONAL(GYARADOS),   HOENN_TO_NATIONAL(AZURILL),
        HOENN_TO_NATIONAL(MARILL),    HOENN_TO_NATIONAL(AZUMARILL), HOENN_TO_NATIONAL(GEODUDE),    HOENN_TO_NATIONAL(GRAVELER),   HOENN_TO_NATIONAL(GOLEM),
        HOENN_TO_NATIONAL(NOSEPASS),  HOENN_TO_NATIONAL(PROBOPASS), HOENN_TO_NATIONAL(SKITTY),     HOENN_TO_NATIONAL(DELCATTY),   HOENN_TO_NATIONAL(ZUBAT),
        HOENN_TO_NATIONAL(GOLBAT),    HOENN_TO_NATIONAL(CROBAT),    HOENN_TO_NATIONAL(TENTACOOL),  HOENN_TO_NATIONAL(TENTACRUEL), HOENN_TO_NATIONAL(SABLEYE),
        HOENN_TO_NATIONAL(MAWILE),    HOENN_TO_NATIONAL(ARON),      HOENN_TO_NATIONAL(LAIRON),     HOENN_TO_NATIONAL(AGGRON),     HOENN_TO_NATIONAL(MACHOP),
        HOENN_TO_NATIONAL(MACHOKE),   HOENN_TO_NATIONAL(MACHAMP),   HOENN_TO_NATIONAL(MEDITITE),   HOENN_TO_NATIONAL(MEDICHAM),   HOENN_TO_NATIONAL(ELECTRIKE),
        HOENN_TO_NATIONAL(MANECTRIC), HOENN_TO_NATIONAL(PLUSLE),    HOENN_TO_NATIONAL(MINUN),      HOENN_TO_NATIONAL(MAGNEMITE),  HOENN_TO_NATIONAL(MAGNETON),
        HOENN_TO_NATIONAL(MAGNEZONE), HOENN_TO_NATIONAL(VOLTORB),   HOENN_TO_NATIONAL(ELECTRODE),  HOENN_TO_NATIONAL(VOLBEAT),    HOENN_TO_NATIONAL(ILLUMISE),
        HOENN_TO_NATIONAL(ODDISH),    HOENN_TO_NATIONAL(GLOOM),     HOENN_TO_NATIONAL(VILEPLUME),  HOENN_TO_NATIONAL(BELLOSSOM),  HOENN_TO_NATIONAL(DODUO),
        HOENN_TO_NATIONAL(DODRIO),    HOENN_TO_NATIONAL(BUDEW),     HOENN_TO_NATIONAL(ROSELIA),    HOENN_TO_NATIONAL(ROSERADE),   HOENN_TO_NATIONAL(GULPIN),
        HOENN_TO_NATIONAL(SWALOT),    HOENN_TO_NATIONAL(CARVANHA),  HOENN_TO_NATIONAL(SHARPEDO),   HOENN_TO_NATIONAL(WAILMER),    HOENN_TO_NATIONAL(WAILORD),
        HOENN_TO_NATIONAL(NUMEL),     HOENN_TO_NATIONAL(CAMERUPT),  HOENN_TO_NATIONAL(SLUGMA),     HOENN_TO_NATIONAL(MAGCARGO),   HOENN_TO_NATIONAL(TORKOAL),
        HOENN_TO_NATIONAL(GRIMER),    HOENN_TO_NATIONAL(MUK),       HOENN_TO_NATIONAL(KOFFING),    HOENN_TO_NATIONAL(WEEZING),    HOENN_TO_NATIONAL(SPOINK),
        HOENN_TO_NATIONAL(GRUMPIG),   HOENN_TO_NATIONAL(SANDSHREW), HOENN_TO_NATIONAL(SANDSLASH),  HOENN_TO_NATIONAL(SPINDA),     HOENN_TO_NATIONAL(SKARMORY),
        HOENN_TO_NATIONAL(TRAPINCH),  HOENN_TO_NATIONAL(VIBRAVA),   HOENN_TO_NATIONAL(FLYGON),     HOENN_TO_NATIONAL(CACNEA),     HOENN_TO_NATIONAL(CACTURNE),
        HOENN_TO_NATIONAL(SWABLU),    HOENN_TO_NATIONAL(ALTARIA),   HOENN_TO_NATIONAL(ZANGOOSE),   HOENN_TO_NATIONAL(SEVIPER),    HOENN_TO_NATIONAL(LUNATONE),
        HOENN_TO_NATIONAL(SOLROCK),   HOENN_TO_NATIONAL(BARBOACH),  HOENN_TO_NATIONAL(WHISCASH),   HOENN_TO_NATIONAL(CORPHISH),   HOENN_TO_NATIONAL(CRAWDAUNT),
        HOENN_TO_NATIONAL(BALTOY),    HOENN_TO_NATIONAL(CLAYDOL),   HOENN_TO_NATIONAL(LILEEP),     HOENN_TO_NATIONAL(CRADILY),    HOENN_TO_NATIONAL(ANORITH),
        HOENN_TO_NATIONAL(ARMALDO),   HOENN_TO_NATIONAL(IGGLYBUFF), HOENN_TO_NATIONAL(JIGGLYPUFF), HOENN_TO_NATIONAL(WIGGLYTUFF1), HOENN_TO_NATIONAL(FEEBAS),
        HOENN_TO_NATIONAL(MILOTIC),   HOENN_TO_NATIONAL(CASTFORM),  HOENN_TO_NATIONAL(STARYU),     HOENN_TO_NATIONAL(STARMIE),    HOENN_TO_NATIONAL(KECLEON),
        HOENN_TO_NATIONAL(SHUPPET),   HOENN_TO_NATIONAL(BANETTE),   HOENN_TO_NATIONAL(DUSKULL),    HOENN_TO_NATIONAL(DUSCLOPS),   HOENN_TO_NATIONAL(DUSKNOIR),
        HOENN_TO_NATIONAL(TROPIUS),   HOENN_TO_NATIONAL(CHINGLING), HOENN_TO_NATIONAL(CHIMECHO),   HOENN_TO_NATIONAL(ABSOL),      HOENN_TO_NATIONAL(VULPIX),
        HOENN_TO_NATIONAL(NINETALES), HOENN_TO_NATIONAL(PICHU),     HOENN_TO_NATIONAL(PIKACHU),    HOENN_TO_NATIONAL(RAICHU),     HOENN_TO_NATIONAL(PSYDUCK),
        HOENN_TO_NATIONAL(GOLDUCK),   HOENN_TO_NATIONAL(WYNAUT),    HOENN_TO_NATIONAL(WOBBUFFET),  HOENN_TO_NATIONAL(NATU),       HOENN_TO_NATIONAL(XATU),
        HOENN_TO_NATIONAL(GIRAFARIG), HOENN_TO_NATIONAL(PHANPY),    HOENN_TO_NATIONAL(DONPHAN),    HOENN_TO_NATIONAL(PINSIR),     HOENN_TO_NATIONAL(HERACROSS),
        HOENN_TO_NATIONAL(RHYHORN),   HOENN_TO_NATIONAL(RHYDON),    HOENN_TO_NATIONAL(RHYPERIOR),  HOENN_TO_NATIONAL(SNORUNT),    HOENN_TO_NATIONAL(GLALIE),
        HOENN_TO_NATIONAL(FROSLASS),  HOENN_TO_NATIONAL(SPHEAL),    HOENN_TO_NATIONAL(SEALEO),     HOENN_TO_NATIONAL(WALREIN),    HOENN_TO_NATIONAL(CLAMPERL),
        HOENN_TO_NATIONAL(HUNTAIL),   HOENN_TO_NATIONAL(GOREBYSS),  HOENN_TO_NATIONAL(RELICANTH),  HOENN_TO_NATIONAL(CORSOLA),    HOENN_TO_NATIONAL(CHINCHOU),
        HOENN_TO_NATIONAL(LANTURN),   HOENN_TO_NATIONAL(LUVDISC),   HOENN_TO_NATIONAL(HORSEA),     HOENN_TO_NATIONAL(SEADRA),     HOENN_TO_NATIONAL(KINGDRA),
        HOENN_TO_NATIONAL(BAGON),     HOENN_TO_NATIONAL(SHELGON),   HOENN_TO_NATIONAL(SALAMENCE),  HOENN_TO_NATIONAL(BELDUM),     HOENN_TO_NATIONAL(METANG),
        HOENN_TO_NATIONAL(METAGROSS), HOENN_TO_NATIONAL(REGIROCK),  HOENN_TO_NATIONAL(REGICE),     HOENN_TO_NATIONAL(REGISTEEL),  HOENN_TO_NATIONAL(LATIAS),
        HOENN_TO_NATIONAL(LATIOS),    HOENN_TO_NATIONAL(KYOGRE),    HOENN_TO_NATIONAL(GROUDON),    HOENN_TO_NATIONAL(RAYQUAZA),   HOENN_TO_NATIONAL(JIRACHI),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] = {
    ...
    [SPECIES_WIGGLYTUFF1 - 1] = ANIM_H_JUMPS,
    ...
    [SPECIES_RAPIDASH1 - 1] = ANIM_H_SHAKE,
    ...
    [SPECIES_HITMONCHAN1 - 1] = ANIM_GROW_VIBRATE,
    ...
    [SPECIES_MUDSDALE1 - 1] = ANIM_V_SHAKE_TWICE,
    ...
    [SPECIES_BLACEPHALON1 - 1] = ANIM_SHAKE_GLOW_RED,
    ...
    [SPECIES_TINKATON1 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_TINKATON_MEGA1 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_WIGGLYTUFF_PRIMAL1 - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_SCRAFTY_MEGA - 1] = ANIM_V_SQUISH_AND_BOUNCE,
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] = {
    ...
    [SPECIES_HYPNO - 1] = 40,     [SPECIES_HITMONCHAN1 - 1] = 25, [SPECIES_SCYTHER - 1] = 10,   [SPECIES_TAUROS - 1] = 10,   [SPECIES_TYPHLOSION - 1] = 20,
...
u32 GetUnownSpeciesId(u32 personality) {
    ...
    return unownLetter + SPECIES_UNOWN_B1 - 1;
}
...
const struct CompressedSpritePalette *GetMonSpritePalStructFromOtIdPersonality(u16 species, u32 personality, u8 isShiny) {
    if (isSpeciesPlaceholderMon(species)) species = PLACEHOLDER_SPECIES;
...
bool8 IsMonSpriteNotFlipped(u16 species) { return gBaseStats[species].noFlip; }
...
bool8 SpeciesHasDifferentForms(u16 speciesId) { return gFormSpeciesIdTables[speciesId] != NULL; }
...
u16 getRandomSpecies(void) {
    static const u16 Obt[][1] = {
        ...
        {SPECIES_NAGANADEL}, {SPECIES_STAKATAKA}, {SPECIES_BLACEPHALON1}, {SPECIES_ZERAORA},
    };
    ...
    if (!enc && leg) {
        ...
        do {
            species = RandRangeDeterministic(min, max, &rndSeed);
                 ...
                 species == SPECIES_NAGANADEL || species == SPECIES_STAKATAKA || species == SPECIES_BLACEPHALON1 ||
                 // Legendary
        ...
        if (gSaveBlock2Ptr->encounterRandomizedLegendaryMode == FALSE) {
            ...
            do {
                species = RandRangeDeterministic(0, LAST_REDUX_FORM - 1, &rndSeed);
                     ...
                     (species >= SPECIES_DRAGONITE_DELIVERY && species <= SPECIES_TINKATON_MEGA1));
        } else {
            ...
            do {
                species = RandRangeDeterministic(0, LAST_REDUX_FORM - 1, &rndSeed);
                     ...
                     // Monochamp Mons
                     species == SPECIES_DRACOVISH_MEGA || species == SPECIES_WIGGLYTUFF_APEX1 || species == SPECIES_WIGGLYTUFF_PRIMAL1 ||
...
u16 getBaseSpeciesFromMega(u16 species) {
    switch (species) {
        ...
        case SPECIES_RILLABOOM_MEGA:
            return SPECIES_RILLABOOM;
        case SPECIES_CINDERACE_MEGA:
            return SPECIES_CINDERACE;
        case SPECIES_INTELEON_MEGA:
            return SPECIES_INTELEON;
        case SPECIES_CORVIKNIGHT_MEGA:
            return SPECIES_CORVIKNIGHT;
        case SPECIES_ORBEETLE_MEGA:
            return SPECIES_ORBEETLE;
        case SPECIES_DREDNAW_MEGA:
            return SPECIES_DREDNAW;
        case SPECIES_COALOSSAL_MEGA:
            return SPECIES_COALOSSAL;
        ...
        case SPECIES_HATTERENE_MEGA:
            return SPECIES_HATTERENE;
        case SPECIES_GRIMMSNARL_MEGA:
            return SPECIES_GRIMMSNARL;
        ...
        case SPECIES_WIGGLYTUFF_PRIMAL1:
            return SPECIES_WIGGLYTUFF_APEX1;
