...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_WIGGLYTUFF1] = BACK_ANIM_GROW,
    ...
    [SPECIES_RAPIDASH1]   = BACK_ANIM_JOLT_RIGHT,
    ...
    [SPECIES_HITMONCHAN1] = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_TINKATON1] = BACK_ANIM_H_SLIDE,
    ...
    [SPECIES_TINKATON_MEGA1] = BACK_ANIM_H_SLIDE,
    ...
    [SPECIES_WIGGLYTUFF_PRIMAL1] = BACK_ANIM_GROW,
    [SPECIES_WIGGLYTUFF_APEX1] = BACK_ANIM_GROW,
    ...
    [SPECIES_WIGGLYTUFF_MEGA1] = BACK_ANIM_H_SLIDE,
    [SPECIES_WIGGLYTUFF_MEGA_X1] = BACK_ANIM_H_SLIDE,
    ...
    [SPECIES_RAPIDASH_MEGA1] = BACK_ANIM_H_SLIDE,
