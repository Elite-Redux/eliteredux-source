...
static u32 GetMonSize(SpeciesEnum species, u16 b)
{
    u64 unk2;
    u64 unk4;
    u64 unk0;
...
static u8 CompareMonSize(SpeciesEnum species, u16 *sizeRecord)
{
...
static void GetMonSizeRecordInfo(SpeciesEnum species, u16 *sizeRecord)
{
