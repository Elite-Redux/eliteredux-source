...
// Config options - Note that some config options need external modifications to fully work, such as CONFIG_CAN_FORGET_HM_MOVES, CONFIG_PHYSICAL_SPECIAL_SPLIT,
// and CONFIG_DECAPITALIZE_MET_LOCATION_STRINGS
...
static EWRAM_DATA struct PokemonSummaryScreenData {
    ...
    u8 trueMaxPageIndex;
    u8 currStatIndex;
    bool8 lockMonFlag;    // This is used to prevent the player from changing pokemon in the move deleter select, etc, but it is not needed because the input is
    ...
    u16 moveReplaceFirstMove;
    u8 moveReplaceCurrentIdx;
    u8 moveReplaceTabNum;
    u8 moveReplaceMoveNum;
...
static void Task_SwitchFromMoveReplaceMenu(u8 taskId);
...
static const struct WindowTemplate sSummaryTemplate[] = {
    [PSS_LABEL_PANE_LEFT_TOP] = {.bg = 0, .tilemapLeft = 0, .tilemapTop = 0, .width = 10, .height = 4, .paletteNum = 2, .baseBlock = 800},
    [PSS_LABEL_PANE_LEFT_BOTTOM] =
        {
            .bg = 0,
            .tilemapLeft = 0,
...
static const u8 sTextColors[][3] = {[PSS_COLOR_BLACK_GRAY_SHADOW] = {0, 7, 8},
...
static void (*const sTextPrinterFunctions[])(void) = {[PSS_PAGE_INFO] = PrintInfoPage,
...
static const union AnimCmd sSpriteAnim_TypeFighting[] = {ANIMCMD_FRAME(TYPE_FIGHTING * 8, 0, FALSE, FALSE), ANIMCMD_END};
...
static const union AnimCmd sSpriteAnim_TypeMystery[] = {ANIMCMD_FRAME(TYPE_MYSTERY * 8, 0, FALSE, FALSE), ANIMCMD_END};
...
static const union AnimCmd sSpriteAnim_TypePsychic[] = {ANIMCMD_FRAME(TYPE_PSYCHIC * 8, 0, FALSE, FALSE), ANIMCMD_END};
...
static const union AnimCmd sSpriteAnim_TypeStellar[] = {ANIMCMD_FRAME(TYPE_STELLAR * 8, 0, FALSE, FALSE), ANIMCMD_END};
static const union AnimCmd *const sSpriteAnimTable_MoveTypes[NUMBER_OF_MON_TYPES] = {
    sSpriteAnim_TypeNormal, sSpriteAnim_TypeFighting, sSpriteAnim_TypeFlying, sSpriteAnim_TypePoison,   sSpriteAnim_TypeGround,
    sSpriteAnim_TypeRock,   sSpriteAnim_TypeBug,      sSpriteAnim_TypeGhost,  sSpriteAnim_TypeSteel,    sSpriteAnim_TypeMystery,
    sSpriteAnim_TypeFire,   sSpriteAnim_TypeWater,    sSpriteAnim_TypeGrass,  sSpriteAnim_TypeElectric, sSpriteAnim_TypePsychic,
    sSpriteAnim_TypeIce,    sSpriteAnim_TypeDragon,   sSpriteAnim_TypeDark,   sSpriteAnim_TypeFairy,    sSpriteAnim_TypeStellar,
};

const struct CompressedSpriteSheet sSpriteSheet_MoveTypes = {.data = gMoveTypes_Gfx, .size = (NUMBER_OF_MON_TYPES) * 0x100, .tag = TAG_MOVE_TYPES};
const struct SpriteTemplate sSpriteTemplate_MoveTypes = {.tileTag = TAG_MOVE_TYPES,
...
static const u8 sMoveTypeToOamPaletteNum[NUMBER_OF_MON_TYPES] = {
    [TYPE_NORMAL] = 13,  [TYPE_FIGHTING] = 13, [TYPE_FLYING] = 14,  [TYPE_POISON] = 14, [TYPE_GROUND] = 13, [TYPE_ROCK] = 13,    [TYPE_BUG] = 15,
    [TYPE_GHOST] = 14,   [TYPE_STEEL] = 13,    [TYPE_MYSTERY] = 15, [TYPE_FIRE] = 13,   [TYPE_WATER] = 14,  [TYPE_GRASS] = 15,   [TYPE_ELECTRIC] = 13,
    [TYPE_PSYCHIC] = 14, [TYPE_ICE] = 14,      [TYPE_DRAGON] = 15,  [TYPE_DARK] = 13,   [TYPE_FAIRY] = 14,  [TYPE_STELLAR] = 15,
};
...
static const union AnimCmd sSpriteAnim_MoveSelectorLeftRed[] = {ANIMCMD_FRAME(0, 0, FALSE, FALSE), ANIMCMD_END};
static const union AnimCmd sSpriteAnim_MoveSelectorCenterRed[] = {ANIMCMD_FRAME(16, 0, FALSE, FALSE), ANIMCMD_END};
static const union AnimCmd sSpriteAnim_MoveSelectorRightRed[] = {ANIMCMD_FRAME(0, 0, TRUE, FALSE), ANIMCMD_END};
static const union AnimCmd sSpriteAnim_MoveSelectorLeftWhite[] = {ANIMCMD_FRAME(32, 0, FALSE, FALSE), ANIMCMD_END};
static const union AnimCmd sSpriteAnim_MoveSelectorCenterWhite[] = {ANIMCMD_FRAME(48, 0, FALSE, FALSE), ANIMCMD_END};
static const union AnimCmd sSpriteAnim_MoveSelectorRightWhite[] = {ANIMCMD_FRAME(32, 0, TRUE, FALSE), ANIMCMD_END};
static const union AnimCmd *const sSpriteAnimTable_MoveSelector[] = {sSpriteAnim_MoveSelectorLeftRed,
...
static const struct CompressedSpriteSheet sMoveSelectorSpriteSheet = {.data = gSummaryMoveSelect_Gfx, .size = 0x800, .tag = TAG_MOVE_SELECTOR};
static const struct CompressedSpritePalette sMoveSelectorSpritePal = {.data = gSummaryMoveSelect_Pal, .tag = TAG_MOVE_SELECTOR};
...
static const struct CompressedSpriteSheet sStatusIconsSpriteSheet = {.data = gStatusGfx_Icons, .size = 0x480, .tag = TAG_MON_STATUS};
static const struct CompressedSpritePalette sStatusIconsSpritePalette = {.data = gStatusPal_Icons, .tag = TAG_MON_STATUS};
...
static const struct OamData sOamData_ExpHealthBars = {.y = 0,
                                                      .affineMode = ST_OAM_AFFINE_OFF,
                                                      .objMode = ST_OAM_OBJ_NORMAL,
                                                      .mosaic = FALSE,
                                                      .bpp = ST_OAM_4BPP,
...
static const union AnimCmd *const sSpriteAnimTable_ExpHealthBars[] = {sSpriteAnim_ExpHealthBarDivisionEmpty,
...
static const u32 *const sPageTilemaps[] = {gSummaryScreenPageInfoTilemap,
...
const u8 sText_TitlePageDetail[] = _("{DPAD_LEFTRIGHT}Page {A_BUTTON}Detail {R_BUTTON}Replace");
...
static const struct SpritePalette sSpritePal_SplitIcons = {.data = sSplitIcons_Pal, .tag = TAG_SPLIT_ICONS};

static const union AnimCmd sSpriteAnim_SplitIcon0[] = {ANIMCMD_FRAME(0, 0), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_SplitIcon1[] = {ANIMCMD_FRAME(8, 0), ANIMCMD_END};

static const union AnimCmd sSpriteAnim_SplitIcon2[] = {ANIMCMD_FRAME(16, 0), ANIMCMD_END};
...
static const struct SpriteTemplate sSpriteTemplate_SplitIcons = {.tileTag = TAG_SPLIT_ICONS,
...
static void DestroySplitIcon(void) {
    if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_SPLIT] != 0xFF) DestroySprite(&gSprites[sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_SPLIT]]);
...
static u8 ShowMoveTypeIcon(u16 move) {
    if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MOVE_TYPE] == 0xFF)
        sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MOVE_TYPE] =
            CreateSprite(&sSpriteTemplate_MoveTypes, SPRITE_ARR_ID_MOVE_TYPE_X, SPRITE_ARR_ID_MOVE_TYPE_Y, 0);
...
static void UpdateTypeIcon(u16 move) {
    ...
    if (move == MOVE_NONE) gSprites[sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MOVE_TYPE]].invisible = TRUE;

    SetTypeSpritePosAndPal(movetype, SPRITE_ARR_ID_MOVE_TYPE_X, SPRITE_ARR_ID_MOVE_TYPE_Y, SPRITE_ARR_ID_MOVE_TYPE);
}

static void DestroyMoveTypeIcon(void) {
    if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MOVE_TYPE] != 0xFF) DestroySprite(&gSprites[sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MOVE_TYPE]]);
...
void ShowPokemonSummaryScreen(u8 mode, void *mons, u8 monIndex, u8 maxMonIndex, void (*callback)(void)) {
    ...
    if (gMonSpritesGfxPtr == NULL) sub_806F2AC(0, 0);
...
static bool8 LoadGraphics(void) {
    ...
    switch (gMain.state) {
        ...
        case 5:
            ...
            break;
        case 6:
            if (DecompressGraphics() != FALSE) gMain.state++;
            break;
        case 7:
            ResetWindows();
            gMain.state++;
        ...
        case 8:
            ...
            break;
        case 9:
            if (ExtractMonDataToSummaryStruct(&sMonSummaryScreen->currentMon) != 0) gMain.state++;
            break;
        case 10:
            PrintMonInfo();
            gMain.state++;
        ...
        case 18:
            ...
            sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MON_ICON] =
                CreateMonIcon(sMonSummaryScreen->summary.species2, SpriteCB_MonIcon, 20, 47, 1, sMonSummaryScreen->summary.pid);
...
static void CloseSummaryScreen(u8 taskId) {
    if (MenuHelpers_CallLinkSomething() != TRUE && !gPaletteFade.active) {
        ...
        if (gMonSpritesGfxPtr == NULL) sub_806F47C(0);
        FreeSummaryScreen();
        DestroyTask(taskId);
    }
}
...
static void ChangeSummaryPokemon(u8 taskId, s8 delta) {
    ...
    if (!sMonSummaryScreen->lockMonFlag) {
        ...
        if (monId != -1) {
            PlaySE(SE_SELECT);
            if (sMonSummaryScreen->summary.ailment != AILMENT_NONE) SetSpriteInvisibility(SPRITE_ARR_ID_STATUS, TRUE);
...
static void Task_ChangeSummaryMon(u8 taskId) {
    ...
    switch (data[0]) {
        ...
        case 12:
            ...
            if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MON] == SPRITE_NONE) return;
...
static s8 AdvanceMultiBattleMonIndex(s8 delta) {
    ...
    while (TRUE) {
        ...
        if (arrId < 0)
            ...
            arrId = 0;
        index = order[arrId];
        if (IsValidToViewInMulti(&mons[index]) == TRUE) return index;
    }
}
...
static int IsStab(u16 *abilities, int type) {
    ...
    if (!abilities[1]) {
        ...
        abilities[4] =
            RandomizeType(gSpecies[sMonSummaryScreen->summary.species].type1, sMonSummaryScreen->summary.species, sMonSummaryScreen->summary.pid, TRUE);
        abilities[5] =
            RandomizeType(gSpecies[sMonSummaryScreen->summary.species].type2, sMonSummaryScreen->summary.species, sMonSummaryScreen->summary.pid, FALSE);
    }
...
static void GenerateMoveReplaceList(u8 keyPress) {
    ...
    ZERO(sMonSummaryScreen->moveReplaceList)
    ...
    switch (sMonSummaryScreen->moveReplaceTabNum) {
        case MOVE_REPLACE_TAB_LEVEL:
            for (i = 0; gSpecies[species].levelUpMoves[i].move; i++) {
                newMove = gSpecies[species].levelUpMoves[i].move;
                moveLevel = gSpecies[species].levelUpMoves[i].level;
            ...
            for (i = 0; i < TUTOR_COUNT; i++) {
                ...
                if (CanLearnTutorMove(species, i) && gBattleMoves[newMove].effect != EFFECT_PLACEHOLDER && newMove != MOVE_NONE) {
                    ...
                    if (expectedSplit != SPLIT_STATUS) {
                        ...
                        } else if (gBattleMoves[newMove].effect != EFFECT_COUNTER && gBattleMoves[newMove].effect != EFFECT_METAL_BURST &&
                                   gBattleMoves[newMove].effect != EFFECT_MIRROR_COAT && gBattleMoves[newMove].effect != EFFECT_LEVEL_DAMAGE &&
                    ...
                    if (isStab)
                        boostedMoves[++boostedMoves[0]] = newMove;
                    else
                        otherMoves[++otherMoves[0]] = newMove;
                }
            }
...
const u32 gSummaryScreenPageMoveDetailsReplaceTilemap[] = INCBIN_U32("graphics/summary_screen/page_moves_replace_selected.bin.lz");
const u32 gSummaryScreenPageMoveReplaceTilemap[] = INCBIN_U32("graphics/summary_screen/page_moves_replace.bin.lz");
...
static void Task_SwitchToReplaceMove(u8 taskId) {
    ...
    switch (data[0]) {
        case 0:
            ...
            SetSpriteInvisibility(SPRITE_ARR_ID_TYPE + 5, TRUE);
            StopPokemonAnimations();
            sMonSummaryScreen->markingsSprite->x = 257;
            sMonSummaryScreen->markingsSprite->y = 332;
...
static const u8 sSummary_R_Arrow[] = INCBIN_U8("graphics/summary_screen/new/r_arrow.4bpp");
static const u8 sSummary_L_Arrow[] = INCBIN_U8("graphics/summary_screen/new/l_arrow.4bpp");

#define MAX_MOVE_REPLACE_MOVES 7
#define MAX_MOVE_TABS 3
#define SPACE_BETWEEN_MOVES_AND_BPACC (10 * 8)
#define SPACE_BETWEEN_MOVES_AND_BPACC_2 (2 * 8) + 3
...
static void RedrawMoveTypeMenu() {
    ...
    // Move List
    windowId = PSS_LABEL_PANE_RIGHT_BASE;
        ...
        switch (tabNum) {
            case MOVE_REPLACE_TAB_LEVEL:
                AddTextPrinterParameterized4(
                    windowId, FONT_SMALL_NARROW, (PosX * 8), (PosY * 8) - 4, 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], 0xFF, sText_Move_Type_Level);
                break;
            case MOVE_REPLACE_TAB_PHYSICAL:
                AddTextPrinterParameterized4(
                    windowId, FONT_SMALL_NARROW, (PosX * 8), (PosY * 8) - 4, 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], 0xFF, sText_Move_Type_Physical);
                break;
            case MOVE_REPLACE_TAB_SPECIAL:
                AddTextPrinterParameterized4(
                    windowId, FONT_SMALL_NARROW, (PosX * 8), (PosY * 8) - 4, 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], 0xFF, sText_Move_Type_Special);
                break;
            case MOVE_REPLACE_TAB_STATUS:
                AddTextPrinterParameterized4(
                    windowId, FONT_SMALL_NARROW, (PosX * 8), (PosY * 8) - 4, 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], 0xFF, sText_Move_Type_Status);
                break;
        }

        if (i == 1) BlitBitmapToWindow(windowId, sMoveTabCursor, (PosX * 8) - 4, (PosY * 8) - 1, 32, 16);
...
static void PrintMoveReplaceTab(void) {
    ...
    windowId = PSS_LABEL_PANE_RIGHT;

    CopyWindowToWindow(PSS_LABEL_PANE_RIGHT_BASE, windowId);

    if (numMoves > MAX_MOVE_REPLACE_MOVES) numMoves = MAX_MOVE_REPLACE_MOVES;
    ...
    for (i = 0; i < numMoves; i++) {
        ...
        moveNum = sMonSummaryScreen->moveReplaceList[sMonSummaryScreen->moveReplaceFirstMove + i];
        AddTextPrinterParameterized4(
            windowId, FONT_NARROW, (PosX * 8), (PosY * 8), 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], 0xFF, gMoveNamesLong[moveNum]);
        ...
        if (moveNum == MOVE_SKETCH && !hasMonMove && getLearnsetMon(sMonSummaryScreen->summary.species2) != SPECIES_SMEARGLE) {
            ...
            for (j = 0; gSpecies[species].levelUpMoves[j].move; j++) {
                int newMove = gSpecies[species].levelUpMoves[j].move;
                int moveLevel = gSpecies[species].levelUpMoves[j].level;
        ...
        if (hasMonMove) {
            AddTextPrinterParameterized4(windowId,
                                         FONT_NARROW,
                                         (PosX * 8) + SPACE_BETWEEN_MOVES_AND_BPACC,
                                         (PosY * 8),
                                         0,
                                         0,
                                         sTextColors[PSS_COLOR_MALE_GENDER_SYMBOL],
                                         0xFF,
                                         sText_MoveLearned);
        } else {
            ...
            AddTextPrinterParameterized4(windowId,
                                         ...
                                         0,
                                         0,
                                         sTextColors[PSS_COLOR_BLACK_GRAY_SHADOW],
                                         0xFF,
                                         sText_Move_Power);
            AddTextPrinterParameterized4(windowId,
                                         FONT_SMALL_NARROW,
                                         (PosX * 8) + SPACE_BETWEEN_MOVES_AND_BPACC + SPACE_BETWEEN_MOVES_AND_BPACC_2,
                                         (PosY * 8) - 4,
                                         0,
                                         0,
                                         sTextColors[PSS_COLOR_BLACK_GRAY_SHADOW],
...
#define LEFTRIGHT_ITEM_NUMBER_CHANGE 5 5
#define NUM_OF_POSSIBLE_OPTIONS_THAT_FIT_ON_SCREEN 7
...
static void Task_HandleInput_ReplaceMoves(u8 taskId) {
    ...
    if (JOY_NEW(DPAD_DOWN) || (JOY_REPEAT(DPAD_DOWN) && !sMonSummaryScreen->replaceMoveMode)) {
        if (sMonSummaryScreen->replaceMoveMode) {
            ...
            PressedDownButton_ReplaceMoves();
            PrintMoveReplaceTab();
        }
        PrintMoveInfoFromReplaceTab();
...
static bool8 HasMoreThanOneMove(void) {
    ...
    for (i = 1; i < MAX_MON_MOVES; i++) {
        if (sMonSummaryScreen->summary.moves[i] != 0) return TRUE;
    }
    return FALSE;
}
...
static void ChangeSelectedMove(s16 *taskData, s8 direction, u8 *moveIndexPtr) {
    ...
    if ((*moveIndexPtr == MAX_MON_MOVES && sMonSummaryScreen->newMove == MOVE_NONE) || taskData[1] == 1) ScheduleBgCopyTilemapToVram(0);
...
static void Task_SwitchFromMoveDetails(u8 taskId) {
    ...
    switch (data[0]) {
        ...
        case 2:
            ...
            if (sMonSummaryScreen->spriteIds[SPRITE_ARR_ID_MON] != SPRITE_NONE) data[0]++;
            break;
        case 3:
            ...
            if (GetMonData(&sMonSummaryScreen->currentMon, MON_DATA_HELD_ITEM)) SetSpriteInvisibility(SPRITE_ARR_ID_ITEM, FALSE);
            CreateSetStatusSprite();
...
static void CloseMoveReplaceMode(u8 taskId) {
    ...
    gTasks[taskId].func = Task_HandleInput;
    SetTaskFuncWithFollowupFunc(taskId, Task_SwitchFromMoveReplaceMenu, gTasks[taskId].func);
}
...
static void Task_SwitchFromMoveReplaceMenu(u8 taskId) {
    ...
    switch (data[0]) {
        case 0:
            SetMoveTypeIcons();
            for (i = 0; i < MAX_MON_MOVES; i++) {
                if (summary->moves[i] != MOVE_NONE) SetSpriteInvisibility(SPRITE_ARR_ID_TYPE + 2 + i, FALSE);
            }

            LZDecompressWram(gSummaryScreenPageMovesTilemap, sMonSummaryScreen->bgTilemapBufferPage);
            SetBgTilemapBuffer(2, sMonSummaryScreen->bgTilemapBufferPage);
            PrintBattleMovesFromReplaceMenu();
            data[0]++;
            break;
        case 1:
            DestroyMoveSelectorSprites(SPRITE_ARR_ID_MOVE_SELECTOR1);
...
static void ResetWindows(void) {
    ...
    for (i = 0; i < PSS_LABEL_WINDOW_COUNT; i++) FillWindowPixelBuffer(i, PIXEL_FILL(0));
    for (i = 0; i < ARRAY_COUNT(sMonSummaryScreen->windowIds); i++) sMonSummaryScreen->windowIds[i] = WINDOW_NONE;
}
...
static void PrintNotEggInfo(void) {
    ...
    PrintNarrowTextOnWindowNoRender(PSS_LABEL_PANE_LEFT_TOP, gStringVar1, 20, 2, 0, 1);
    ...
    if (IsMonShiny(mon) != SHINY_NONE) PrintTextOnWindow(PSS_LABEL_PANE_LEFT_TOP, sText_Shiny, 62, 18, 0, PSS_COLOR_SHINY_STARS);

#if CONFIG_FATEFUL_ENCOUNTER_MARK
    if (summary->isEventMon) PrintTextOnWindow(PSS_LABEL_PANE_LEFT_TOP, sText_Fateful, 52, 18, 0, PSS_COLOR_FATEFUL_TRIANGLE);
    if (isAlpha) PrintTextOnWindow(PSS_LABEL_PANE_LEFT_TOP, sText_Alpha, 43, 18, 0, PSS_COLOR_SHINY_STARS);
#else
    if (isAlpha) PrintTextOnWindow(PSS_LABEL_PANE_LEFT_TOP, sText_Alpha, 52, 18, 0, PSS_COLOR_SHINY_STARS);
#endif
    ...
    AddTextPrinterParameterized4(PSS_LABEL_PANE_LEFT_BOTTOM, 0, 33, 7, 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], TEXT_SPEED_FF, sText_HeldItem);
...
static void PrintEggInfo(void) {
    ...
    AddTextPrinterParameterized4(PSS_LABEL_PANE_LEFT_BOTTOM, 0, 9, 7, 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], TEXT_SPEED_FF, sText_HeldItem);
    AddTextPrinterParameterized4(PSS_LABEL_PANE_LEFT_BOTTOM, 0, x, 19, 0, 0, sTextColors[PSS_COLOR_BLACK_GRAY_SHADOW], 0, gStringVar1);
}
...
static void PutPageWindowTilemaps(u8 page) {
    ...
    for (i = 0; i < ARRAY_COUNT(sMonSummaryScreen->windowIds); i++) PutWindowTilemap(sMonSummaryScreen->windowIds[i]);
...
static void PrintInfoPage(void) {
    ...
    if (summary->level < MAX_LEVEL)
        ConvertIntToDecimalStringN(
            gStringVar1, gExperienceTables[gSpecies[summary->species].growthRate][summary->level + 1] - summary->exp, STR_CONV_MODE_RIGHT_ALIGN, 6);
    else
    ...
    if (summary->level < MAX_LEVEL) {
        u32 expBetweenLevels = gExperienceTables[gSpecies[summary->species].growthRate][summary->level + 1] -
                               gExperienceTables[gSpecies[summary->species].growthRate][summary->level];
        ...
        if (numExpProgressBarTicks == 0 && expSinceLastLevel != 0) numExpProgressBarTicks = 1;
    } else
...
static void BufferMonTrainerMemo(void) {
    ...
    if (InBattleFactory() == TRUE || InSlateportBattleTent() == TRUE || IsInGamePartnerMon() == TRUE) {
        ...
        if (sum->metGame == VERSION_GAMECUBE) {
            ...
            } else if (sum->isEventMon && sum->metLocation == 0 &&
                       (sum->species == SPECIES_EEVEE || sum->species == SPECIES_VAPOREON || sum->species == SPECIES_JOLTEON ||
                        sum->species == SPECIES_FLAREON || sum->species == SPECIES_ESPEON || sum->species == SPECIES_UMBREON)) {
                DynamicPlaceholderTextUtil_SetPlaceholderPtr(4, sum->OTName);
        ...
        if (!DidMonComeFromGBAGames()) StringCopy(metLocationString, sMapName_DistantLand);
...
void CopyNatureName(u8 nature) { StringCopy(gStringVar1, gNatureNamePointers[nature]); }
...
static void GetMetLevelString(u8 *output) {
    ...
    if (level == 0) level = EGG_HATCH_LEVEL;
...
static bool8 DidMonComeFromGBAGames(void) {
    struct PokeSummary *sum = &sMonSummaryScreen->summary;
    if (sum->metGame >= VERSION_SAPPHIRE && sum->metGame <= VERSION_LEAF_GREEN) return TRUE;
    return FALSE;
}

static bool8 DidMonComeFromRSE(void) {
    struct PokeSummary *sum = &sMonSummaryScreen->summary;
    if (sum->metGame >= VERSION_SAPPHIRE && sum->metGame <= VERSION_EMERALD) return TRUE;
    return FALSE;
}

static bool8 DidMonComeFromFRLG(void) {
    struct PokeSummary *sum = &sMonSummaryScreen->summary;
    if (sum->metGame == VERSION_FIRE_RED || sum->metGame == VERSION_LEAF_GREEN) return TRUE;
    return FALSE;
}

static bool8 IsInGamePartnerMon(void) {
    if ((gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER) && gMain.inBattle) {
        if (sMonSummaryScreen->curMonIndex == 1 || sMonSummaryScreen->curMonIndex == 4 || sMonSummaryScreen->curMonIndex == 5) return TRUE;
    }
    return FALSE;
}
...
static void PrintSkillsPage(void) {
    ...
    if (numHPBarTicks == 0 && summary->currentHP != 0) numHPBarTicks = 1;
...
static void PrintConditionPage(void) {
    ...
    if (numSheenBarTicks == 0 && summary->sheen != 0) numSheenBarTicks = 1;
    ...
    switch (gSpecies[species].evos[i].method) {
        ...
        case EVO_LEVEL_NINJASK:
            if (species != SPECIES_EEVEE) {
                ...
                // Target Species
                StringCopy(gStringVar4, gText_Eeveevolution);
            }

            PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
            // Evolution Method
            ConvertIntToDecimalStringN(gStringVar2, gSpecies[species].evos[i].param, STR_CONV_MODE_LEADING_ZEROS, EVO_SCREEN_LVL_DIGITS);  // level
        ...
        case EVO_TRADE_ITEM:
            ...
            PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
            // Evolution Method
            item = gSpecies[species].evos[i].param;  // item
        ...
        case EVO_MOVE:
            ...
            PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
            // Evolution Method
            StringCopy(gStringVar2, gMoveNames[gSpecies[species].evos[i].param]);
        ...
        case EVO_MOVE_TYPE:
            ...
            PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
            // Evolution Method
            StringCopy(gStringVar2, gTypeNames[gSpecies[species].evos[i].param]);
        ...
        case EVO_SPECIFIC_MAPSEC:
            ...
            PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
            // Evolution Method
            StringCopy(gStringVar2, gRegionMapEntries[gSpecies[species].evos[i].param].name);
        ...
        case EVO_SPECIFIC_MON_IN_PARTY:
            ...
            PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
            // Evolution Method
            StringCopy(gStringVar2, gSpecies[gSpecies[species].evos[i].param].name);  // mon name
        ...
        case EVO_SPECIFIC_MAP:
            ...
            PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
            // Evolution Method
            mapHeader = Overworld_GetMapHeaderByGroupAndId(gSpecies[species].evos[i].param >> 8, gSpecies[species].evos[i].param & 0xFF);
...
static void BufferMonPokemonEvolutionData(void) {
    ...
    for (i = 0; i < EVOS_PER_MON; i++) {
        if (gSpecies[species].evos[i].method != 0 && gSpecies[species].evos[i].targetSpecies != actualSpecies) times = i + 1;
    }
    ...
    if (times == 0)  // || isEnemyMon
    {
        ...
        if (species == SPECIES_EEVEE) times = 1;
    ...
    // Pokeball Change
    CopyItemName(pokeball, gStringVar1);  // pokeball
    StringExpandPlaceholders(gStringVar4, gText_Pokeball);
    PrintSmallTextOnWindow(PSS_LABEL_PANE_RIGHT, gStringVar4, 0, y, EVOLUTION_METHOD_LINE_SPACING, PSS_COLOR_WHITE_BLACK_SHADOW);
}
...
const u8 gText_Effect_Hit_Number[] = _("Max Hits");
const u8 gText_Effect_Boost_Type[] = _("Boost Type");
const u8 gText_Effect_Based_Type[] = _("Based on");
const u8 gText_Effect_Boost_Type_Weather[] = _("Weather");
const u8 gText_Effect_Boost_Type_Fist[] = _("Fist");
const u8 gText_Effect_Boost_Type_Kick[] = _("Kick");
const u8 gText_Effect_Boost_Type_Sound[] = _("Sound");
const u8 gText_Effect_Boost_Type_Cannon[] = _("Cannon");
const u8 gText_Effect_Boost_Type_Dance[] = _("Dance");
const u8 gText_Effect_Boost_Type_Field[] = _("Field");
...
static void PrintMoveInfo(u16 move, u8 tabNum, bool8 moveReplaceMode) {
    ...
    switch (tabNum) {
        ...
        case MOVE_INFO_EFFECT:
            ...
            if (gBattleMoves[move].target == MOVE_TARGET_USER || gBattleMoves[move].target == MOVE_TARGET_ALL_BATTLERS)
                StringCopy(gStringVar1, gText_Effect_Misc);

            // Status Effects
            MoveEffectIntoStringVar1(move);
            PrintSmallTextOnWindow(windowId, gStringVar1, MOVE_EFFECT_Y, PosX, 0, 0);

            // Chance -------------------------------------------------------------------------------------------
            PosX = PosX + 16;
            PrintSmallTextOnWindow(windowId, gText_Chance, MOVE_EFFECT_TEXT_Y, PosX, 0, 0);
        ...
        case MOVE_INFO_EFFECT_2:
            // Target -------------------------------------------------------------------------------------------
            PrintSmallTextOnWindow(windowId, gText_Target, MOVE_EFFECT_TEXT_Y, PosX, 0, 0);
            if (gBattleMoves[move].target == MOVE_TARGET_FOES_AND_ALLY)
                PrintSmallTextOnWindow(windowId, gText_Effect_FoeAndAlly, MOVE_EFFECT_Y, PosX, 0, 0);
            else if (gBattleMoves[move].target == MOVE_TARGET_BOTH)
                PrintSmallTextOnWindow(windowId, gText_Effect_BothFoes, MOVE_EFFECT_Y, PosX, 0, 0);
            else if (gBattleMoves[move].target == MOVE_TARGET_USER)
                PrintSmallTextOnWindow(windowId, gText_Effect_Self, MOVE_EFFECT_Y, PosX, 0, 0);
            else if (gBattleMoves[move].target == MOVE_TARGET_ALL_BATTLERS)
                PrintSmallTextOnWindow(windowId, gText_Effect_Field, MOVE_EFFECT_Y, PosX, 0, 0);
            else
                PrintSmallTextOnWindow(windowId, gText_Effect_OneFoe, MOVE_EFFECT_Y, PosX, 0, 0);

            // Critical -------------------------------------------------------------------------------------------
            PosX = PosX + 16;
            PrintSmallTextOnWindow(windowId, gText_Critical, MOVE_EFFECT_TEXT_Y, PosX, 0, 0);

            if (gBattleMoves[move].flags & FLAG_HIGH_CRIT)
                PrintSmallTextOnWindow(windowId, gText_Effect_Critical_High, MOVE_EFFECT_Y, PosX, 0, 0);
            else if (gBattleMoves[move].alwaysCrit == TRUE)
                PrintSmallTextOnWindow(windowId, gText_Effect_Critical_Always, MOVE_EFFECT_Y, PosX, 0, 0);
            else
...
if (gBattleMoves[move].flags & FLAG_TWO_STRIKES)
    numHits = 2;
            ...
            // Sheer Force -------------------------------------------------------------------------------------------
            PosX = PosX + 16;
            PrintSmallTextOnWindow(windowId, gText_Effect_Sheer_Force_Boosted, MOVE_EFFECT_TEXT_Y, PosX, 0, 0);
            if ((gBattleMoves[move].flags & FLAG_SHEER_FORCE_BOOST))
                StringCopy(gStringVar1, gText_Effect_ContactYes);
            else
                StringCopy(gStringVar1, gText_Effect_ContactNo);
            PrintSmallTextOnWindow(windowId, gStringVar1, MOVE_EFFECT_Y, PosX, 0, 0);
            break;
        case MOVE_INFO_BOOSTS:
            // Boosted -------------------------------------------------------------------------------------------
            PrintSmallTextOnWindow(windowId, gText_Effect_Boost_Type, MOVE_EFFECT_TEXT_Y, PosX, 0, 0);
            if ((gBattleMoves[move].flags & FLAG_IRON_FIST_BOOST))
                StringCopy(gStringVar1, gText_Effect_Boost_Type_Fist);
            ...
            // Ignores Ability -------------------------------------------------------------------------------------------
            PosX = PosX + 16;
            PrintSmallTextOnWindow(windowId, gText_Effect_Ignores_Ability, MOVE_EFFECT_TEXT_Y, PosX, 0, 0);
            ...
            // Ignores Stats -------------------------------------------------------------------------------------------
            PosX = PosX + 16;
            PrintSmallTextOnWindow(windowId, gText_Effect_Ignores_Stats, MOVE_EFFECT_TEXT_Y, PosX, 0, 0);
...
static void RedrawMoveDetailsBase(bool8 moveReplaceMode) {
    ...
    if (sMonSummaryScreen->replaceMoveMode) {
        int currentMove = sMonSummaryScreen->moveReplaceList[sMonSummaryScreen->moveReplaceCurrentIdx];
...
static void PrintMoveDetails(u16 move, bool8 moveReplaceMode) {
    ...
    if (sMonSummaryScreen->replaceMoveMode) {
        ...
        for (i = 0; i < MAX_MON_MOVES; i++) {
            currentMove = GetMonData(mon, MON_DATA_MOVE1 + i, 0);
            if (i == sMonSummaryScreen->moveReplaceMoveNum) BlitBitmapToWindow(PSS_LABEL_PANE_LEFT_MOVE, sMoveCursorDark, PosX - 12, PosY, 8, 16);
        ...
        // Cancel
        if (sMonSummaryScreen->moveReplaceMoveNum == MAX_MON_MOVES) BlitBitmapToWindow(PSS_LABEL_PANE_LEFT_MOVE, sMoveCursorDark, PosX - 12, PosY, 8, 16);
...
static void SwapMovesNamesPP(u8 moveIndex1, u8 moveIndex2) {
    ...
    for (i = 0; i < MAX_MON_MOVES; i++) PrintMoveNameAndPP(i);
}

static void ResetSpriteIds(void) {
    u8 i;

    for (i = 0; i < ARRAY_COUNT(sMonSummaryScreen->spriteIds); i++) sMonSummaryScreen->spriteIds[i] = SPRITE_NONE;
}
...
static void SetSpriteInvisibility(u8 spriteArrayId, bool8 invisible) { gSprites[sMonSummaryScreen->spriteIds[spriteArrayId]].invisible = invisible; }
...
static void HidePageSpecificSprites(void) {
    ...
    for (i = SPRITE_ARR_ID_ORIGIN; i < ARRAY_COUNT(sMonSummaryScreen->spriteIds); i++) {
        if (sMonSummaryScreen->spriteIds[i] != SPRITE_NONE) SetSpriteInvisibility(i, TRUE);
    }

    for (i = 0; i < HP_BAR_SPRITES_COUNT; i++) sHealthBar->sprites[i]->invisible = TRUE;
    for (i = 0; i < EXP_BAR_SPRITES_COUNT; i++) sExpBar->sprites[i]->invisible = TRUE;
}
...
static void CreateMoveTypeIcons(void) {
    ...
    for (i = SPRITE_ARR_ID_TYPE; i < SPRITE_ARR_ID_TYPE + 7; i++) {
        if (sMonSummaryScreen->spriteIds[i] == SPRITE_NONE) sMonSummaryScreen->spriteIds[i] = CreateSprite(&sSpriteTemplate_MoveTypes, 0, 0, 2);
        ...
        case 0:
            if (gMain.inBattle) {
                HandleLoadSpecialPokePic(
                    &gSpecies[summary->species2].frontPic, gMonSpritesGfxPtr->sprites.ptr[B_POSITION_OPPONENT_LEFT], summary->species2, summary->pid);
            } else {
                if (gMonSpritesGfxPtr != NULL) {
                    HandleLoadSpecialPokePic(
                        &gSpecies[summary->species2].frontPic, gMonSpritesGfxPtr->sprites.ptr[B_POSITION_OPPONENT_LEFT], summary->species2, summary->pid);
                } else {
                    HandleLoadSpecialPokePic(&gSpecies[summary->species2].frontPic, sub_806F4F8(0, 1), summary->species2, summary->pid);
                }
            }
            (*state)++;
            return 0xFF;
...
static void CreateSetStatusSprite(void) {
    ...
    if (*spriteId == SPRITE_NONE) *spriteId = CreateSprite(&sSpriteTemplate_StatusCondition, 20, 124, 0);
...
static void CreateMoveSelectorSprites(u8 idArrayStart) {
    ...
    if (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES) {
        u8 subpriority = 1;
        if (idArrayStart == SPRITE_ARR_ID_MOVE_SELECTOR1) subpriority = 0;
...
static void SpriteCb_MoveSelector(struct Sprite *sprite) {
    ...
    if (sprite->data[0] == SPRITE_ARR_ID_MOVE_SELECTOR1) {
        ...
        if (sMonSummaryScreen->firstMoveIndex > 0) sprite->y2--;
    } else {
        sprite->y2 = sMonSummaryScreen->secondMoveIndex * 29;
        if (sMonSummaryScreen->secondMoveIndex > 0) sprite->y2--;
    }
}

static void DestroyMoveSelectorSprites(u8 firstArrayId) {
    u8 i;
    for (i = 0; i < MOVE_SELECTOR_SPRITES_COUNT; i++) DestroySpriteInArray(firstArrayId + i);
}
...
static void CreateHealthBarSprites(u16 tileTag, u16 palTag) {
    ...
    if (gfxBufferPtr != NULL) {
        struct SpriteSheet sheet = {.data = gfxBufferPtr, .size = 0x20 * 12, .tag = tileTag};
...
static void ConfigureHealthBarSprites(void) {
    ...
    for (i = 0; i < HP_BAR_SPRITES_COUNT; i++) sHealthBar->sprites[i]->oam.paletteNum = IndexOfSpritePaletteTag(TAG_HEALTH_BAR) + hpBarPalOffset;

    if (curHp == maxHp) {
        for (i = 2; i < HP_BAR_SPRITES_COUNT - 1; i++) StartSpriteAnim(sHealthBar->sprites[i], 8);
    } else {
        v0 = (maxHp << 2) / 8;
        v1 = (curHp << 2);
        ...
        for (i = 2; i < numWholeHpBarTiles; i++) StartSpriteAnim(sHealthBar->sprites[i], 8);

        animNum = (v1 * 8) / v0;
        StartSpriteAnim(sHealthBar->sprites[numWholeHpBarTiles], animNum);

        for (i = numWholeHpBarTiles + 1; i < HP_BAR_SPRITES_COUNT - 1; i++) StartSpriteAnim(sHealthBar->sprites[i], 0);
    }
...
static void DestroyHealthBarSprites(void) {
    ...
    for (i = 0; i < HP_BAR_SPRITES_COUNT; i++)
        if (sHealthBar->sprites[i] != NULL) DestroySpriteAndFreeResources(sHealthBar->sprites[i]);
...
static void SetHealthBarSprites(void) {
    ...
    if (sMonSummaryScreen->currPageIndex == PSS_PAGE_SKILLS) {
        for (i = 0; i < HP_BAR_SPRITES_COUNT; i++) sHealthBar->sprites[i]->invisible = FALSE;
    }
}
...
static void ConfigureExpBarSprites(void) {
    ...
    if (level < 100) {
        ...
        for (i = 2; i < numWholeExpBarTiles; i++) StartSpriteAnim(sExpBar->sprites[i], 8);
        ...
        for (i = numWholeExpBarTiles + 1; i < EXP_BAR_SPRITES_COUNT - 1; i++) StartSpriteAnim(sExpBar->sprites[i], 0);
    } else
        for (i = 2; i < EXP_BAR_SPRITES_COUNT - 1; i++) StartSpriteAnim(sExpBar->sprites[i], 0);
...
static void DestroyExpBarSprites(void) {
    ...
    for (i = 0; i < EXP_BAR_SPRITES_COUNT; i++)
        if (sExpBar->sprites[i] != NULL) DestroySpriteAndFreeResources(sExpBar->sprites[i]);
...
static void SetExpBarSprites(void) {
    ...
    if (sMonSummaryScreen->currPageIndex == PSS_PAGE_INFO) {
        for (i = 0; i < EXP_BAR_SPRITES_COUNT; i++) sExpBar->sprites[i]->invisible = FALSE;
    }
}
...
static void PrintInfoBar(u8 pageIndex, bool8 detailsShown) {
    ...
    AddTextPrinterParameterized4(PSS_LABEL_PANE_TITLE, 0, 3, 0, 0, 0, sTextColors[PSS_COLOR_WHITE_BLACK_SHADOW], TEXT_SPEED_FF, gStringVar1);
