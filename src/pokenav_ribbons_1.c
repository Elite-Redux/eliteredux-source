...
static void InitMonRibbonPokenavListMenuTemplate(void)
{
    ...
    spriteTemplate.list.monList = GetMonRibbonMonListData();
    spriteTemplate.count = GetRibbonsMonListCount();
    spriteTemplate.unk8 = 4;
    spriteTemplate.unk6 = GetRibbonListMenuCurrIndex();
    ...
    spriteTemplate.listFunc.printMonFunc = BufferRibbonMonInfoText;
    spriteTemplate.unk14 = NULL;
    sub_81C81D4(&sMonRibbonListBgTemplates[1], &spriteTemplate, 0);
}
