...
static u8 CreateWheelIconSprite(const struct SpriteTemplate *spriteTemplate, u8 r1, u16 *angle)
{
    u16 temp;
    u8 spriteId = CreateSprite(spriteTemplate, 116, 80, spriteTemplate->oam->y);
