...
const u8 gText_BirchStrictCaps[] = _("Elite Caps"); // Elite
...
const u8 gText_FlyToWhere[] = _("L/R to clip."); //changed from "Fly to where?"
...
const u8 gText_ShopAlreadyHaveItem[] = _("You already have that item!{PAUSE_UNTIL_PRESS}");
const u8 gText_ShopPurchasedItemPrice[] = _("---");
...
const u8 gText_Tutor_Moves[] = _("Tutor Moves");
...
const u8 gText_PkmnBleedHealed[] = _("{STR_VAR_1}'s bleeding was stopped.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Information[] = _("Wiki");
...
const u8 gText_Unrestricted[] = _("Unrestricted");
const u8 gText_3v3[] = _("3v3");
const u8 gText_6v6[] = _("6v6");
...
const u8 gJPText_BattlePoints[] = _("Battle Points");
...
#ifdef DEBUG_BUILD
const u8 gText_SavingVersionNum[] = _("v2.65 Beta2.1 Debug");
#else
const u8 gText_SavingVersionNum[] = _("v2.65 Beta2.1");
#endif
...
// Rare Pokemon
const u8 gText_GameCornerPorygon[] = 	_("Porygon{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerMunchlax[] = 	_("Munchlax{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerVulpix[] = 	_("Vulpix{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerSandshrew[] = 	_("Sandshrew{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerRattata[] = 	_("Rattata{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerMeowth[] = 	_("Meowth{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerGrimer[] = 	_("Grimer{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerDiglett[] = 	_("Diglett{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerGeodude[] = 	_("Geodude{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerRaichu[] = 	_("Raichu{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerMarowak[] = 	_("Marowak{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerExeggutor[] = 	_("Exeggutor{CLEAR_TO 0x48}10 Coins");
// Grass Starters
const u8 gText_GameCornerBulbasaur[] = 	_("Bulbasaur{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerChikorita[] = 	_("Chikorita{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerTreecko[] = 	_("Treecko{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerTurtwig[] = 	_("Turtwig{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerSnivy[] = 		_("Snivy{CLEAR_TO 0x48}10 Coins");
...
const u8 gText_GameCornerTorchic[] = 	_("Torchic{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerChimchar[] = 	_("Chimchar{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerTepig[] = 		_("Tepig{CLEAR_TO 0x48}10 Coins");
...
const u8 gText_GameCornerMudkip[] = 	_("Mudkip{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerPiplup[] = 	_("Piplup{CLEAR_TO 0x48}10 Coins");
const u8 gText_GameCornerOshawott[] = 	_("Oshawott{CLEAR_TO 0x48}10 Coins");
...
const u8 gText_Fighting[] = _("Fighting");
const u8 gText_Flying[] =   _("Flying");
const u8 gText_Ghost[] =    _("Ghost");
const u8 gText_Ground[] =   _("Ground");
const u8 gText_Ice2[] =      _("Ice");
const u8 gText_Poison2[] =   _("Poison");
...
const u8 gText_EVO_FORM_SHIFT_Male[]                = _("Form Shift Male");
const u8 gText_EVO_FORM_SHIFT_Female[]              = _("Form Shift Female");
...
const u8 gText_TutorialBattleChanges[]           = _("Battle changes"); // Weather, IVs
...
const u8 gText_TutorialSwitchAbility[]           = _("Switch abilities");
const u8 gText_TutorialSwitchNature[]            = _("Switch nature");
const u8 gText_TutorialSwitchHiddenPower[]       = _("Switch Hidden Power"); // Type Gems
const u8 gText_TutorialSetEVs[]                  = _("Set EVs");
const u8 gText_TutorialLearnMoves[]              = _("Learn moves");
*/
