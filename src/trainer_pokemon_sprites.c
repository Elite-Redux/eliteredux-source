...
static bool16 DecompressPic(SpeciesEnum species, u32 personality, bool8 isFrontPic, u8 *dest, bool8 isTrainer)
{
    if (!isTrainer)
    {
        if (isFrontPic)
...
static void LoadPicPaletteByTagOrSlot(SpeciesEnum species, u32 otId, u32 personality, u8 paletteSlot, u16 paletteTag, bool8 isTrainer, u8 isShiny, bool8 isAlpha)
{
    if (!isTrainer)
    {
...
static void LoadPicPaletteBySlot(SpeciesEnum species, u32 otId, u32 personality, u8 paletteSlot, bool8 isTrainer)
{
    u8 isShiny = FALSE;
    bool8 isAlpha = FALSE;
    if (!isTrainer)
...
static u16 CreatePicSprite(SpeciesEnum species, u32 otId, u32 personality, bool8 isFrontPic, s16 x, s16 y, u8 paletteSlot, u16 paletteTag, bool8 isTrainer, u8 isShiny, bool8 isAlpha)
{
    u8 i;
    u8 *framePics;
    struct SpriteFrameImage *images;
...
static u16 sub_818D65C(SpeciesEnum species, u32 otId, u32 personality, bool8 isFrontPic, u8 paletteSlot, u8 windowId, bool8 isTrainer)
{
...
static u16 CreateTrainerCardSprite(SpeciesEnum species, u32 otId, u32 personality, bool8 isFrontPic, u16 destX, u16 destY, u8 paletteSlot, u8 windowId, bool8 isTrainer)
{
    u8 *framePics;
...
u16 sub_818D834(SpeciesEnum species, u32 otId, u32 personality, bool8 isFrontPic, u8 paletteSlot, u8 windowId)
{
    return sub_818D65C(species, otId, personality, isFrontPic, paletteSlot, windowId, FALSE);
}

// Unused, FRLG only
u16 CreateTrainerCardMonIconSprite(SpeciesEnum species, u32 otId, u32 personality, bool8 isFrontPic, u16 destX, u16 destY, u8 paletteSlot, u8 windowId)
{
...
u16 sub_818D904(SpeciesEnum species, bool8 isFrontPic, u8 paletteSlot, u8 windowId)
{
