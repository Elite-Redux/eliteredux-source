...
void TryPutPokemonTodayOnAir(void)
{
    ...
    else
    {
        ...
        if (!rbernoulli(1, 1) && StringCompare(gSpecies[gBattleResults.caughtMonSpecies].name, gBattleResults.caughtMonNick))
        {
...
static void InterviewBefore_FanClubLetter(void)
{
    ...
    {
        StringCopy(gStringVar1, gSpecies[GetMonData(&gPlayerParty[GetLeadMonIndex()], MON_DATA_SPECIES, NULL)].name);
...
static bool8 IsPartyMonNicknamedOrNotEnglish(u8 monIdx)
{
    ...
    if (language == GAME_LANGUAGE && !StringCompare(gSpecies[GetMonData(pokemon, MON_DATA_SPECIES, NULL)].name, gStringVar1))
        return FALSE;
...
static u16 GetRandomDifferentSpeciesAndNameSeenByPlayer(u8 varIdx, u16 passedSpecies)
{
    ...
    StringCopy(gTVStringVarPtrs[varIdx], gSpecies[species].name);
    return species;
}
...
static void GetNicknameSubstring(u8 varIdx, u8 whichPosition, u8 charParam, u16 whichString, u16 species, TVShow *show)
{
    ...
    {
        strlen = StringLength(gSpecies[species].name);
        if (charParam == 0)
        {
            buff[0] = gSpecies[species].name[whichPosition];
        }
        else if (charParam == 1)
        {
            buff[0] = gSpecies[species].name[strlen - whichPosition];
        }
        else if (charParam == 2)
        {
            buff[0] = gSpecies[species].name[whichPosition];
            buff[1] = gSpecies[species].name[whichPosition + 1];
        }
        else
        {
            buff[0] = gSpecies[species].name[strlen - (whichPosition + 2)];
            buff[1] = gSpecies[species].name[strlen - (whichPosition + 1)];
        }
    }
...
static void DoTVShowBravoTrainerPokemonProfile(void)
{
    ...
    case 0:
        ...
        if (!StringCompare(gSpecies[show->bravoTrainer.species].name, show->bravoTrainer.pokemonNickname))
            sTVShowState = 8;
        else
            sTVShowState = 1;
        break;
    case 1:
        StringCopy(gStringVar1, gSpecies[show->bravoTrainer.species].name);
    ...
    case 7:
        TVShowConvertInternationalString(gStringVar1, show->bravoTrainer.playerName, show->bravoTrainer.language);
        StringCopy(gStringVar2, gSpecies[show->bravoTrainer.species].name);
        TVShowDone();
        break;
    case 8:
        StringCopy(gStringVar1, gSpecies[show->bravoTrainer.species].name);
...
static void DoTVShowBravoTrainerBattleTower(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->bravoTrainerTower.species].name);
    ...
    case 3:
        TVShowConvertInternationalString(gStringVar1, show->bravoTrainerTower.pokemonName, show->bravoTrainerTower.pokemonNameLanguage);
        StringCopy(gStringVar2, gSpecies[show->bravoTrainerTower.defeatedSpecies].name);
        if (show->bravoTrainerTower.interviewResponse == 0)
            sTVShowState = 5;
        else
            sTVShowState = 6;
...
static void DoTVShowTheNameRaterShow(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->nameRaterShow.species].name);
    ...
    case 17:
        GetNicknameSubstring(0, 0, 2, 1, 0, show);
        StringCopy(gStringVar2, gSpecies[show->nameRaterShow.randomSpecies].name);
...
static void DoTVShowPokemonTodaySuccessfulCapture(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->pokemonToday.species].name);
    ...
    case 7:
    case 8:
        StringCopy(gStringVar1, gSpecies[show->pokemonToday.species].name);
...
static void DoTVShowPokemonTodayFailedCapture(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->pokemonTodayFailed.species].name);
        sTVShowState = 1;
        break;
    case 1:
        TVShowConvertInternationalString(gStringVar1, show->pokemonTodayFailed.playerName, show->pokemonTodayFailed.language);
        GetMapName(gStringVar2, show->pokemonTodayFailed.location, 0);
        StringCopy(gStringVar3, gSpecies[show->pokemonTodayFailed.species2].name);
...
static void DoTVShowPokemonFanClubLetter(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->fanclubLetter.species].name);
        sTVShowState = 50;
        break;
    case 1:
        rval = (Random() % 4) + 1;
...
static void DoTVShowPokemonFanClubOpinions(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->fanclubOpinions.species].name);
...
static void DoTVShowPokemonNewsMassOutbreak(void)
{
    ...
    StringCopy(gStringVar2, gSpecies[show->massOutbreak.species].name);
    TVShowDone();
    StartMassOutbreak();
...
static void DoTVShowPokemonContestLiveUpdates(void)
{
    ...
    case CONTESTLIVE_STATE_INTRO:
        ...
        StringCopy(gStringVar2, gSpecies[show->contestLiveUpdates.winningSpecies].name);
    ...
    case CONTESTLIVE_STATE_TALK_ABOUT_LOSER:
        StringCopy(gStringVar1, gSpecies[show->contestLiveUpdates.winningSpecies].name);
        ...
        StringCopy(gStringVar3, gSpecies[show->contestLiveUpdates.losingSpecies].name);
    ...
    case CONTESTLIVE_STATE_NO_APPEALS:
        StringCopy(gStringVar1, gSpecies[show->contestLiveUpdates.losingSpecies].name);
    ...
    case CONTESTLIVE_STATE_LAST_BOTH:
        ...
        StringCopy(gStringVar2, gSpecies[show->contestLiveUpdates.losingSpecies].name);
        sTVShowState = CONTESTLIVE_STATE_OUTRO;
        break;
...
static void DoTVShowPokemonBattleUpdate(void)
{
    ...
    case 2:
        TVShowConvertInternationalString(gStringVar1, show->battleUpdate.playerName, show->battleUpdate.language);
        StringCopy(gStringVar2, gSpecies[show->battleUpdate.speciesPlayer].name);
    ...
    case 3:
        ...
        StringCopy(gStringVar2, gSpecies[show->battleUpdate.speciesOpponent].name);
        sTVShowState = 4;
        break;
    case 4:
        TVShowConvertInternationalString(gStringVar1, show->battleUpdate.playerName, show->battleUpdate.language);
    ...
    case 7:
        TVShowConvertInternationalString(gStringVar1, show->battleUpdate.playerName, show->battleUpdate.language);
        TVShowConvertInternationalString(gStringVar2, show->battleUpdate.linkOpponentName, show->battleUpdate.linkOpponentLanguage);
        StringCopy(gStringVar3, gSpecies[show->battleUpdate.speciesOpponent].name);
        TVShowDone();
        break;
    }
...
void DoTVShowInSearchOfTrainers(void)
{
    ...
    case 2:
        ...
        break;
    case 3:
        StringCopy(gStringVar1, gSpecies[gSaveBlock1Ptr->gabbyAndTyData.mon1].name);
        StringCopy(gStringVar2, gMoveNames[gSaveBlock1Ptr->gabbyAndTyData.lastMove]);
        StringCopy(gStringVar3, gSpecies[gSaveBlock1Ptr->gabbyAndTyData.mon2].name);
        sTVShowState = 8;
        break;
    case 4:
    case 5:
    ...
    case 8:
        CopyEasyChatWord(gStringVar1, gSaveBlock1Ptr->gabbyAndTyData.quote[0]);
        StringCopy(gStringVar2, gSpecies[gSaveBlock1Ptr->gabbyAndTyData.mon1].name);
        StringCopy(gStringVar3, gSpecies[gSaveBlock1Ptr->gabbyAndTyData.mon2].name);
        gSpecialVar_Result = TRUE;
        sTVShowState = 0;
        TakeGabbyAndTyOffTheAir();
...
static void DoTVShowPokemonAngler(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->pokemonAngler.species].name);
...
static void DoTVShowTheWorldOfMasters(void)
{
    ...
    case 0:
        ...
        break;
    case 1:
        StringCopy(gStringVar1, gSpecies[show->worldOfMasters.species].name);
        sTVShowState = 2;
        break;
    case 2:
        TVShowConvertInternationalString(gStringVar1, show->worldOfMasters.playerName, show->worldOfMasters.language);
        GetMapName(gStringVar2, show->worldOfMasters.location, 0);
        StringCopy(gStringVar3, gSpecies[show->worldOfMasters.caughtPoke].name);
        TVShowDone();
        break;
    }
...
static void DoTVShowBreakingNewsTV(void)
{
    ...
    case 1:
        ...
        StringCopy(gStringVar2, gSpecies[show->breakingNews.lastOpponentSpecies].name);
    ...
    case 2:
        TVShowConvertInternationalString(gStringVar1, show->breakingNews.playerName, show->breakingNews.language);
        StringCopy(gStringVar2, gSpecies[show->breakingNews.lastOpponentSpecies].name);
        StringCopy(gStringVar3, gSpecies[show->breakingNews.poke1Species].name);
        sTVShowState = 3;
        break;
    case 3:
    ...
    case 7:
        ...
        StringCopy(gStringVar2, gSpecies[show->breakingNews.poke1Species].name);
        sTVShowState = 8;
        break;
    case 12:
        TVShowConvertInternationalString(gStringVar1, show->breakingNews.playerName, show->breakingNews.language);
...
static void DoTVShowSecretBaseVisit(void)
{
    ...
    case 12:
        TVShowConvertInternationalString(gStringVar1, show->secretBaseVisit.playerName, show->secretBaseVisit.language);
        StringCopy(gStringVar2, gSpecies[show->secretBaseVisit.species].name);
...
static void DoTVShowThePokemonBattleSeminar(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, gSpecies[show->battleSeminar.species].name);
        StringCopy(gStringVar3, gSpecies[show->battleSeminar.foeSpecies].name);
        sTVShowState = 1;
        break;
    case 1:
        TVShowConvertInternationalString(gStringVar1, show->battleSeminar.playerName, show->battleSeminar.language);
        StringCopy(gStringVar2, gSpecies[show->battleSeminar.foeSpecies].name);
        StringCopy(gStringVar3, gMoveNames[show->battleSeminar.move]);
        sTVShowState = 2;
        break;
    case 2:
        StringCopy(gStringVar1, gSpecies[show->battleSeminar.species].name);
...
static void DoTVShowPokemonNewsBattleFrontier(void)
{
    ...
    case 13:
        ...
        break;
    case 14:
        StringCopy(gStringVar1, gSpecies[show->frontier.species1].name);
        StringCopy(gStringVar2, gSpecies[show->frontier.species2].name);
        StringCopy(gStringVar3, gSpecies[show->frontier.species3].name);
        sTVShowState = 18;
        break;
    case 15:
        StringCopy(gStringVar1, gSpecies[show->frontier.species1].name);
    ...
    case 16:
        ...
        break;
    case 17:
        StringCopy(gStringVar1, gSpecies[show->frontier.species4].name);
        sTVShowState = 18;
        break;
    case 18:
        TVShowConvertInternationalString(gStringVar1, show->frontier.playerName, show->frontier.language);
