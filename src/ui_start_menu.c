...
static const struct StartMenuActionData StartMenuActions[NUM_START_MENU_ACTIONS] = {
    [START_MENU_ACTION_POKEDEX] =
        {
            .title = _("Pokedex"),
            .description = _("Open a database of all\n"
    ...
    [START_MENU_ACTION_PLAYER] =
        {
            .title = _("{PLAYER}."),
            .description = _("See all your Trainer\n"
                             "information, money,\n"
                             "battle points, etc."),
            .flag = FLAG_NONE,
        },
    [START_MENU_ACTION_POKEMON] =
        {
            .title = _("Pokemon"),
            .description = _("Organize your Pokémon\n"
    ...
    [START_MENU_ACTION_PC] =
        {
            .title = _("Use the PC"),
            .description = _("Open the Pokemon\n"
    ...
    [START_MENU_ACTION_BAG] =
        {
            .title = _("Inventory"),
            .description = _("Organize your Inventory,\n"
                             "use your items or\n"
    ...
    [START_MENU_ACTION_OPTIONS] =
        {
            .title = _("Settings"),
            .description = _("Change your settings,\n"
                             "character colors,\n"
    ...
    [START_MENU_ACTION_DEXNAV] =
        {
            .title = _("DexNav"),
            .description = _("Search for nearby\n"
                             "Pokémon, chain them,\n"
    ...
    [START_MENU_ACTION_DEBUG] =
        {
            .title = _("Debug"),
            .description = _("Open some developer\n"
    ...
    [START_MENU_ACTION_SAVE] =
        {
            .title = _("Save"),
            .description = _("Save your game with\n"
    ...
    [START_MENU_ACTION_EXIT] =
        {
            .title = _("Exit"),
            .description = _("Exit this menu and\n"
    ...
    switch (gMain.state) {
        ...
        case 5:
            ...
            for (i = 0; i < PARTY_SIZE; i++) {
                if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES) != SPECIES_NONE) ShowSpeciesIcon(i, x, y);
...
static const u8 *GetBarGfx(u32 percent) {
    ...
    if (percent == 0) return sStartMenu_HPBar_Fill_Gfx[percent];

    if (modifiedPercent == 0) return sStartMenu_HPBar_Fill_Gfx[1];
...
static void *GetSpriteCallbackForIcon(u32 percent, bool32 isEgg) {
    if (((percent > 20) && isEgg) || percent == 0) return sSpriteCB_Dummy;
...
// Saving Stuff
enum { SAVE_MODE_NOT_ENGAGED, SAVE_MODE_ASK, SAVE_MODE_IN_PROGRESS, SAVE_MODE_SUCCESS, SAVE_MODE_CANCELED, SAVE_MODE_ERROR, SAVE_MODE_OVERWRITE };
...
static const struct StringList DayNames[32] = {
    [1] = _("1st"),   [2] = _("2nd"),   [3] = _("3rd"),   [4] = _("4th"),   [5] = _("5th"),   [6] = _("6th"),   [7] = _("7th"),   [8] = _("8th"),
    [9] = _("9th"),   [10] = _("10th"), [11] = _("11th"), [12] = _("12th"), [13] = _("13th"), [14] = _("14th"), [15] = _("15th"), [16] = _("16th"),
    [17] = _("17th"), [18] = _("18th"), [19] = _("19th"), [20] = _("20th"), [21] = _("21st"), [22] = _("22nd"), [23] = _("23rd"), [24] = _("24th"),
    [25] = _("25th"), [26] = _("26th"), [27] = _("27th"), [28] = _("28th"), [29] = _("29th"), [30] = _("30th"), [31] = _("31st")};
...
const u8 sText_Message_Test[] =
    _("Save your game with\n"
      "a complete record of\n"
      "your progress to take\n"
      "a break.");

const u8 sText_Message_Cant_Save[] = _("You can't save here!");

const u8 sText_Message_Cant_Use_Dexnav[] =
    _("There are no Pokémon in\n"
      "this area.");

const u8 sText_Message_Cant_Use_Bike[] =
    _("You can't use your bike\n"
      "here.");

const u8 sText_Message_Steps_Reset[] =
    _("The step counter\n"
      "was reset.");

const u8 sText_Message_Cant_Change_Time[] =
    _("You can't change the\n"
      "time again today.");

const u8 sText_Message_Saving[] =
    _("Saving please wait...\n"
      "Don't turn off your\n"
      "console to avoid any\n"
      "problem.");

const u8 sText_Message_TrainerInfo[] =
    _("See all your information\n"
...
u8 getCurrentOptionIndex(u8 num) { return sMenuDataPtr->MenuOptions[num]; }
...
static void PrintToWindow(void) {
    ...
    // Selection Sprite
    j = sMenuDataPtr->cursorRowY - max(sMenuDataPtr->FirstItem, 0);
    x = 2;
...
static bool8 canUsePC(void) {
    ...
    switch (gSaveBlock1Ptr->location.mapNum) {
        case MAP_NUM(EVER_GRANDE_CITY_SIDNEYS_ROOM):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_SIDNEYS_ROOM)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_PHOEBES_ROOM):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_PHOEBES_ROOM)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_GLACIAS_ROOM):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_GLACIAS_ROOM)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_DRAKES_ROOM):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_DRAKES_ROOM)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_CHAMPIONS_ROOM):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_CHAMPIONS_ROOM)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_HALL1):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL1)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_HALL2):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL2)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_HALL3):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL3)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_HALL4):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL4)) disablePC = TRUE;
            break;
        case MAP_NUM(EVER_GRANDE_CITY_HALL5):
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(EVER_GRANDE_CITY_HALL5)) disablePC = TRUE;
            break;
    }

    if (!disablePC && FlagGet(FLAG_SYS_POKEMON_GET)) return TRUE;
...
static bool8 ShouldDisableSaving() {
    ...
    if (mapSection == MAPSEC_SAFARI_ZONE) return TRUE;
...
bool8 CanUseBikeFromStartMenu(void) {
    ...
    if (!CheckBagHasItem(ITEM_ACRO_BIKE, 1) && !CheckBagHasItem(ITEM_MACH_BIKE, 1)) return FALSE;

    if (FlagGet(FLAG_SYS_CYCLING_ROAD) == TRUE || MetatileBehavior_IsVerticalRail(behavior) == TRUE || MetatileBehavior_IsHorizontalRail(behavior) == TRUE ||
        MetatileBehavior_IsIsolatedVerticalRail(behavior) == TRUE || MetatileBehavior_IsIsolatedHorizontalRail(behavior) == TRUE ||
